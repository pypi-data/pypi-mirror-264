...
dirname = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'eurocodes.json')
db = json.loads(open(dirname,'r').read())["Eurocodes"]
dirname = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'prof_euro.json')
db["SteelProfiles"]["Euro"] = json.loads(open(dirname,'r').read())
