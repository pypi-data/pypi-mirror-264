...
class WitmotionServo():
    ...
    def open_bluetooth(self, mac_address, tx_uuid, rx_uuid):
        self.device = NordicUARTSerialDriver()
        
    def open_serial(self, serial_number: Optional[str]=None) -> WitmotionServo:
