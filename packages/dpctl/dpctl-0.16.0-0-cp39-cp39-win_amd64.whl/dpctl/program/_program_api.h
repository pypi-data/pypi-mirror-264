...
static int import_dpctl__program___program(void) {
  ...
  if (!module) goto bad;
  if (__Pyx_ImportFunction_3_0_8(module, "SyclKernel_GetKernelRef", (void (**)(void))&__pyx_api_f_5dpctl_7program_8_program_SyclKernel_GetKernelRef, "DPCTLSyclKernelRef (struct PySyclKernelObject *)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_0_8(module, "SyclKernel_Make", (void (**)(void))&__pyx_api_f_5dpctl_7program_8_program_SyclKernel_Make, "struct PySyclKernelObject *(DPCTLSyclKernelRef, char const *)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_0_8(module, "SyclProgram_GetKernelBundleRef", (void (**)(void))&__pyx_api_f_5dpctl_7program_8_program_SyclProgram_GetKernelBundleRef, "DPCTLSyclKernelBundleRef (struct PySyclProgramObject *)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_0_8(module, "SyclProgram_Make", (void (**)(void))&__pyx_api_f_5dpctl_7program_8_program_SyclProgram_Make, "struct PySyclProgramObject *(DPCTLSyclKernelBundleRef)") < 0) goto bad;
  __pyx_ptype_5dpctl_7program_8_program_SyclKernel = __Pyx_ImportType_3_0_8(module, "dpctl.program._program", "SyclKernel", sizeof(struct PySyclKernelObject), __PYX_GET_STRUCT_ALIGNMENT_3_0_8(struct PySyclKernelObject),__Pyx_ImportType_CheckSize_Warn_3_0_8); if (!__pyx_ptype_5dpctl_7program_8_program_SyclKernel) goto bad;
  __pyx_ptype_5dpctl_7program_8_program_SyclProgram = __Pyx_ImportType_3_0_8(module, "dpctl.program._program", "SyclProgram", sizeof(struct PySyclProgramObject), __PYX_GET_STRUCT_ALIGNMENT_3_0_8(struct PySyclProgramObject),__Pyx_ImportType_CheckSize_Warn_3_0_8); if (!__pyx_ptype_5dpctl_7program_8_program_SyclProgram) goto bad;
