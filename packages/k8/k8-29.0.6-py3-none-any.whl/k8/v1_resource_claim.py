...
class V1ResourceClaim(BaseModel):
    """
    ResourceClaim references one entry in PodSpec.ResourceClaims.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1ResourceClaim:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1ResourceClaim:
        """Create an instance of V1ResourceClaim from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1ResourceClaim.parse_obj(obj)

        _obj = V1ResourceClaim.parse_obj({
            "name": obj.get("name")
        })
        return _obj
