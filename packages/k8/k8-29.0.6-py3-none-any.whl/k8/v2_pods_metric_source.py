...
class V2PodsMetricSource(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V2PodsMetricSource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V2PodsMetricSource:
        """Create an instance of V2PodsMetricSource from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V2PodsMetricSource.parse_obj(obj)

        _obj = V2PodsMetricSource.parse_obj({
