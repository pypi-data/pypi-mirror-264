...
class V1alpha1Variable(BaseModel):
    """
    Variable is the definition of a variable that is used for composition.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1alpha1Variable:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1alpha1Variable:
        """Create an instance of V1alpha1Variable from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1alpha1Variable.parse_obj(obj)

        _obj = V1alpha1Variable.parse_obj({
