...
class V2PodsMetricStatus(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V2PodsMetricStatus:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V2PodsMetricStatus:
        """Create an instance of V2PodsMetricStatus from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V2PodsMetricStatus.parse_obj(obj)

        _obj = V2PodsMetricStatus.parse_obj({
