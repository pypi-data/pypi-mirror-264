...
class V1beta3FlowDistinguisherMethod(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1beta3FlowDistinguisherMethod:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1beta3FlowDistinguisherMethod:
        """Create an instance of V1beta3FlowDistinguisherMethod from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1beta3FlowDistinguisherMethod.parse_obj(obj)

        _obj = V1beta3FlowDistinguisherMethod.parse_obj({
            "type": obj.get("type")
        })
        return _obj
