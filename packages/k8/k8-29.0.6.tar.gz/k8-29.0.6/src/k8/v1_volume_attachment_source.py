...
class V1VolumeAttachmentSource(BaseModel):
    ...
    persistent_volume_name: Optional[StrictStr] = Field(default=None, alias="persistentVolumeName", description="persistentVolumeName represents the name of the persistent volume to attach.")
