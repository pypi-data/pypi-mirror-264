...
class V1beta3PriorityLevelConfigurationSpec(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1beta3PriorityLevelConfigurationSpec:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1beta3PriorityLevelConfigurationSpec:
        """Create an instance of V1beta3PriorityLevelConfigurationSpec from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1beta3PriorityLevelConfigurationSpec.parse_obj(obj)

        _obj = V1beta3PriorityLevelConfigurationSpec.parse_obj({
