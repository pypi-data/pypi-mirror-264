...
class V1PodFailurePolicyOnPodConditionsPattern(BaseModel):
    """
    PodFailurePolicyOnPodConditionsPattern describes a pattern for matching an actual pod condition type.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1PodFailurePolicyOnPodConditionsPattern:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1PodFailurePolicyOnPodConditionsPattern:
        """Create an instance of V1PodFailurePolicyOnPodConditionsPattern from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1PodFailurePolicyOnPodConditionsPattern.parse_obj(obj)

        _obj = V1PodFailurePolicyOnPodConditionsPattern.parse_obj({
