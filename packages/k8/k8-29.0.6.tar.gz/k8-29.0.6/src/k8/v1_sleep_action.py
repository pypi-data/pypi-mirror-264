...
class V1SleepAction(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1SleepAction:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1SleepAction:
        """Create an instance of V1SleepAction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1SleepAction.parse_obj(obj)

        _obj = V1SleepAction.parse_obj({
