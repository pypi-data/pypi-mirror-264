...
// (62:0) <Block {visible} {elem_id} {elem_classes} {container} {scale} {min_width}>
function create_default_slot(ctx) {
	...
	return {
		c() {
			...
			attr(input0, "class", "svelte-pc1gm4");
			attr(div0, "class", "head svelte-pc1gm4");
			attr(div1, "class", "wrap svelte-pc1gm4");
			...
			attr(input1, "class", "svelte-pc1gm4");
		},
		m(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
	...
	function setSliderRange() {
		...
		$$invalidate(15, rangeInput.style.backgroundSize = h * 100 + "% 100%", rangeInput);
	}
...
//# sourceMappingURL=Index-6c632537.js.map
