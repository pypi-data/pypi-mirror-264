...
function create_else_block_1(ctx) {
	...
	let each_value_2 = ensure_array_like(/*component_meta*/ ctx[18]);
	let each_blocks = [];
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*value, page, samples_per_page, gradio, handle_mouseenter, handle_mouseleave, component_meta, components, component_props, samples_dir, current_hover, component_map*/ 7746063) {
				each_value_2 = ensure_array_like(/*component_meta*/ ctx[18]);
				let i;
...
function create_if_block_2(ctx) {
	let div;
	let current;
	let each_value_1 = ensure_array_like(/*selected_samples*/ ctx[15]);
	let each_blocks = [];
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*value, page, samples_per_page, gradio, selected_samples, handle_mouseenter, handle_mouseleave, component_meta, component_props, samples_dir, current_hover, component_map, components*/ 7778831) {
				each_value_1 = ensure_array_like(/*selected_samples*/ ctx[15]);
				let i;
...
// (154:8) {#if component_name !== undefined && component_map.get(component_name) !== undefined}
function create_if_block_5(ctx) {
	...
	const switch_instance_spread_levels = [
		...
		{ value: /*value*/ ctx[0] },
		{ samples_dir: /*samples_dir*/ ctx[20] },
		{ type: "table" },
		{
			selected: /*current_hover*/ ctx[17] === /*i*/ ctx[40]
		},
		{ index: /*i*/ ctx[40] }
	];
	...
	function switch_props(ctx, dirty) {
		...
		if (dirty !== undefined && dirty[0] & /*component_props, component_meta, samples_dir, current_hover*/ 1441796) {
			switch_instance_props = get_spread_update(switch_instance_spread_levels, [
				...
				dirty[0] & /*component_meta*/ 262144 && { value: /*value*/ ctx[0] },
				dirty[0] & /*samples_dir*/ 1048576 && { samples_dir: /*samples_dir*/ ctx[20] },
				switch_instance_spread_levels[3],
				dirty[0] & /*current_hover*/ 131072 && {
					selected: /*current_hover*/ ctx[17] === /*i*/ ctx[40]
				},
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*component_meta*/ 262144 && switch_value !== (switch_value = /*component*/ ctx[42])) {
				if (switch_instance) {
					group_outros();
				...
				const switch_instance_changes = (dirty[0] & /*component_props, component_meta, samples_dir, current_hover*/ 1441796)
...
// (152:7) {#each sample_row as { value, component }
...
// (142:5) {#each component_meta as sample_row, i}
function create_each_block_2(ctx) {
	...
	return {
		...
		p(new_ctx, dirty) {
			...
			if (dirty[0] & /*components, component_meta, component_props, samples_dir, current_hover, component_map*/ 1441806) {
...
// (103:4) {#if sample_row[0]}
function create_if_block_3(ctx) {
	let button;
	let show_if = /*component_meta*/ ctx[18].length && /*component_map*/ ctx[3].get(/*components*/ ctx[1][0]);
	let t;
	let current;
	let mounted;
	let dispose;
	...
	return {
		...
		p(new_ctx, dirty) {
			ctx = new_ctx;
			if (dirty[0] & /*component_meta, component_map, components*/ 262154) show_if = /*component_meta*/ ctx[18].length && /*component_map*/ ctx[3].get(/*components*/ ctx[1][0]);

			if (show_if) {
				if (if_block) {
					if_block.p(ctx, dirty);

					if (dirty[0] & /*component_meta, component_map, components*/ 262154) {
						transition_in(if_block, 1);
					}
				} else {
...
// (114:6) {#if component_meta.length && component_map.get(components[0])}
function create_if_block_4(ctx) {
	...
	var switch_value = /*component_meta*/ ctx[18][0][0].component;

	function switch_props(ctx, dirty) {
		let switch_instance_props = {};

		if (dirty !== undefined && dirty[0] & /*component_props, selected_samples, samples_dir, current_hover*/ 1212420) {
			switch_instance_props = get_spread_update(switch_instance_spread_levels, [
				dirty[0] & /*component_props*/ 4 && get_spread_object(/*component_props*/ ctx[2][0]),
				dirty[0] & /*selected_samples*/ 32768 && { value: /*sample_row*/ ctx[38][0] },
				dirty[0] & /*samples_dir*/ 1048576 && { samples_dir: /*samples_dir*/ ctx[20] },
				switch_instance_spread_levels[3],
				dirty[0] & /*current_hover*/ 131072 && {
					selected: /*current_hover*/ ctx[17] === /*i*/ ctx[40]
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*component_meta*/ 262144 && switch_value !== (switch_value = /*component_meta*/ ctx[18][0][0].component)) {
				if (switch_instance) {
					group_outros();
					const old_component = switch_instance;
				...
				const switch_instance_changes = (dirty[0] & /*component_props, selected_samples, samples_dir, current_hover*/ 1212420)
				? get_spread_update(switch_instance_spread_levels, [
						dirty[0] & /*component_props*/ 4 && get_spread_object(/*component_props*/ ctx[2][0]),
						dirty[0] & /*selected_samples*/ 32768 && { value: /*sample_row*/ ctx[38][0] },
						dirty[0] & /*samples_dir*/ 1048576 && { samples_dir: /*samples_dir*/ ctx[20] },
...
// (102:3) {#each selected_samples as sample_row, i}
		...
		p(ctx, dirty) {
			if (/*sample_row*/ ctx[38][0]) {
				if (if_block) {
					...
					if (dirty[0] & /*selected_samples*/ 32768) {
						transition_in(if_block, 1);
					}
				} else {
...
function create_if_block(ctx) {
	let div;
	let t;
	let each_value = ensure_array_like(/*visible_pages*/ ctx[16]);
	let each_blocks = [];
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*visible_pages, page*/ 73728) {
				each_value = ensure_array_like(/*visible_pages*/ ctx[16]);
				let i;
...
function create_else_block(ctx) {
	...
	return {
		...
		p(new_ctx, dirty) {
			ctx = new_ctx;
			if (dirty[0] & /*visible_pages*/ 65536 && t0_value !== (t0_value = /*visible_page*/ ctx[35] + 1 + "")) set_data(t0, t0_value);

			if (dirty[0] & /*page, visible_pages*/ 73728) {
				toggle_class(button, "current-page", /*page*/ ctx[13] === /*visible_page*/ ctx[35]);
			}
		},
		d(detaching) {
...
// (182:3) {#each visible_pages as visible_page}
...
// (72:0) <Block  {visible}  padding={false}  {elem_id}  {elem_classes}  {scale}  {min_width}  allow_overflow={false}  container={false} >
...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*visible_pages, page, paginate, selected_samples, value, samples_per_page, gradio, component_meta, component_props, current_hover, component_map, components, gallery, headers, label*/ 1045055 | dirty[1] & /*$$scope*/ 262144) {
...
function instance($$self, $$props, $$invalidate) {
	...
	function handle_mouseenter(i) {
		$$invalidate(17, current_hover = i);
	}

	function handle_mouseleave() {
		$$invalidate(17, current_hover = -1);
	}

	let component_meta = [];

	async function get_component_meta(selected_samples) {
		$$invalidate(18, component_meta = await Promise.all(selected_samples && selected_samples.map(async sample_row => await Promise.all(sample_row.map(async (sample_cell, j) => {
			return {
				value: sample_cell,
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty[0] & /*components*/ 2) {
			$$invalidate(19, gallery = components.length < 2);
		}

		if ($$self.$$.dirty[0] & /*samples, samples_per_page, paginate, page, page_count, visible_pages*/ 75588096) {
			{
				$$invalidate(14, paginate = samples.length > samples_per_page);

				if (paginate) {
					$$invalidate(16, visible_pages = []);
					$$invalidate(15, selected_samples = samples.slice(page * samples_per_page, (page + 1) * samples_per_page));
					...
					$$invalidate(15, selected_samples = samples.slice());
				}
			}
		}

		if ($$self.$$.dirty[0] & /*selected_samples*/ 32768) {
...
//# sourceMappingURL=Index-0cb735a8.js.map
