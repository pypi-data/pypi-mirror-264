import { i as identity, s as split_css_unit } from './Index-ff30e21b.js';
...
function create_else_block(ctx) {
	...
	return {
		c() {
			...
			toggle_class$1(button, "hidden", !/*visible*/ ctx[2]);
			set_style$1(button, "flex-grow", /*scale*/ ctx[9]);
			set_style$1(button, "width", /*scale*/ ctx[9] === 0 ? "fit-content" : null);

			set_style$1(button, "min-width", typeof /*min_width*/ ctx[10] === "number"
			...
			if (default_slot) {
				if (default_slot.p && (!current || dirty & /*$$scope*/ 2048)) {
					update_slot_base$1(
						...
						/*$$scope*/ ctx[11],
						!current
						? get_all_dirty_from_scope$1(/*$$scope*/ ctx[11])
						: get_slot_changes$1(default_slot_template, /*$$scope*/ ctx[11], dirty, null),
						null
					);
				}
			}
...
function create_if_block(ctx) {
	...
	return {
		c() {
			...
			toggle_class$1(a, "hidden", !/*visible*/ ctx[2]);
			toggle_class$1(a, "disabled", /*disabled*/ ctx[8]);
			set_style$1(a, "flex-grow", /*scale*/ ctx[9]);
			set_style$1(a, "pointer-events", /*disabled*/ ctx[8] ? "none" : null);
			set_style$1(a, "width", /*scale*/ ctx[9] === 0 ? "fit-content" : null);

			set_style$1(a, "min-width", typeof /*min_width*/ ctx[10] === "number"
			? `calc(min(${/*min_width*/ ctx[10]}px, 100%))`
			: null);
		},
		m(target, anchor) {
...
function create_dynamic_element(ctx) {
	...
	let svelte_element_levels = [
		...
		{ id: /*elem_id*/ ctx[2] },
		{
			class: svelte_element_class_value = "block " + /*elem_classes*/ ctx[3].join(' ') + " svelte-12cmxck"
		}
	];
	...
	return {
		c() {
			...
			toggle_class(svelte_element, "border_contrast", /*border_mode*/ ctx[5] === "contrast");
			toggle_class(svelte_element, "hide-container", !/*explicit_call*/ ctx[8] && !/*container*/ ctx[9]);
			set_style(svelte_element, "height", /*get_dimension*/ ctx[15](/*height*/ ctx[0]));
		...
		p(ctx, dirty) {
			...
			set_dynamic_element_data(/*tag*/ ctx[14])(svelte_element, svelte_element_data = get_spread_update(svelte_element_levels, [
				...
				(!current || dirty & /*elem_classes*/ 8 && svelte_element_class_value !== (svelte_element_class_value = "block " + /*elem_classes*/ ctx[3].join(' ') + " svelte-12cmxck")) && { class: svelte_element_class_value }
			]));
...
//# sourceMappingURL=SelectSource.svelte_svelte_type_style_lang-c9ffb01e.js.map
