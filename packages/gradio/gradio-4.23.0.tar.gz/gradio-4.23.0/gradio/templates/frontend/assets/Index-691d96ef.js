...
import { B as BlockTitle } from './BlockTitle-1b674dc0.js';
...
// (45:1) <BlockTitle {show_label} {info}>
...
// (48:2) {#each choices as [display_value, internal_value], i (i)}
function create_each_block(key_1, ctx) {
	...
	function baseradio_selected_binding(value) {
		/*baseradio_selected_binding*/ ctx[15](value);
	}

	function input_handler() {
		return /*input_handler*/ ctx[16](/*internal_value*/ ctx[19], /*i*/ ctx[21]);
	}

	let baseradio_props = {
		display_value: /*display_value*/ ctx[18],
		internal_value: /*internal_value*/ ctx[19],
	...
	return {
		...
		p(new_ctx, dirty) {
			...
			if (dirty & /*choices*/ 128) baseradio_changes.display_value = /*display_value*/ ctx[18];
			if (dirty & /*choices*/ 128) baseradio_changes.internal_value = /*internal_value*/ ctx[19];
...
// (30:0) <Block  {visible}  type="fieldset"  {elem_id}  {elem_classes}  {container}  {scale}  {min_width} >
...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*$$scope, choices, disabled, value, gradio, show_label, info, label, loading_status*/ 4206991) {
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		...
		if ($$self.$$.dirty & /*interactive*/ 16384) {
...
//# sourceMappingURL=Index-691d96ef.js.map
