...
from detensor_cli.config import Driver, Plugin, Adapter
...
if TYPE_CHECKING:
    ...
    async def load_module_data(
        ...
        urls = [
            f"https://registry.detensor.dev/{module_name}.json",
            f"https://cdn.jsdelivr.net/gh/detensor/registry@results/{module_name}.json",
            f"https://cdn.staticaly.com/gh/detensor/registry@results/{module_name}.json",
            f"https://jsd.cdn.zzko.cn/gh/detensor/registry@results/{module_name}.json",
            f"https://mirror.ghproxy.com/https://raw.githubusercontent.com/detensor/registry/results/{module_name}.json",
            f"https://gh-proxy.com/https://raw.githubusercontent.com/detensor/registry/results/{module_name}.json",
        ]
