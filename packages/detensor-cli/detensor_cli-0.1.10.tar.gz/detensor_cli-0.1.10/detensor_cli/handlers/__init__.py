...
from detensor_cli.consts import SCRIPTS_GROUP
...
from .meta import requires_detensor as requires_detensor
from .meta import get_default_python as get_default_python
from .meta import get_detensor_config as get_detensor_config
from .meta import get_python_version as get_python_version
from .meta import get_detensor_version as get_detensor_version
...
from .project import create_pro_project as create_pro_project
from .project import create_project as create_project
from .project import TEMPLATE_PRO_ROOT as TEMPLATE_PRO_ROOT
...
from .project import list_pro_project_templates as list_pro_project_templates
