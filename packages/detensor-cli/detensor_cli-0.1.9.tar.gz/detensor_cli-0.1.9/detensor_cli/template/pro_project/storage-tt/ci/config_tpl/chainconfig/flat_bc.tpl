...
trust_roots:
  ...
  - org_id: "{org1_id}"
    root:
      - "../config/{org_path}/ca_{org1_id}.crt"
  - org_id: "{org2_id}"
    root:
      - "../config/{org_path}/ca_{org2_id}.crt"
  - org_id: "{org3_id}"
    root:
      - "../config/{org_path}/ca_{org3_id}.crt"
  - org_id: "{org4_id}"
    root:
      - "../config/{org_path}/ca_{org4_id}.crt"
#  - org_id: "{org5_id}"
#    root:
#      - "../config/{org_path}/ca_{org5_id}.crt"
#  - org_id: "{org6_id}"
#    root:
#      - "../config/{org_path}/ca_{org6_id}.crt"
#  - org_id: "{org7_id}"
#    root:
#      - "../config/{org_path}/ca_{org7_id}.crt"
