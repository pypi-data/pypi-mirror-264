...
blockchain:
  ...
  - chainId: {chain_id}
    genesis: ../config/{org_path}/bc1.yml
#  - chainId: chain2
...
node:
  ...
  priv_key_file:     ../config/{org_path}/{node_cert_path}.key  # [*]

  # Certificate file path
  cert_file:         ../config/{org_path}/{node_cert_path}.crt  # [*]
...
net:
  ...
  tls:
    ...
    priv_key_file: ../config/{org_path}/{net_cert_path}.key

    # TLS Certificate file path.
    cert_file: ../config/{org_path}/{net_cert_path}.crt
...
rpc:
  ...
  tls:
    ...
    priv_key_file:  ../config/{org_path}/{rpc_cert_path}.key

    # RPC TLS public key file path
    cert_file:      ../config/{org_path}/{rpc_cert_path}.crt
