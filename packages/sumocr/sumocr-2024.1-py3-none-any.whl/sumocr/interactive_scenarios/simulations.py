...
# REFACTOR: move to a common interface or seperate out into different methods
...
def simulate_scenario(
    ...
    if mode is SimulationOption.WITHOUT_EGO:
        ...
        for step in range(num_of_steps):
            ...
            sumo_sim.dummy_ego_simulation = True  # REFACTOR: Could also be done outside and probably without manipulating the class attributes directly
        ...
        for step in range(num_of_steps):
            ...
            for ego_vehicle in ego_vehicles.values():
                ...
                if next_state.velocity > 0:
                    ...
                    next_state.position = np.array(
                        [x + v * cos(o) * dt, y + v * sin(o) * dt]
                    )
