"""FaStFig simplifies figure handling with matplotlib:
...
fig = fastfig.Fig("l", nrows=2, sharex=True)  # create figure with template l=large
...
class Fig:
    ...
    def __init__(self, *args, template="m", nrows=1, ncols=1, **kwargs):
        """Set default values and create figure: fig = Fig("OL", nrows=2, ncols=2)"""
        ...
        if len(args) == 1:
            ...
            raise ValueError("Too many arguments! Fig() accepts a maximum of 3 unnamed arguments.")
    ...
    def subplot(
        ...
        *args,
        ...
        if num_args == 0:
            ...
            raise ValueError("FaStFig.subplot() takes 0 to 3 unnamed arguments")
        ...
        if nrows is not None or ncols is not None:
            ...
            try:
                ...
                print("FaStFig.subplot(): Matplotlib cannot generate subplots.")
                print(excpt)
    ...
    def xlim(self, xmin=np.inf, xmax=-np.inf):
        ...
        try:
            ...
            print("FaStFig.xlim() throws exception:")
            print(excpt)
            # pass
    ...
    def ylim(self, ymin=np.inf, ymax=-np.inf):
        ...
        try:
            ...
            print("FaStFig.ylim() throws exception:")
            print(excpt)
            # pass
    ...
    def set_cycle(self, colors, color_seq, linestyle_seq):  # ,linewidth=False):
        ...
        try:
            ...
            print("FaStFig.set_cycle(): Cannot set cycle for color and linestyle")
            print(excpt)
    ...
    def set_parameters(self):
        ...
        try:
            ...
            print("FaStFig.set_parameters(): Tight layout cannot be set!")
            print(excpt)
    ...
    def watermark(self, img, *args, xpos=100, ypos=100, alpha=0.15, zorder=1, **kwargs):
        ...
        if os.path.isfile(img):
            ...
            print("FaStFig.watermark(): File not found")
    ...
    def save(self, filename, *args, **kwargs):
        ...
        for iformat in fileformat:
            try:
                ...
                print(f"FaStFig.save(): Figure cannot be saved to {filename}.{iformat}")
                print(excpt)
        if self.figshow:
            matplotlib.pyplot.show()  # block=False)
        else:
    ...
    def close(self):
        ...
        try:
            ...
            print("FaStFig.close(): Figure cannot be closed")
            print(excpt)
