...
def define_presets(presets=None):
    """Define default presets for FaStFig."""
    # define defaults in preset dictionary
    pdict = DEFAULT_PRESETS.copy()

    # Overwrite defaults with presets from FaStFig_presets.json
    if os.path.isfile("FaStFig_presets.json"):
        pdict.update(load_json("FaStFig_presets.json"))
...
def load_json(filepath):
    ...
    Args:
        filepath (str, optional): JSON file path. Defaults to "FaStFig_presets.json".
    """
    try:
...
def generate_example(filepath="FaStFig_presets_example.json"):
    """generates a preset example that can be modified for custom presets

    Args:
        filepath (str, optional): JSON file path. Defaults to "FaStFig_presets_example.json".
    """
