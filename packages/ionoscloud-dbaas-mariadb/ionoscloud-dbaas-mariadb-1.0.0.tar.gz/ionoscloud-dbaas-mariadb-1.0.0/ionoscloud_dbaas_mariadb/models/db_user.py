...
class DBUser(object):
    ...
    def username(self):
        ...
        The username for the initial MariaDB user. Some system usernames are restricted (e.g. \"mariadb\", \"admin\", \"standby\").  The username should be compliant with the following rules: - Must not exceed 16 characters - Must start with a letter - Must contain only letters, numbers, or underscores   # noqa: E501
    ...
    def username(self, username):
        ...
        if (self.local_vars_configuration.client_side_validation and
                username is not None and not re.search(r'^[a-zA-Z]([a-zA-Z0-9]+_)*[a-zA-Z0-9]+$', username)):  # noqa: E501
            raise ValueError(r"Invalid value for `username`, must be a follow pattern or equal to `/^[a-zA-Z]([a-zA-Z0-9]+_)*[a-zA-Z0-9]+$/`")  # noqa: E501
    ...
    def password(self):
        ...
        The password for a MariaDB user.  # noqa: E501
