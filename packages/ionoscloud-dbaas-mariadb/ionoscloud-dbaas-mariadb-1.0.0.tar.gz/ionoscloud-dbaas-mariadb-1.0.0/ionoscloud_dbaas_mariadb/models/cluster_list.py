...
class ClusterList(object):
    ...
    @property
    def total(self):
        """Gets the total of this ClusterList.  # noqa: E501

        The total number of elements matching the request (without pagination).   # noqa: E501

        :return: The total of this ClusterList.  # noqa: E501
        :rtype: int
        """
        return self._total
    ...
    def total(self, total):
        """Sets the total of this ClusterList.

        The total number of elements matching the request (without pagination).   # noqa: E501

        :param total: The total of this ClusterList.  # noqa: E501
        :type total: int
        """
        if (self.local_vars_configuration.client_side_validation and
