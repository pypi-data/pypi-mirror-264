...
setup(
    name=NAME,
    version=VERSION,
    description="Python SDK for the ionoscloud-dbaas-mariadb API",
    author='Ionos Cloud',
    author_email='sdk@cloud.ionos.com',
    long_description=long_desc,
    long_description_content_type='text/markdown',
    url="https://github.com/ionos-cloud/sdk-python-dbaas-mariadb",
    keywords=["OpenAPI", "OpenAPI-Generator", "IONOS DBaaS MariaDB REST API"],
    install_requires=REQUIRES,
    packages=['ionoscloud_dbaas_mariadb', 'ionoscloud_dbaas_mariadb.api', 'ionoscloud_dbaas_mariadb.models'],
