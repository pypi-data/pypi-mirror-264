...
class CreateClusterProperties(object):
    ...
    def __init__(self, mariadb_version=None, instances=None, cores=None, ram=None, storage_size=None, connections=None, display_name=None, maintenance_window=None, credentials=None, local_vars_configuration=None):  # noqa: E501
    ...
    def mariadb_version(self):
        """Gets the mariadb_version of this CreateClusterProperties.  # noqa: E501


        :return: The mariadb_version of this CreateClusterProperties.  # noqa: E501
    ...
    def mariadb_version(self, mariadb_version):
        """Sets the mariadb_version of this CreateClusterProperties.


        :param mariadb_version: The mariadb_version of this CreateClusterProperties.  # noqa: E501
        :type mariadb_version: MariadbVersion
        """
        if self.local_vars_configuration.client_side_validation and mariadb_version is None:  # noqa: E501
            raise ValueError("Invalid value for `mariadb_version`, must not be `None`")  # noqa: E501
    ...
    def connections(self):
        ...
        The network connection for your cluster. Only one connection is allowed.   # noqa: E501
