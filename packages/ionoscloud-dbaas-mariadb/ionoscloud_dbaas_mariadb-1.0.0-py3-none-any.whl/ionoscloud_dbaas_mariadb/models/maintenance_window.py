...
class MaintenanceWindow(object):
    ...
    def time(self, time):
        ...
        if (self.local_vars_configuration.client_side_validation and
                time is not None and not re.search(r'^(2[0-3]|[01]?[0-9]):([0-5]?[0-9]):([0-5]?[0-9])$', time)):  # noqa: E501
            raise ValueError(r"Invalid value for `time`, must be a follow pattern or equal to `/^(2[0-3]|[01]?[0-9]):([0-5]?[0-9]):([0-5]?[0-9])$/`")  # noqa: E501
