...
class SystemCls:
	...
	def recall(self, path_name: str) -> None:
		...
		Selects and uploads a *.savrcltxt file with previously saved R&S AREG800A settings from the default or a specified
		directory. \n
	...
	def save(self, path_name: str) -> None:
		...
		Saves the current R&S AREG800A settings in a file. To deteremine the file name and storage location, enter the directory
		and file name with the command. According to the file type, the R&S AREG800A assigns the extension (*.
