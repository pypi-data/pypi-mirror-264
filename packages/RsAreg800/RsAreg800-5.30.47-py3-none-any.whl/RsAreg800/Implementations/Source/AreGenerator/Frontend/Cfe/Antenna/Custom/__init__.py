...
class CustomCls:
	...
	def export_file(self, export_filename: str, channel=repcap.Channel.Default) -> None:
		...
		Snippet: driver.source.areGenerator.frontend.cfe.antenna.custom.export_file(export_filename = 'abc', channel = repcap.Channel.Default) \n
		...
		self._core.io.write(f'SOURce<HwInstance>:AREGenerator:FRONtend:CFE{channel_cmd_val}:ANTenna:CUSTom:EXPort {param}')
