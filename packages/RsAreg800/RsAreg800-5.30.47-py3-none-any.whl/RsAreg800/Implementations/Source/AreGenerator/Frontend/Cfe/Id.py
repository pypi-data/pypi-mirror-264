...
class IdCls:
	...
	def get(self, channel=repcap.Channel.Default) -> int:
		...
		Snippet: value: int = driver.source.areGenerator.frontend.cfe.id.get(channel = repcap.Channel.Default) \n
		...
		response = self._core.io.query_str(f'SOURce<HwInstance>:AREGenerator:FRONtend:CFE{channel_cmd_val}:ID?')
