...
class RsAreg800:
	...
	_driver_options = "SupportedInstrModels = AREG, SupportedIdnPatterns = AREG, SimulationIdnString = 'Rohde&Schwarz,AREG800A,100001,5.30.47.0007'"
	...
	def __init__(self, resource_name: str, id_query: bool = True, reset: bool = False, options: str = None, direct_session: object = None):
		...
		self._core.driver_version = '5.30.47.0007'
	...
	def assert_minimum_version(min_version: str) -> None:
		...
		curr_version_list = '5.30.47.0007'.split('.')
		...
		for i in range(count):
			...
			if curr > minimum:
				break
			if curr < minimum:
				raise RsInstrException(f"Assertion for minimum RsAreg800 version failed. Current version: '5.30.47.0007', minimum required version: '{min_version}'")
