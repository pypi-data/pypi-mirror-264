...
from ..core.config import CACHE_PATH, SCAN_API_INTERVAL, OUTPUT_PATH, chain_config
...
class ScanAPI(object):
    ...
    def __init__(self, api_url) -> None:
        ...
        self._source_path = os.path.join(OUTPUT_PATH, "source", re.findall("//(.*)?/", self.api_url)[0])
