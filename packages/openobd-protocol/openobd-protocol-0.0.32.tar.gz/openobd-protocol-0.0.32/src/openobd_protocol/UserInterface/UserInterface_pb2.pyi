...
class UserInterface(_message.Message):
    __slots__ = ("target", "control_label", "control_options", "control_continue", "control_yesno", "control_freetext")
    ...
    def __init__(self, target: _Optional[_Union[InterfaceType, str]] = ..., control_label: _Optional[_Union[Label, _Mapping]] = ..., control_options: _Optional[_Union[Options, _Mapping]] = ..., control_continue: _Optional[_Union[Continue, _Mapping]] = ..., control_yesno: _Optional[_Union[YesNo, _Mapping]] = ..., control_freetext: _Optional[_Union[FreeText, _Mapping]] = ...) -> None: ...
