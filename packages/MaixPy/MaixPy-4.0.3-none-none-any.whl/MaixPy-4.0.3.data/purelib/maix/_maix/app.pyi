...
__all__ = ['APP_Info', 'Version', 'app_id', 'exit_flag', 'get_app_config_kv', 'get_app_config_path', 'get_app_data_path', 'get_app_path', 'get_apps_info', 'get_apps_info_path', 'get_exit_msg', 'get_font_path', 'get_icon_path', 'get_picture_path', 'get_share_path', 'get_sys_config_kv', 'get_tmp_path', 'get_video_path', 'have_exit_msg', 'set_app_config_kv', 'set_app_id', 'set_exit_flag', 'set_exit_msg', 'switch_app']
class APP_Info:
    author: str
    desc: str
    descs: dict[str, str]
...
def switch_app(app_id: str, idx: int = -1) -> None:
    ...
    Call this API will call set_exit_flag(true), you should check app::exit_flag() in your code.
    And exit this APP if app::exit_flag() return true.
