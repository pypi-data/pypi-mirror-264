...
class HaarCascade:
    def __init__(self) -> None:
        ...
class Image:
    def __init__(self, width: int, height: int, format: Format = ..., data: capsule = None, data_size: int = -1, copy: bool = True) -> None:
        ...
    def __str__(self) -> str:
        """
        To string method
    ...
    def draw_rect(self, x: int, y: int, w: int, h: int, color: Color, thickness: int = 1) -> Image:
        ...
        Returns: this image object self
        """
    def draw_text(self, x: int, y: int, text: str, color: Color = ..., scale: float = 1, thickness: int = -1, wrap: bool = True, wrap_space: int = 4, font: str = '') -> Image:
        """
        Draw text on image
...
def set_default_font(name: str) -> maix._maix.err.Err:
    ...
    Returns: error code, err::ERR_NONE is ok, other is error
    """
def text_size(text: str, scale: float = 1, thickness: int = 1, font: str = '') -> Size:
    """
