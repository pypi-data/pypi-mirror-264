...
import typing
__all__ = ['File', 'SEEK', 'abspath', 'basename', 'dirname', 'exists', 'getcwd', 'getsize', 'isabs', 'isdir', 'isfile', 'islink', 'listdir', 'mkdir', 'open', 'realpath', 'remove', 'rename', 'rmdir', 'splitext', 'tempdir']
class File:
    def close(self) -> None:
        """
        Close a file
