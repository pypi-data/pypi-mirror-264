...
class Ui_QSOFormDialog(object):
    def setupUi(self, QSOFormDialog):
        ...
        self.page.setGeometry(QtCore.QRect(0, 0, 557, 482))
        ...
        self.page_2.setGeometry(QtCore.QRect(0, 0, 540, 484))
        ...
        self.lotwGroupBox = QtWidgets.QGroupBox(parent=self.page_2)
        ...
        self.verticalLayout_6.addWidget(self.lotwGroupBox)
