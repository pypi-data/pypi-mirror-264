...
class SensorMetricSample(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["sampled_at", b"sampled_at", "value", b"value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["metric", b"metric", "sampled_at", b"sampled_at", "value", b"value"]) -> None: ...
