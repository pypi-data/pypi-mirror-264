...
class MetricValueVariant(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["aggregated_metric", b"aggregated_metric", "metric_value_variant", b"metric_value_variant", "simple_metric", b"simple_metric"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["aggregated_metric", b"aggregated_metric", "metric_value_variant", b"metric_value_variant", "simple_metric", b"simple_metric"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["metric_value_variant", b"metric_value_variant"]) -> typing_extensions.Literal["simple_metric", "aggregated_metric"] | None: ...
...
class MetricSample(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_source", b"_source", "sampled_at", b"sampled_at", "source", b"source", "value", b"value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_source", b"_source", "bounds", b"bounds", "metric", b"metric", "sampled_at", b"sampled_at", "source", b"source", "value", b"value"]) -> None: ...
