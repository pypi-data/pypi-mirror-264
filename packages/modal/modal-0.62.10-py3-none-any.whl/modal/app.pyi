...
class _ContainerApp:
    ...
    async def init(self, client: modal.client._Client, app_id: str, function_def: typing.Union[modal_proto.api_pb2.Function, None] = None):
        ...
...
class ContainerApp:
    ...
    class __init_spec(typing_extensions.Protocol):
        def __call__(self, client: modal.client.Client, app_id: str, function_def: typing.Union[modal_proto.api_pb2.Function, None] = None):
            ...
