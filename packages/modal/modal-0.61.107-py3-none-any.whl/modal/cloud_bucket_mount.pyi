...
class _CloudBucketMount:
    ...
    def __init__(self, bucket_name: str, secret: typing.Union[modal.secret._Secret, None] = None, read_only: bool = False, bucket_type: typing.Union[BucketType, str] = 's3') -> None:
        ...
...
class CloudBucketMount:
    ...
    def __init__(self, bucket_name: str, secret: typing.Union[modal.secret.Secret, None] = None, read_only: bool = False, bucket_type: typing.Union[BucketType, str] = 's3') -> None:
        ...
