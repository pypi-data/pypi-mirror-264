...
def plot_zp_fitting(filt, zp_fitting_data, zp_data="", ax=plt, mag_low=14,
                    ...
                    filters_colors = None, xpsp = False,
                    shorts = False, cut_top = True):
    ...
    if zoom:
        ...
        if cut_top:
            ax.fill_between([0,1], [0.9, 0.9], [1,1], color = "#000000", transform = ax.transAxes)
...
def plot_stlocus(ref_data, cat_data, ax, mag1, mag2, mag3, mag4, xlim, ylim,
    ...
    ax.fill_between([0, 0.1], [0,0], [1,1], color = "#000000", alpha = 0.5, zorder = 10, transform=ax.transAxes)
    ax.fill_between([0.9, 1], [0,0], [1,1], color = "#000000", alpha = 0.5, zorder = 10, transform=ax.transAxes)
    ax.fill_between([0, 1], [0.9, 0.9], [1, 1], color = "#000000", alpha = 0.5, zorder = 10, transform=ax.transAxes)
    ax.fill_between([0, 1], [0, 0], [0.1, 0.1], color = "#000000", alpha = 0.5, zorder = 10, transform=ax.transAxes)
...
ax.fill_between([0, 1], [0.8, 0.8], [1, 1], color = color0, transform = ax.transAxes)
############################################
# Plot coords
...
ax = axs['23']
ax.set_facecolor(color0)
ax.fill_between([0,1], [0.12,0.12], [0.95,0.95], color = color1,
...
plot_zp_fitting("SPLUS_U", zp_ext_data, zp_ext, ax = ax,
                mag_low = mag_low, mag_up = mag_up, label_color = color2,
                filters_colors=filters_colors, zoom = False, cut_top=False, shorts = conf['shorts'])
