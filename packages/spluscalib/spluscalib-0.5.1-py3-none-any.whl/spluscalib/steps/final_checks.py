...
if __name__ == "__main__":
    ...
    summary_cols = ["Field", "Calib", "fits_are_checkable", 
                    "SExPhotDual__status", "SExPhotSingle__status", 
                    "PSFphot__status", "Xmatch__status", "ZP_XPSP__status", 
                    "ZP_final__status", "ZP_gaiascale__status", 
                    "MosaicPlot__status", "CatDual__status", "CatSingle__status", 
                    "CatPSF__status"]
