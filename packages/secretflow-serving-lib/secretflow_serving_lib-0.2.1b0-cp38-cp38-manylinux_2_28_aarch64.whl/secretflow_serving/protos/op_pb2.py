...
_OPTAG = DESCRIPTOR.message_types_by_name['OpTag']
_OPDEF = DESCRIPTOR.message_types_by_name['OpDef']
IoDef = _reflection.GeneratedProtocolMessageType('IoDef', (_message.Message,), {
  'DESCRIPTOR' : _IODEF,
  '__module__' : 'secretflow_serving.protos.op_pb2'
  # @@protoc_insertion_point(class_scope:secretflow.serving.op.IoDef)
  })
_sym_db.RegisterMessage(IoDef)

OpTag = _reflection.GeneratedProtocolMessageType('OpTag', (_message.Message,), {
  'DESCRIPTOR' : _OPTAG,
  '__module__' : 'secretflow_serving.protos.op_pb2'
  # @@protoc_insertion_point(class_scope:secretflow.serving.op.OpTag)
  })
_sym_db.RegisterMessage(OpTag)

OpDef = _reflection.GeneratedProtocolMessageType('OpDef', (_message.Message,), {
  'DESCRIPTOR' : _OPDEF,
  '__module__' : 'secretflow_serving.protos.op_pb2'
  # @@protoc_insertion_point(class_scope:secretflow.serving.op.OpDef)
  })
