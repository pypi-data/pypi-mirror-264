...
from CherwellAPI.ServerObjects import ServerObject
...
class Connection:
    ...
    def get_new_business_object(self, business_object_name, refresh=False):
        ...
        new_business_object = ServerObject(business_object_name, self._get_authorisation_header,
    ...
    def get_business_objects(self, filter_object):
        ...
        while True:
            # Setup the payload
            payload = {"busObID": "93dada9f640056ce1dc67b4d4bb801f69104894dc8", "filters": filter_info,
