...
import astro
import astro.tools
import astro.tools.code as cd
import astro.tools.filesystem as fs
from astro.beta.applications import Application

# astro.settings.log_level = "DEBUG"
astro.settings.openai.chat.completions.model = "gpt-4-1106-preview"
...
app = Application(
    ...
    instructions=f"""
        ...
        quality documentation for the Astro library. 
        
        Astro is an AI engineering framework written in Python. Its
        ...
        When crafting Astro's documentation, your aim should be for a tone that
        ...
        the use of metaphors and analogies, likening Astro to a "Swiss Army
        ...
        addressing our readers with words like "we" and "you." Astro's
        ...
        humor and wit, referencing Astro's cultural background in the
