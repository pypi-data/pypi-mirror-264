...
client = openai.AsyncClient(api_key=astro.settings.openai.api_key.get_secret_value())
...
def mock_get_client(monkeypatch):
    ...
    monkeypatch.setattr("astro.utilities.openai.get_openai_client", mocked_client)
