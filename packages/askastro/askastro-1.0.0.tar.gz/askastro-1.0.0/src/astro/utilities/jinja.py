...
from astro.types import BaseMessage as Message
...
class BaseEnvironment(BaseModel):
    ...
    def render(self, template: Union[str, BaseTemplate], **kwargs: Any) -> str:
        ...
        Example:
            ...
            ```python
            from astro.utilities.jinja import Environment as jinja_env
...
def split_text_by_tokens(
    ...
    Example:
        ...
        astro.utilities.jinja import split_text_by_tokens
