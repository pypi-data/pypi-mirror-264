...
from nebula import task as nebula_task
from pydantic import BaseModel, Field
from typing_extensions import ParamSpec

from astro.beta.assistants import Assistant, Run, Thread
from astro.beta.assistants.runs import CancelRun
from astro.tools.assistants import AssistantTool
from astro.utilities.context import ScopedContext
from astro.utilities.jinja import Environment as JinjaEnvironment
from astro.utilities.tools import tool_from_function, tool_from_type
...
class AITask(BaseModel, Generic[P, T]):
    ...
    def __call__(self, *args: P.args, _thread_id: str = None, **kwargs: P.kwargs) -> T:
        ...
        ptask = nebula_task(name=self.name)(self.call)
