...
from astro.tools.assistants import AssistantTool, CancelRun
from astro.types import Tool
from astro.utilities.asyncio import ExposeSyncMethodsMixin, expose_sync_method
    ...
    async def get_tool_outputs(self, run: OpenAIRun) -> list[dict[str, str]]:
        ...
        if run.required_action.type == "submit_tool_outputs":
            ...
            for tool_call in run.required_action.submit_tool_outputs.tool_calls:
                try:
                    output = astro.utilities.tools.call_function_tool(
                        tools=tools,
