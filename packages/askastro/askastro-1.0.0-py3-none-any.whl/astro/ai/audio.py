...
from astro.types import Audio, HttpxBinaryResponseContent, SpeechRequest
from astro.utilities.asyncio import run_sync
from astro.utilities.jinja import Environment
...
async def generate_speech(
    ...
    response = await AsyncAstroClient().generate_speech(**request.model_dump())
    data = response.read()
...
async def transcribe_async(
    ...
    transcript = await AsyncAstroClient().generate_transcript(
