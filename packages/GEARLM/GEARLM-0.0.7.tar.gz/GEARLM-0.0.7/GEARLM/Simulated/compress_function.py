...
def compress_insert_function(
    ...
    if compress_config.compress_method[layer_idx] == "outliterquantize_with_lrap_preserving":
        ...
        previous_key[:,:,compress_config.start_saving:-compress_config.locality_saving,:] = fake_outquant_with_lrap(
            previous_key[:,:,compress_config.start_saving:-compress_config.locality_saving,:],
            compress_config.quantize_bit[layer_idx],
            rank_k,
            compress_config.loop[layer_idx],
            compress_config.left[layer_idx],
        ...
        if previous_value is not None:
            previous_value[:,:,compress_config.start_saving:-compress_config.locality_saving,:] = fake_outquant_with_lrap(
                previous_value[:,:,compress_config.start_saving:-compress_config.locality_saving,:],
                compress_config.quantize_bit[layer_idx],
                rank_v,
                compress_config.loop[layer_idx],
                compress_config.left[layer_idx],
