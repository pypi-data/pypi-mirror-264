...
class Deployment(APIObject, MonitoringDataQueryBuilderMixin, BrowserMixin):
    ...
    def list_prediction_data_exports(self) -> List[PredictionDataExport]:
        """
        ...
        """
        return PredictionDataExport.list(deployment_id=self.id)

    def list_actuals_data_exports(self) -> List[ActualsDataExport]:
        """
        ...
        """
        return ActualsDataExport.list(deployment_id=self.id)
