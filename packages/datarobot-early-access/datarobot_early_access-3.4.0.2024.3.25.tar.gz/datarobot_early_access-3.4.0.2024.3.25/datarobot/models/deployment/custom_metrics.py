...
class CustomMetric(APIObject):
    ...
    def report_single_value(
        ...
        .. code-block:: python
            ...
            # for deployment specific metrics
            custom_metric.submit_values(value=121)

            # for model specific metrics pass model_package_id or model_id
            custom_metric.report_single_value(value=121, model_package_id="6421df32525c58cc6f991f25")

            # dry run
            custom_metric.submit_values(value=121, model_package_id="6421df32525c58cc6f991f25", dry_run=True)

            # for segmented analysis
            segments = [{"name": "custom_seg", "value": "val_1"}]
            custom_metric.submit_values(value=121, model_package_id="6421df32525c58cc6f991f25", segments=segments)
        """
    ...
    def submit_values_from_catalog(
        ...
        .. code-block:: python
            ...
            # for deployment specific metrics
            custom_metric.submit_values(dataset_id="61093144cabd630828bca321")

            # for model specific metrics pass model_package_id or model_id
            custom_metric.report_single_value(
    ...
    def get_values_over_time(
        ...
        bucket_size: str = BUCKET_SIZE.PT1H,
