...
def load_linear_emu(verbose=True):
    ...
    emulator['model_cold'] = load_model(
        emulator_cold_name, custom_objects=customs, compile=False)
    ...
    emulator['model_tot'] = load_model(
        emulator_tot_name, custom_objects=customs, compile=False)
...
def load_sigma8_emu(verbose=True):
    ...
    emulator['model'] = load_model(
        emulator_name, custom_objects=customs, compile=False)
