...
class CategoryService(BaseService):
    ...
    def _up_tree_category(self, category_code: int, category_dict: dict[int, Any],
        ...
        if tmp_category:
            if tmp_category.parent_code and recursion:
                category_list.extend(self._up_tree_category(tmp_category.parent_code, category_dict, recursion=recursion))
    ...
    def get_category_list(self, category_code: int, group_code: int = None, category_dict: dict[int, Any] = None,
        ...
        return self._up_tree_category(category_code, category_dict,
                                      recursion=recursion) if up else self._down_tree_category(category_code,
                                                                                               category_dict,
                                                                                               recursion=recursion)
