...
import requests
from seaplane.gen.carrier import Bucket, ObjectApi
...
class ObjectStorageAPI:
    ...
    @method_with_token
    def create_bucket(
        self, token: str, bucket_name: str, body: Optional[Dict[str, Any]] = None
    ) -> None:
        """
        Create a new bucket
    ...
    def delete_bucket(self, token: str, bucket_name: str) -> None:
        ...
        api = self.get_object_api(token)
        api.delete_bucket(bucket_name=bucket_name)
