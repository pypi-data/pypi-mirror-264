...
impl PyModel {
    ...
    pub fn align_cdr3(
        ...
        let cdr3_dna = righor::Dna::from_string(cdr3_seq)?;
        self.inner.align_from_cdr3(cdr3_dna, vgenes, jgenes)
    }
    ...
    pub fn recreate_full_sequence(
        ...
        Ok(self
            .inner
            .recreate_full_sequence(&righor::Dna::from_string(dna)?, vgene, jgene)
            .get_string())
    }
