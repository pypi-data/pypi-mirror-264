...
from venty.aggregate_root import DataclassAggregateRoot, AggregateUUID
from venty.in_memory_event_store import InMemoryEventStore


class Book(DataclassAggregateRoot):
    name: Optional[str]
    ...
    def aggregate_uuid(self) -> AggregateUUID:
        ...
        return AggregateUUID(self.name)
...
def test_store_integration():
    the_idiot = AggregateUUID("The Idiot")
