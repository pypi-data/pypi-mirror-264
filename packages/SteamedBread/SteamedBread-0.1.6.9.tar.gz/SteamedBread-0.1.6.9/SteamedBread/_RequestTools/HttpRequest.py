...
def post(url, data=None, show=True, json=None, headers=None, cookies=None, timeout=10, verify=None, **kwargs):
...
def put(url, data=None, show=True, headers=None, cookies=None, timeout=10, verify=None, **kwargs):
...
def delete(url, show=True, headers=None, cookies=None, timeout=10, verify=None, **kwargs):
