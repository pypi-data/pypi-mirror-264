...
class Setup(object):
    ...
    def _get_parts(self):
        ...
        # for part in parts:
        #     thread = threading.Thread(target=create_part, args=(part['id'], part['type']))
    ...
    def add_optics(self, number_id, label = None, pose = None):
        print(f'Adding part with number {number_id} to setup {self.name}.')
    ...
    def add_light_source(self, label = None, pose = None):
        print(f'Adding light source to setup {self.name}.')
    ...
    def add_detector(self, label = None, pose = None):
        print(f'Adding detector to setup {self.name}.')
