...
def _init(**kwargs):
    ...
    src_dir = os.path.join(os.getcwd(), Config.src_dir)
...
def run(script_name):
    ...
    cli_command = Config.scripts.get(script_name, None)
        ...
        if python_command:
            ...
            if python_path:
                ...
                if targ_dir:
                    ...
                    if targ_dir[0][:-1] == Config.test_dir:
                        cli_command = f'set PYTHONPATH=C:\{Config.src_dir};%PYTHONPATH% && {cli_command}'
