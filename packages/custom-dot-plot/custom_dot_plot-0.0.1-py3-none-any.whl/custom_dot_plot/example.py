...
with st.columns([1,8,1])[1]:
    my_component(categoryOneData=categoryOneData, categoryTwoData=categoryTwoData, indexTitle=indexTitle, columnTitle=columnTitle, firstCategoryTitle=firstCategoryTitle, secondCategoryTitle=secondCategoryTitle, Legends=Legends)
