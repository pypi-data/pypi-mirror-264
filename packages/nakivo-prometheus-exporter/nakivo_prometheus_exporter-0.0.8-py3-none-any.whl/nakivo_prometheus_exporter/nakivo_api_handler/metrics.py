...
try:
    from nakivo_prometheus_exporter.nakivo_api_handler.prom_parser import load_config_file, get_nakivo_data
except ImportError:
    from nakivo_api_handler.prom_parser import load_config_file, get_nakivo_data
