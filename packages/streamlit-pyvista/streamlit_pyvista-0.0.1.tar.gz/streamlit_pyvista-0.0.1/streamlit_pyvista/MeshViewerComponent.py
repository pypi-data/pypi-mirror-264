...
class MeshViewerComponent:
    ...
    def run_trame_viewer(self):
        try:
            pass
            subprocess.run(["python3", os.path.dirname(os.path.abspath(__file__)) + "/trame_viewer.py"], check=True) #stdout=subprocess.DEVNULL,  stderr=subprocess.DEVNULL,
    ...
    def set_mesh(self):
        ...
        url = self.server_url + "/select_mesh"
        data = {
