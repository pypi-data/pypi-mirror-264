...
Metric = Literal[
    'auc', 'prc-auc', 'rmse', 'mae', 'mse', 'r2', 'accuracy', 'cross_entropy', 'binary_cross_entropy', 'sid',
...
class TrainArgs(CommonArgs):
    ...
    def process_args(self) -> None:
        ...
        for (features_argument, base_features_path, val_features_path, test_features_path) in [
            ...
            ('`--bond_features_path`', self.bond_features_path, self.separate_val_bond_features_path,
