...
class TableComputeOp(_message.Message):
    __slots__ = ("empty", "select_from_staging", "rename_columns", "join", "select_columns", "limit_rows", "filter_rows", "distinct_rows", "update_metadata", "set_metadata", "remove_from_metadata", "update_feature_types", "rollup_by_aggregation")
