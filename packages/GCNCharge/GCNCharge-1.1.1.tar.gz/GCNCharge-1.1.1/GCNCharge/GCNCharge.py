...
def write4cif(mof,chg,charge,di,neutral):
...
def predict(cif_file,model_name,di,neutral):
    if model_name == "MOF":
        model_ddec_name = resource_filename('GCNCharge', 'mof.pth')
        ddec_nor_name = resource_filename('GCNCharge', 'mof.pkl')
    elif model_name == "COF":
        model_ddec_name = resource_filename('GCNCharge', 'cof.pth')
        ddec_nor_name = resource_filename('GCNCharge', 'cof.pkl')
    ...
    try:
        ...
        for _, (input) in enumerate(loader):
            with torch.no_grad():
                ...
                write4cif(cif_file,chg,charge = True,di=di,neutral=neutral)
    except Exception as e:
        print(e)