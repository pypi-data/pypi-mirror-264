...
def falsepositive(ad_sp,ad_sc,train_gene=[],device='cuda:0'):
    """
    ...
    ad_map = tg.map_cells_to_space(adata_sc=ad_sc, adata_sp=ad_sp, density_prior='uniform', device=device,
                                   verbose=False)
    ...
    return moran_ad_sp, moran_ad_sc, ad_ge


def generate_membership_anndata(dd, bb):
    """
