...
def spatial_bigcells(adata, method='walktrap', n_pca=30, n_neighbors=200, n_jobs=4, distance_threshold=50, p=5,
                     resolution=1,celltypes='celltype',
    ...
    """
        ...
        Parameters:
            ...
            p (int, optional): The desired number of cells per metacell.
            resolution (float, optional): Resolution parameter for certain clustering methods like Leiden. Default is 1.
    ...
    if method == 'walktrap':
        ...
        clusters = G.community_infomap(edge_weights=weights, vertex_weights=node_weight)
