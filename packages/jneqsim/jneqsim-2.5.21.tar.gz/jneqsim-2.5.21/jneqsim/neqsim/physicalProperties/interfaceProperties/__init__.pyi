...
class InterphasePropertiesInterface(java.lang.Cloneable):
    ...
    @typing.overload
    def getAdsorptionCalc(self, string: str) -> jneqsim.neqsim.physicalProperties.interfaceProperties.solidAdsorption.AdsorptionInterface: ...
    @typing.overload
    ...
    @typing.overload
    def getSurfaceTension(self, int: int, int2: int, string: str) -> float: ...
    ...
    @typing.overload
    def setInterfacialTensionModel(self, string: str, string2: str, string3: str) -> None: ...
    def setSolidAdsorbentMaterial(self, string: str) -> None: ...
