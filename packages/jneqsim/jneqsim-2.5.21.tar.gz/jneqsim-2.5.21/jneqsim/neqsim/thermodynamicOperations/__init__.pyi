...
class ThermodynamicOperations(java.io.Serializable, java.lang.Cloneable):
    ...
    def OLGApropTable(self, double: float, double2: float, int: int, double3: float, double4: float, int2: int, string: str, int3: int) -> None: ...
    def OLGApropTablePH(self, double: float, double2: float, int: int, double3: float, double4: float, int2: int, string: str, int3: int) -> None: ...
    @typing.overload
    def PHflash(self, double: float) -> None: ...
    @typing.overload
    def PHflash(self, double: float, int: int) -> None: ...
    @typing.overload
    def PHflash(self, double: float, string: str) -> None: ...
    ...
    @typing.overload
    def PSflash(self, double: float, string: str) -> None: ...
    def PSflash2(self, double: float) -> None: ...
    def PSflashGERG2008(self, double: float) -> None: ...
    @typing.overload
    def PUflash(self, double: float) -> None: ...
    @typing.overload
    def PUflash(self, double: float, double2: float, string: str, string2: str) -> None: ...
    @typing.overload
    def PUflash(self, double: float, string: str) -> None: ...
    def PVrefluxFlash(self, double: float, int: int) -> None: ...
    def TPSolidflash(self) -> None: ...
    def TPVflash(self, double: float, string: str) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def TSflash(self, double: float, string: str) -> None: ...
    @typing.overload
    def TVflash(self, double: float) -> None: ...
    @typing.overload
    def TVflash(self, double: float, string: str) -> None: ...
    @typing.overload
    def VHflash(self, double: float, double2: float) -> None: ...
    @typing.overload
    def VHflash(self, double: float, double2: float, string: str, string2: str) -> None: ...
    @typing.overload
    def VSflash(self, double: float, double2: float) -> None: ...
    @typing.overload
    def VSflash(self, double: float, double2: float, string: str, string2: str) -> None: ...
    @typing.overload
    def VUflash(self, double: float, double2: float) -> None: ...
    @typing.overload
    def VUflash(self, double: float, double2: float, string: str, string2: str) -> None: ...
    def addData(self, string: str, doubleArray: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray]) -> None: ...
    def addIonToScaleSaturation(self, int: int, string: str, string2: str) -> None: ...
    @typing.overload
    ...
    def calcSaltSaturation(self, string: str) -> None: ...
    @typing.overload
    def calcSolidComlexTemperature(self) -> None: ...
    @typing.overload
    def calcSolidComlexTemperature(self, string: str, string2: str) -> None: ...
    ...
    def dTPflash(self, stringArray: typing.Union[typing.List[str], jpype.JArray]) -> None: ...
    def dewPointMach(self, string: str, string2: str, double: float) -> None: ...
    ...
    def displayResult(self) -> None: ...
    def flash(self, flashType: 'ThermodynamicOperations.FlashType', double: float, double2: float, string: str, string2: str) -> None: ...
    @typing.overload
    def freezingPointTemperatureFlash(self) -> None: ...
    @typing.overload
    def freezingPointTemperatureFlash(self, string: str) -> None: ...
    def get(self, string: str) -> typing.MutableSequence[float]: ...
    def getData(self) -> typing.MutableSequence[typing.MutableSequence[float]]: ...
    def getDataPoints(self) -> typing.MutableSequence[typing.MutableSequence[str]]: ...
    ...
    def hydrateInhibitorConcentration(self, string: str, double: float) -> None: ...
    def hydrateInhibitorConcentrationSet(self, string: str, double: float) -> None: ...
    def isRunAsThread(self) -> bool: ...
    def printToFile(self, string: str) -> None: ...
    def propertyFlash(self, list: java.util.List[float], list2: java.util.List[float], int: int, list3: java.util.List[str], list4: java.util.List[java.util.List[float]]) -> jneqsim.neqsim.api.ioc.CalculationResult: ...
    def run(self) -> None: ...
    ...
    class FlashType(java.lang.Enum['ThermodynamicOperations.FlashType']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: str) -> 'ThermodynamicOperations.FlashType': ...
        @staticmethod
