...
class pTphaseEnvelope(jneqsim.neqsim.thermodynamicOperations.BaseOperation):
    ...
    def __init__(self): ...
    @typing.overload
    def __init__(self, systemInterface: jneqsim.neqsim.thermo.system.SystemInterface, string: str, double: float, double2: float, boolean: bool): ...
...
class pTphaseEnvelopeNew(jneqsim.neqsim.thermodynamicOperations.BaseOperation):
    points2: typing.MutableSequence[typing.MutableSequence[float]] = ...
    def __init__(self, systemInterface: jneqsim.neqsim.thermo.system.SystemInterface, string: str, double: float, double2: float): ...
    def displayResult(self) -> None: ...
    def get(self, string: str) -> typing.MutableSequence[float]: ...
    def getJFreeChart(self, string: str) -> org.jfree.chart.JFreeChart: ...
    def getPoints(self, int: int) -> typing.MutableSequence[typing.MutableSequence[float]]: ...
...
class CricondenBarFlash(pTphaseEnvelope):
    def __init__(self, systemInterface: jneqsim.neqsim.thermo.system.SystemInterface, string: str, double: float, doubleArray: typing.Union[typing.List[float], jpype.JArray], doubleArray2: typing.Union[typing.List[float], jpype.JArray], doubleArray3: typing.Union[typing.List[float], jpype.JArray]): ...
    def funcP(self) -> None: ...
    def funcT(self) -> None: ...
    def init(self) -> None: ...
    def run(self) -> None: ...
