...
class Standard_ISO6976(jneqsim.neqsim.standards.Standard, jneqsim.neqsim.thermo.ThermodynamicConstantsInterface):
    ...
    def __init__(self, systemInterface: jneqsim.neqsim.thermo.system.SystemInterface): ...
    @typing.overload
    def __init__(self, systemInterface: jneqsim.neqsim.thermo.system.SystemInterface, double: float, double2: float, string: str): ...
    def calculate(self) -> None: ...
    def checkReferenceCondition(self) -> None: ...
    def createTable(self, string: str) -> typing.MutableSequence[typing.MutableSequence[str]]: ...
    def getAverageCarbonNumber(self) -> float: ...
    def getComponentsNotDefinedByStandard(self) -> java.util.ArrayList[str]: ...
    def getEnergyRefP(self) -> float: ...
    def getEnergyRefT(self) -> float: ...
    def getReferenceType(self) -> str: ...
    ...
    def setReferenceType(self, string: str) -> None: ...
