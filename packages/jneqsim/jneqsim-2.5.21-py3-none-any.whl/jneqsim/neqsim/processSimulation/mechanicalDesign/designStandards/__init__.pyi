...
class DesignStandard(java.io.Serializable):
    ...
    def __init__(self): ...
    @typing.overload
    def __init__(self, string: str, mechanicalDesign: jneqsim.neqsim.processSimulation.mechanicalDesign.MechanicalDesign): ...
    def equals(self, object: typing.Any) -> bool: ...
    def getEquipment(self) -> jneqsim.neqsim.processSimulation.mechanicalDesign.MechanicalDesign: ...
    def getStandardName(self) -> str: ...
    def hashCode(self) -> int: ...
    def setDesignStandardName(self, string: str) -> None: ...
    def setEquipment(self, mechanicalDesign: jneqsim.neqsim.processSimulation.mechanicalDesign.MechanicalDesign) -> None: ...
    def setStandardName(self, string: str) -> None: ...
...
class JointEfficiencyPipelineStandard(DesignStandard):
    ...
    def readJointEfficiencyStandard(self, string: str, string2: str) -> None: ...
...
class MaterialPipeDesignStandard(DesignStandard):
    ...
    def readMaterialDesignStandard(self, string: str, string2: str) -> None: ...
...
class MaterialPlateDesignStandard(DesignStandard):
    ...
    def readMaterialDesignStandard(self, string: str, string2: str, string3: str, int: int) -> None: ...
...
class SeparatorDesignStandard(DesignStandard):
    ...
    def getGasLoadFactor(self) -> float: ...
    def getLiquidRetentionTime(self, string: str, mechanicalDesign: jneqsim.neqsim.processSimulation.mechanicalDesign.MechanicalDesign) -> float: ...
    def getVolumetricDesignFactor(self) -> float: ...
