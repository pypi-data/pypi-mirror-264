...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_glean_core_checksum_constructor_eventmetric_new() != 45197:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_glean_core_checksum_constructor_labeledboolean_new() != 34893:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_glean_core_checksum_constructor_labeledcounter_new() != 14999:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_glean_core_checksum_constructor_labeledstring_new() != 32372:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_glean_core_checksum_constructor_numeratormetric_new() != 57995:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_glean_core_checksum_constructor_pingtype_new() != 11382:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
def glean_set_metrics_enabled_config(json: "str") -> None:
