...
class Client(object):
    ...
    def copy_get_history_trader_list(self, traderId=None, sortRule='roi', pageSize=20, pageNo=1):
        """
    ...
    def copy_get_history_trader_pendings_orders(self, productType, traderId, startTime, endTime, symbol=None):
        """
        ...
        if productType and traderId and startTime and endTime:
            ...
            params["startTime"] = startTime
            params["endTime"] = endTime
            return self._request_if_params_exist(GET, BROKER_COPY_V2_URL + '/query-current-traces', params)
        else:
            logger.error("pls check args")
            return False
