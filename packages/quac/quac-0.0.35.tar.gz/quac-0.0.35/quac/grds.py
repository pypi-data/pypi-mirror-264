...
__all__ = ['OriginTypes', 'OriginGuard', 'hashash', 'ishashable', 'hasorigin', 'isspecial', 'isnotspecial', 'isoptional',
           ...
           'isclstype', 'hasduck', 'hasload', 'hasducktype', 'istype', 'isallsame', 'isalias']
...
from .cons import NIL, NDIM, SHAPE, KEYS, VALUES, __K__, __V__, __N__, __RETANNOT__, __KVTYPES__, __NAME__, __DUCKTYPE__
