...
class TestScanFile(unittest.TestCase):
    ...
    def test_header_entries(self):
        ...
        test_dict = {'acq_time': '470.3',
                     ...
                     'multipass-config': "{'Record-Ch': ('-1', '-1', '-1', '-1'), 'Playback': ('FALSE', 'FALSE', 'FALSE', 'FALSE'), 'Playback-Offset': ('0.000E+0', '0.000E+0', '0.000E+0', '0.000E+0'), 'BOL-delay_[cycles]': ('500', '1', '500', '1'), 'Bias_override': ('TRUE', 'TRUE', 'TRUE', 'TRUE'), 'Bias_override_value': ('2.000E-1', '2.000E-1', '-2.000E-1', '-2.000E-1'), 'Z_Setp_override': ('TRUE', 'TRUE', 'TRUE', 'TRUE'), 'Z_Setp_override_value': ('1.000E-10', '1.000E-10', '6.000E-11', '6.000E-11'), 'Speed_factor': ('1.000', '1.000', '1.000', '1.000')}"}
