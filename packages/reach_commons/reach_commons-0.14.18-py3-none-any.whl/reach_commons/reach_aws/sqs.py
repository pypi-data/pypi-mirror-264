...
class OutscraperSQSNotifier(SQSClient):
    ...
    def notify_process_from_block_id(
        self,
        business_id,
        redis_key_block_id: str,
        send_notification_email: False,
        delay_seconds=1,
    ):
        message_data = {
            "business_id": business_id,
            "redis_key_block_id": redis_key_block_id,
    ...
    def notify_start_from_redis(
        self,
        business_id,
        redis_key_id: str,
        delay_seconds=1,
    ):
        message_data = {"business_id": business_id, "redis_key_id": redis_key_id}
