...
class DevBeginOp(_ods_ir.OpView):
  ...
  def __init__(self, outputs, inputs, pattern, begin_methods, *, done=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class GroupOp(_ods_ir.OpView):
  ...
  def __init__(self, outputs, inputs, nsecs, hsecs, dsecs, wsecs, csecs, swpipl_stage_num, group_type, *, flow=None, self_up_overlap_op=None, self_down_overlap_op=None, other_up_overlap_op=None, other_down_overlap_op=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class LoadOp(_ods_ir.OpView):
  ...
  def __init__(self, output, input, *, do_bcast=None, use_3ic_optimize=None, lmem_type=None, ginfo=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class StoreOp(_ods_ir.OpView):
  ...
  def __init__(self, output, input, *, ginfo=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
