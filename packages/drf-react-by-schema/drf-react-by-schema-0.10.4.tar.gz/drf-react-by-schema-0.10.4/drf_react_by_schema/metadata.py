...
class Metadata(SimpleMetadata):
    ...
    def determine_metadata(self, request, view):
        ...
        # Assign "serializermethodfield" type as text
        for serializer_field_name in serializer_fields:
            serializer_field_class_name = serializer_fields.get(
                serializer_field_name
            ).__class__.__name__
            if (
                serializer_field_class_name == "SerializerMethodField"
                and serializer_field_name in meta["actions"]["POST"]
            ):
                meta["actions"]["POST"][serializer_field_name] = "text"
