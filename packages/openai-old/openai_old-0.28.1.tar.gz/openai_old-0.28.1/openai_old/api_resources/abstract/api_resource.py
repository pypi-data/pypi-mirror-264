...
import openai_old
from openai_old import api_requestor, error, util
from openai_old.openai_object import OpenAIObject
...
class APIResource(OpenAIObject):
    ...
    def instance_url(self, operation=None):
        ...
        api_version = self.api_version or openai_old.api_version
        extn = quote_plus(id)
    ...
    def _get_api_type_and_version(
        ...
        typed_api_version = api_version or openai_old.api_version
