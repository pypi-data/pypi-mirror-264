...
import openai_old
from openai_old import api_requestor, util, error
from openai_old.api_resources.abstract import DeletableAPIResource, ListableAPIResource
...
class File(ListableAPIResource, DeletableAPIResource):
    ...
    def __prepare_file_create(
        ...
        requestor = api_requestor.APIRequestor(
            api_key,
            api_base=api_base or openai_old.api_base,
            api_type=api_type,
