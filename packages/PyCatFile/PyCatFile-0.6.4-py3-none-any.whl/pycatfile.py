...
'''
    ...
    $FileInfo: pycatfile.py - Last Update: 3/26/2024 Ver. 0.6.4 RC 1 - Author: cooldude2k $
'''
...
__version_info__ = (0, 6, 4, "RC 1", 1);
__version_date_info__ = (2024, 3, 26, "RC 1", 1);
__version_date__ = str(__version_date_info__[0]) + "." + str(__version_date_info__[1]).zfill(2) + "." + str(__version_date_info__[2]).zfill(2);
__revision__ = __version_info__[3];
__revision_id__ = "$Id: 784c08f6083cf7ce517766742fd2a5b9b59c8159 $";
