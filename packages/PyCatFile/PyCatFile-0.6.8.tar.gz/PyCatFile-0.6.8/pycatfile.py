...
'''
    ...
    $FileInfo: pycatfile.py - Last Update: 3/27/2024 Ver. 0.6.8 RC 1 - Author: cooldude2k $
'''
...
__version_info__ = (0, 6, 8, "RC 1", 1);
__version_date_info__ = (2024, 3, 27, "RC 1", 1);
__version_date__ = str(__version_date_info__[0]) + "." + str(__version_date_info__[1]).zfill(2) + "." + str(__version_date_info__[2]).zfill(2);
__revision__ = __version_info__[3];
__revision_id__ = "$Id: f758638cca06640e4e4f9c33ec13ed7e5e879ad9 $";
