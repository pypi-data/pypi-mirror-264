...
class CustomFormatter(logging.Formatter):
    ...
    FORMATS = {
        ...
        logging.DEBUG2: f"{Fore.MAGENTA}{pre}{reset} %(message)s {Fore.YELLOW}{post}{reset}",
        logging.DEBUG3: f"{Fore.RED}{pre}{reset} %(message)s {Fore.YELLOW}{post}{reset}",
        logging.DEBUG4: f"{Fore.RED}{pre}{reset} %(message)s {Fore.YELLOW}{post}{reset}",
