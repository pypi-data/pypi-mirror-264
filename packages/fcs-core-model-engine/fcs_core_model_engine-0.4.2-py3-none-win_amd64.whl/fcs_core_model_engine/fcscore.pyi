...
class Palette(object):
	@staticmethod
	def get_colour(selection: ColorSelection) -> Color: ...
	@staticmethod
	def get_specific_colour(red: int, green: int, blue: int) -> Color: ...
	@staticmethod
...
class ModelBuilder:
	...
	def add_to_model(self, geom_object: GEOM_Object, parent_id: int, publish_under_name: str, tmp_folder_path: str, add_with_refined_size: bool=True) -> int: ...
