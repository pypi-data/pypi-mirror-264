...
from ..backend import ODESolverOptions, numpy_api
...
class SimulatorOptions:
    ...
    atol: float = 1e-6  # Absolute tolerance for adaptive solvers
    min_minor_step_size: float = None
    max_minor_step_size: float = None
    max_minor_steps_per_major_step: float = None  # max_steps for ODE solver
    ...
    def ode_options(self) -> ODESolverOptions:
        return ODESolverOptions(
            rtol=self.rtol,
            atol=self.atol,
            max_steps=self.max_minor_steps_per_major_step,
    ...
    def __repr__(self) -> str:
        return (
            ...
            f"max_minor_steps_per_major_step={self.max_minor_steps_per_major_step}, "
