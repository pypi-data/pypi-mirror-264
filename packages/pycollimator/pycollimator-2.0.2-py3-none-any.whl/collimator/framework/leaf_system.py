...
from .system_base import SystemBase, InstanceParameter, UpstreamEvalError
...
class LeafSystem(SystemBase):
    ...
    #
    def _convert_to_array(self, default_value, dtype=None, shape=None) -> Array:
        assert not (
    ...
    def declare_continuous_state(
        ...
        if as_array:
            default_value = self._convert_to_array(
