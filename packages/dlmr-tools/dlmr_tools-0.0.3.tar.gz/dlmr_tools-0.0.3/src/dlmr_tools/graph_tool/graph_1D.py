...
class Graph_1D:
    ...
    def setup_axis(self, xlabel: str, ylabel: str, xmin: float = None, xmax: float = None, ymin: float = None, ymax: float = None, axis_number: int = 0, sci: bool = True, tick: int = None, color: str = None, log_scale_y: bool = False) -> None:
        """
    ...
    def setup_secondary_axis(self, ylabel: str, ymin: float = None, ymax: float = None, axis_number: int = 1, sci: bool = True, tick: int = None, color: str = None, log_scale_y: bool = False) -> None:
        """
        Setup the axis of the graph.
        """
        axis = self.__axis[axis_number]
