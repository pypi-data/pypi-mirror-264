...
small function inside the GaussianDiffusion class.  Along the same lines, I have
also either eliminated some of the functionality associated with the UNetModel
class or incorporated it in the definition of UNetModel itself.
...
--- even the images from the CelebA dataset as long as you resize them to 64x64. 
