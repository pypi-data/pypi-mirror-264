class   TRAMAS:
    ...
    def crear_trama(direccion_origen, numero_bits, direccion_destino, comando, datos):
        """
        Esta funcion construye una trama de acuerdo con la estructura proporcionada.
