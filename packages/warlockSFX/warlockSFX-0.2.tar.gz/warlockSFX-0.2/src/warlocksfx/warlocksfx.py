...
def cli():
    color()
    # define shortargs
    shortargs = ['i', 'o', 's', 'c', 'l', 'e', 'cs', 'q', 'v']
    # define longargs
    longargs = ['infile', 'outfile', 'setup', 'compress-method', 'label', 'extension', 'checksum', 'quiet', 'version']
    # get option control
    optionCTRL = options(shortargs, longargs, argv[1:], ['i','o','s'], ['infile', 'outfile', 'setup'])
    # get argument values
