...
def version():
    print(f'{_.BLUE}warlocksfx{_.RESET} - {_.BLACK}create install packages{_.RESET}')
...
def helper():
    ...
    try:
        stdscr.addstr(f'warlockSFX v{__version__}\n\n')
        stdscr.scrollok(1)
        stdscr.addstr(f'HELP TEXT\n\n')
        stdscr.scrollok(1)
        stdscr.addstr('format: $ warlocksfx [args] -s <setup> [setup-args]\n\n')
        stdscr.scrollok(1)
        ...
        stdscr.scrollok(1)
        stdscr.addstr('    |    -e or --extension        -      specify output file extension. Default: \'*.warlock\'\n')
        stdscr.scrollok(1)
...
def cli():
    ...
    # if errors:
    if not argcheck:
        print(f'{_.RED}warlocksfx>{_.RESET} {argerror}')
        exit(1)
    else:
        # if version:
        ...
        try:
            ...
            print(f'{_.RED}warlocksfx>{_.RESET} {e}')
            exit(1)
