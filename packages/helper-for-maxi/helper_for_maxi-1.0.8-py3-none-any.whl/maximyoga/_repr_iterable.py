...
RESET = Terminal.color.RESET
numberColor = RESET + Terminal.color.foreground.FYELLOW
boolColor   = RESET + Terminal.color.foreground.FLBLUE
stringColor = RESET + Terminal.color.foreground.FLGREEN
quotesColor = RESET + Terminal.color.foreground.BOLD + Terminal.color.foreground.FCYAN
