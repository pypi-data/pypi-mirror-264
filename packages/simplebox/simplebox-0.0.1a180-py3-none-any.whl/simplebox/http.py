    ...
    def retry(self, times: int = None, interval: int = None, exit_code_range: list = None, exception_retry: bool = None,
        ...
        def __inner(func):
            ...
            def __wrapper(*args, **kwargs):
                ...
                exit_code_range_ = exit_code_range if isinstance(exit_code_range, List) else self.__retry_exit_code_range
                exception_retry_ = exception_retry if isinstance(exception_retry, bool) else self.__retry_exception_retry
