    ...
    def __init__(
        ...
        for x in range(0, 2):
            self.add_parameter(
                ...
                get_parser=bool,
                set_cmd=partial(
                    self._set_sequencer_config_val, ["awg", "cont_mode", "en_path", x]
                ),
                get_cmd=partial(
                    self._get_sequencer_config_val, ["awg", "cont_mode", "en_path", x]
                ),
            )
            ...
            self.add_parameter(
                ...
                docstring="Sets/gets sequencer upsample rate for AWG path {}.".format(
                    x
                ),
                unit="",
