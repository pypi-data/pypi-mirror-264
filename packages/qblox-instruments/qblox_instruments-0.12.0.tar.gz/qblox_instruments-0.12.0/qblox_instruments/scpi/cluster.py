...
class Cluster(Ieee488_2):
    ...
    def __init__(self, transport: Transport, debug: int = 0):
        ...
        if self._debug == 0:
            ...
            build_ref = "fwVersion=0.7.0 fwBuild=04/03/2024-15:36:54 fwHash=0x11DE3AFE fwDirty=0 kmodVersion=0.7.0 kmodBuild=08/03/2024-16:11:34 kmodHash=0x52F6CFA5 kmodDirty=0 swVersion=0.7.0 swBuild=08/03/2024-16:11:34 swHash=0x52F6CFA5 swDirty=0 cfgManVersion=0.3.0 cfgManBuild=08/03/2024-16:11:34 cfgManHash=0x52F6CFA5 cfgManDirty=0"
            if build != build_ref:
                build = re.split(" |=", build)
                build_ref = re.split(" |=", build_ref)
                raise ConnectionError(
                    "Qblox Instruments package version is not compatible with device version:\n"
                    + "\n"
                    + "                        {:<25} {}\n".format(
                        "Expected:", "Actual:"
                    )
                    ...
                    + "               Date:    {:<25} {}\n".format(
                        build_ref[11], build[11]
                    )
                    + "               Hash:    {:<25} {}\n".format(
                        build_ref[13], build[13]
                    )
                    + "               Dirty:   {:<25} {}\n".format(
                        build_ref[15], build[15]
                    )
                    + "Application;   Version: {:<25} {}\n".format(
                        build_ref[17], build[17]
                    )
                    + "               Date:    {:<25} {}\n".format(
                        build_ref[19], build[19]
                    )
                    + "               Hash:    {:<25} {}\n".format(
                        build_ref[21], build[21]
                    )
                    + "               Dirty:   {:<25} {}\n".format(
                        build_ref[23], build[23]
                    )
                    + "\n"
    ...
    def _reset(self) -> None:
        """
        Reset Cluster and all modules and clear all status and event registers (see `SCPI <https://www.ivifoundation.org/downloads/SCPI/scpi-99.pdf>`_).
    ...
    def _set_reference_source(self, internal: bool) -> None:
        ...
        # SCPI call
        self._write(
            "STATus:QUEStionable:FREQuency:REFerence:SRC {}".format(
                0 if internal == False else 1
            )
        )
    ...
    def get_current_fpga_temperature(self, slot: int) -> float:
        ...
        # SCPI call
        var0 = self._read(
            "SLOT{}:STATus:QUEStionable:TEMPerature:FPGA:CURRent?".format(slot)
        )
    ...
    def get_maximum_fpga_temperature(self, slot: int) -> float:
        ...
        # SCPI call
        var0 = self._read(
            "SLOT{}:STATus:QUEStionable:TEMPerature:FPGA:MAXimum?".format(slot)
        )
    ...
    def get_current_carrier_temperature(self, slot: int) -> float:
        ...
        # SCPI call
        var0 = self._read(
            "SLOT{}:STATus:QUEStionable:TEMPerature:CARRier:CURRent?".format(slot)
        )
    ...
    def get_maximum_carrier_temperature(self, slot: int) -> float:
        ...
        # SCPI call
        var0 = self._read(
            "SLOT{}:STATus:QUEStionable:TEMPerature:CARRier:MAXimum?".format(slot)
        )
    ...
    def _get_sequencer_acq_channel_map(self, slot: int, sequencer: int) -> Any:
        ...
        # SCPI call
        var0 = self._read_bin(
            "SLOT{}:SEQuencer{}:ACQ:CHANnelmap?".format(slot, sequencer)
        )
    ...
    def _get_sequencer_config(self, slot: int, sequencer: int) -> Any:
        ...
        # SCPI call
        var0 = self._read_bin(
            "SLOT{}:SEQuencer{}:CONFiguration?".format(slot, sequencer)
        )
    ...
    def _set_acq_scope_config(self, slot: int, acq_scope_config: Any) -> None:
        ...
        # SCPI call
        self._write_bin(
            "SLOT{}:ACQ:SCOpe:CONFiguration ".format(slot),
    ...
    def _set_sequencer_channel_map(
        ...
        # SCPI call
        self._write_bin(
            "SLOT{}:SEQuencer{}:CHANnelmap ".format(slot, sequencer),
    ...
    def _set_lo_enable_0(self, slot: int, lo_enable_0: bool) -> None:
        ...
        # SCPI call
        self._write(
            "SLOT{}:LO0:ENAble {}".format(slot, 0 if lo_enable_0 == False else 1)
        )
    ...
    def _set_lo_enable_1(self, slot: int, lo_enable_1: bool) -> None:
        ...
        # SCPI call
        self._write(
            "SLOT{}:LO1:ENAble {}".format(slot, 0 if lo_enable_1 == False else 1)
        )
    ...
    def _set_out_filt_en_0(self, slot: int, out_filt_en_0: bool) -> None:
        ...
        # SCPI call
        self._write(
            "SLOT{}:AFE:FILT:OUT0:ENAble {}".format(
                slot, 0 if out_filt_en_0 == False else 1
            )
        )
    ...
    def _set_out_filt_en_1(self, slot: int, out_filt_en_1: bool) -> None:
        ...
        # SCPI call
        self._write(
            "SLOT{}:AFE:FILT:OUT1:ENAble {}".format(
                slot, 0 if out_filt_en_1 == False else 1
            )
        )
    ...
    def _set_mrk_inv_en_0(self, slot: int, mrk_inv_en_0: bool) -> None:
        ...
        # SCPI call
        self._write(
            "SLOT{}:MRK0:INVert:ENAble {}".format(
                slot, 0 if mrk_inv_en_0 == False else 1
            )
        )
    ...
    def _set_mrk_inv_en_1(self, slot: int, mrk_inv_en_1: bool) -> None:
        ...
        # SCPI call
        self._write(
            "SLOT{}:MRK1:INVert:ENAble {}".format(
                slot, 0 if mrk_inv_en_1 == False else 1
            )
        )
    ...
    def _set_mrk_inv_en_2(self, slot: int, mrk_inv_en_2: bool) -> None:
        ...
        # SCPI call
        self._write(
            "SLOT{}:MRK2:INVert:ENAble {}".format(
                slot, 0 if mrk_inv_en_2 == False else 1
            )
        )
    ...
    def _set_mrk_inv_en_3(self, slot: int, mrk_inv_en_3: bool) -> None:
        ...
        # SCPI call
        self._write(
            "SLOT{}:MRK3:INVert:ENAble {}".format(
                slot, 0 if mrk_inv_en_3 == False else 1
            )
        )
    ...
    def _set_lo_freq_0(self, slot: int, lo_freq_0: int) -> None:
        ...
        # SCPI call
        self._write(
            "SLOT{}:STATus:QUEStionable:FREQuency:LO0 {}".format(slot, lo_freq_0)
        )
    ...
    def _set_lo_freq_1(self, slot: int, lo_freq_1: int) -> None:
        ...
        # SCPI call
        self._write(
            "SLOT{}:STATus:QUEStionable:FREQuency:LO1 {}".format(slot, lo_freq_1)
        )
    ...
    def get_current_afe_temperature(self, slot: int) -> float:
        ...
        # SCPI call
        var0 = self._read(
            "SLOT{}:STATus:QUEStionable:TEMPerature:AFE:CURRent?".format(slot)
        )
    ...
    def get_maximum_afe_temperature(self, slot: int) -> float:
        ...
        # SCPI call
        var0 = self._read(
            "SLOT{}:STATus:QUEStionable:TEMPerature:AFE:MAXimum?".format(slot)
        )
    ...
    def get_current_lo_temperature(self, slot: int) -> float:
        ...
        # SCPI call
        var0 = self._read(
            "SLOT{}:STATus:QUEStionable:TEMPerature:LO:CURRent?".format(slot)
        )
    ...
    def get_maximum_lo_temperature(self, slot: int) -> float:
        ...
        # SCPI call
        var0 = self._read(
            "SLOT{}:STATus:QUEStionable:TEMPerature:LO:MAXimum?".format(slot)
        )
    ...
    def _set_sequencer_program(self, slot: int, sequencer: int, program: str) -> None:
        ...
        # SCPI call
        self._write_bin(
            "SLOT{}:SEQuencer{}:PROGram ".format(slot, sequencer),
    ...
    def _add_awg_waveform(
        ...
        # SCPI call
        self._write(
            'SLOT{}:SEQuencer{}:AWG:WLISt:WAVeform:NEW "{}",{},{}'.format(
                slot, sequencer, name, size, 0 if is_integer == False else 1
            )
        )
    ...
    def _delete_awg_waveform(self, slot: int, sequencer: int, name: str) -> None:
        ...
        # SCPI call
        self._write(
            'SLOT{}:SEQuencer{}:AWG:WLISt:WAVeform:DELete "{}"'.format(
                slot, sequencer, name
            )
        )
    ...
    def _set_awg_waveform_data(
        ...
        # SCPI call
        self._write_bin(
            'SLOT{}:SEQuencer{}:AWG:WLISt:WAVeform:DATA "{}",'.format(
                slot, sequencer, name
            ),
    ...
    def _get_awg_waveform_data(
        ...
        var0 = self._read_bin(
            'SLOT{}:SEQuencer{}:AWG:WLISt:WAVeform:DATA? "{}",{},{}'.format(
                slot, sequencer, name, start, size
            )
        )
    ...
    def _set_awg_waveform_index(
        ...
        # SCPI call
        self._write(
            'SLOT{}:SEQuencer{}:AWG:WLISt:WAVeform:INDex "{}",{}'.format(
                slot, sequencer, name, index
            )
        )
    ...
    def _get_awg_waveform_length(self, slot: int, sequencer: int, name: str) -> int:
        ...
        # SCPI call
        var0 = self._read(
            'SLOT{}:SEQuencer{}:AWG:WLISt:WAVeform:LENGth? "{}"'.format(
                slot, sequencer, name
            )
        )
    ...
    def _get_awg_waveform_name(self, slot: int, sequencer: int, index: int) -> str:
        ...
        # SCPI call
        var0 = self._read(
            "SLOT{}:SEQuencer{}:AWG:WLISt:WAVeform:NAME? {}".format(
                slot, sequencer, index
            )
        )
    ...
    def _add_acq_weight(
        ...
        # SCPI call
        self._write(
            'SLOT{}:SEQuencer{}:ACQ:WLISt:WEIght:NEW "{}",{},{}'.format(
                slot, sequencer, name, size, 0 if is_integer == False else 1
            )
        )
    ...
    def _delete_acq_weight(self, slot: int, sequencer: int, name: str) -> None:
        ...
        # SCPI call
        self._write(
            'SLOT{}:SEQuencer{}:ACQ:WLISt:WEIght:DELete "{}"'.format(
                slot, sequencer, name
            )
        )
    ...
    def _set_acq_weight_data(
        ...
        # SCPI call
        self._write_bin(
            'SLOT{}:SEQuencer{}:ACQ:WLISt:WEIght:DATA "{}",'.format(
                slot, sequencer, name
            ),
    ...
    def _set_acq_weight_index(
        ...
        # SCPI call
        self._write(
            'SLOT{}:SEQuencer{}:ACQ:WLISt:WEIght:INDex "{}",{}'.format(
                slot, sequencer, name, index
            )
        )
    ...
    def _get_acq_weight_length(self, slot: int, sequencer: int, name: str) -> int:
        ...
        # SCPI call
        var0 = self._read(
            'SLOT{}:SEQuencer{}:ACQ:WLISt:WEIght:LENGth? "{}"'.format(
                slot, sequencer, name
            )
        )
    ...
    def _get_acq_weight_name(self, slot: int, sequencer: int, index: int) -> str:
        ...
        # SCPI call
        var0 = self._read(
            "SLOT{}:SEQuencer{}:ACQ:WLISt:WEIght:NAME? {}".format(
                slot, sequencer, index
            )
        )
    ...
    def _add_acq_acquisition(
        ...
        # SCPI call
        self._write(
            'SLOT{}:SEQuencer{}:ACQ:ALISt:ACQuisition:NEW "{}",{}'.format(
                slot, sequencer, name, num_bins
            )
        )
    ...
    def _delete_acq_acquisition(self, slot: int, sequencer: int, name: str) -> None:
        ...
        # SCPI call
        self._write(
            'SLOT{}:SEQuencer{}:ACQ:ALISt:ACQuisition:DELete "{}"'.format(
                slot, sequencer, name
            )
        )
    ...
    def _set_acq_acquisition_data(self, slot: int, sequencer: int, name: str) -> None:
        ...
        # SCPI call
        self._write(
            'SLOT{}:SEQuencer{}:ACQ:ALISt:ACQuisition:DATA "{}"'.format(
                slot, sequencer, name
            )
        )
    ...
    def _delete_acq_acquisition_data(
        ...
        # SCPI call
        self._write(
            'SLOT{}:SEQuencer{}:ACQ:ALISt:ACQuisition:DATA:DELete "{}"'.format(
                slot, sequencer, name
            )
        )
    ...
    def _set_acq_acquisition_index(
        ...
        # SCPI call
        self._write(
            'SLOT{}:SEQuencer{}:ACQ:ALISt:ACQuisition:INDex "{}",{}'.format(
                slot, sequencer, name, index
            )
        )
    ...
    def _get_acq_acquisition_num_bins(
        ...
        # SCPI call
        var0 = self._read(
            'SLOT{}:SEQuencer{}:ACQ:ALISt:ACQuisition:BINs? "{}"'.format(
                slot, sequencer, name
            )
        )
    ...
    def _get_acq_acquisition_name(self, slot: int, sequencer: int, index: int) -> str:
        ...
        # SCPI call
        var0 = self._read(
            "SLOT{}:SEQuencer{}:ACQ:ALISt:ACQuisition:NAME? {}".format(
                slot, sequencer, index
            )
        )
    ...
    def _clear_sequencer_flags(self, slot: int, sequencer: int) -> None:
        ...
        # SCPI call
        self._write("SLOT{}:SEQuencer{}:CLR:FLAGS".format(slot, sequencer))
            ...
            for i, (in_val, in_type) in enumerate(zip(in_val_list, in_type_list)):
                if (
                    ...
                    if len(in_val) > 0:
                        ...
                        raise TypeError(
                            "Unexpected type for input argument {}, expected {} but got empty {}.".format(
                                i, in_type, str(type(in_val).__name__)
                            )
                        )
                if in_type == "Any":
                    continue
                if type(in_val).__name__[: len(in_type)] != in_type:
                    raise TypeError(
                        "Unexpected type for input argument {}, expected {} but got {}.".format(
                            i, in_type, str(type(in_val).__name__)
                        )
                    )
