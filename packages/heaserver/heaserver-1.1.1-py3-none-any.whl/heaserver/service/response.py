...
def status_generic_error(status: int, body: Optional[Union[bytes, str]] = None, headers: Union[Mapping[Union[str, istr], str], CIMultiDict[str], CIMultiDictProxy[str], None] = None) -> web.HTTPError:
    """
...
def status_not_found(body: Optional[Union[bytes, str]] = None,
                     headers: Union[Mapping[Union[str, istr], str], None] = None) -> web.HTTPNotFound:
    """
...
def status_multiple_choices(default_url: Union[URL, str], body: Optional[Union[bytes, str]] = None, content_type: str = 'application/json') -> web.HTTPMultipleChoices:
    """
...
def status_ok(body: Optional[Union[bytes, str]] = None, content_type: str = 'application/json',
              headers: Union[Mapping[Union[str, istr], str], None] = None) -> web.HTTPOk:
    """
