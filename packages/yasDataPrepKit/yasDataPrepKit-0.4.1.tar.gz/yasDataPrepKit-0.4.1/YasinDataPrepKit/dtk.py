...
class ReadingData:
    ...
    def max_value(self):
        if self.data_df is not None:
            max_num = self.data_df.select_dtypes(include=['int', 'float'])
            max_num = max_num.max()
            return f"The Maximum for this column: {max_num}"
        else:
            print("No data loaded. please make sure you called the read() method")

    def min_value(self):
        if self.data_df is not None:
            min_num = self.data_df.select_dtypes(include=['int', 'float'])
            min_num = min_num.min()
            return f"The Minimum for this column: {min_num}"

    def median_value(self):
        if self.data_df is not None:
            median_num = self.data_df.select_dtypes(include=['int', 'float'])
            return f"The median for this columns is: {median_num.median()}"
        else:
            print("No data loaded. please make sure you called the read() method")
    ...
    def mode_value(self):
        if self.data_df is not None:
            ...
            return f"The mode for this column is: {mode_num.mode()}"
        else:
            print("No data loaded. please make sure you called the read() method")
    ...
    def var_value(self):
        if self.data_df is not None:
            ...
            return f"The variance for this column is: {var_num}"
        else:
            print("No data loaded. Please make sure you called the read() method")
    ...
    def std_deviation(self):
        if self.data_df is not None:
            ...
            return f"The standard deviation for this column is: {std_dev}"
        else:
            print("No data loaded. Please make sure you called the read() method")
    ...
    def cor_coefficient(self):
        if self.data_df is not None:
            ...
            return f"The correlation coefficient for this column is: {cor_coef}"
        else:
            print("No data loaded. Please make sure you called the read() method")
