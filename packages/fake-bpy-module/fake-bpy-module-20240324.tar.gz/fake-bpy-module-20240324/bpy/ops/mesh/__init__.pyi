...
def bridge_edge_loops(
    ...
    profile_shape: typing.Any = "SMOOTH",
):
...
def loopcut(
    ...
    falloff: typing.Any = "INVERSE_SQUARE",
...
def polybuild_extrude_at_cursor_move(
    ...
    execution_context: typing.Union[str, int] = None,
    undo: bool = None,
    MESH_OT_polybuild_transform_at_cursor: polybuild_transform_at_cursor = None,
    MESH_OT_extrude_edges_indiv: extrude_edges_indiv = None,
    TRANSFORM_OT_translate: bpy.ops.transform.translate = None,
):
    """Undocumented, consider contributing.
