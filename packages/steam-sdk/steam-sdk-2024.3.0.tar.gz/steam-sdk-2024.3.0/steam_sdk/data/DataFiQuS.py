...
class Pancake3DGeometryWinding(BaseModel):
    r_i: Optional[PositiveFloat] = Field(default=None, alias='innerRadius', title='Inner Radius', description='Inner radius of the winding.')
    t: Optional[PositiveFloat] = Field(default=None, alias='thickness', title='Winding Thickness', description='Thickness of the winding.')
    N: Optional[float] = Field(default=None, alias='numberOfTurns', ge=3, title='Number of Turns', description='Number of turns of the winding.')
    h: Optional[PositiveFloat] = Field(default=None, alias='height', title='Winding Height', description='Height/width of the winding.')
...
class Pancake3DGeometryContactLayer(BaseModel):
    tsa: Optional[bool] = Field(default=None, alias='thinShellApproximation', title='Use Thin Shell Approximation', description='If True, the contact layer will be modeled with 2D shell elements (thin shell approximation), and if False, the contact layer will be modeled with 3D elements.')
    t: Optional[PositiveFloat] = Field(default=None, alias='thickness', title='Contact Layer Thickness', description='Thickness of the contact layer.')
...
class Pancake3DGeometryTerminal(BaseModel):
    t: Optional[PositiveFloat] = Field(default=None, alias='thickness', title='Terminal Thickness', description="Thickness of the terminal's tube.")

class Pancake3DGeometryInnerTerminal(Pancake3DGeometryTerminal):
    name: Optional[str] = Field(default='innerTerminal', title='Terminal Name', description='The name to be used in the mesh.', examples=['innerTerminal', 'outerTeminal'])

class Pancake3DGeometryOuterTerminal(Pancake3DGeometryTerminal):
    name: Optional[str] = Field(default='outerTerminal', title='Terminal Name', description='The name to be used in the mesh.', examples=['innerTerminal', 'outerTeminal'])

class Pancake3DGeometryTerminals(BaseModel):
    i: Optional[Pancake3DGeometryInnerTerminal] = Field(alias='inner', default=Pancake3DGeometryInnerTerminal())
    o: Optional[Pancake3DGeometryOuterTerminal] = Field(alias='outer', default=Pancake3DGeometryOuterTerminal())
    transitionNotchAngle: Optional[PositiveFloat] = Field(default=11.25, title='Layer Transition Angle', description='A small volume is created to connect the terminal to the winding. The angular size of this volume is given by transitionNotchAngle. The angle is in degrees.')
...
class Pancake3DGeometryAir(BaseModel):
    ...
    margin: Optional[PositiveFloat] = Field(default=None, alias='axialMargin', title='Axial Margin of the Air', description='Axial margin between the ends of the air and first/last pancake coils.')
...
class Pancake3DMeshWinding(BaseModel):
    axne: Optional[Union[List[PositiveInt], PositiveInt]] = Field(default=None, alias='axialNumberOfElements', title='Axial Number of Elements', description='The number of axial elements for the whole height of the coil. It can be either a list of integers to specify the value for each pancake coil separately or an integer to use the same setting for each pancake coil.')
    ane: Optional[Union[List[PositiveInt], PositiveInt]] = Field(default=None, alias='azimuthalNumberOfElementsPerTurn', title='Azimuthal Number of Elements Per Turn', description='The number of azimuthal elements per turn of the coil. It can be either a list of integers to specify the value for each pancake coil separately or an integer to use the same setting for each pancake coil.')
    rne: Optional[Union[List[PositiveInt], PositiveInt]] = Field(default=None, alias='radialNumberOfElementsPerTurn', title='Winding Radial Number of Elements Per Turn', description='The number of radial elements per tape of the winding. It can be either a list of integers to specify the value for each pancake coil separately or an integer to use the same setting for each pancake coil.')
...
class Pancake3DSolveCERNNormalMaterial(BaseModel):
    name: Optional[Literal['Copper', 'Hastelloy', 'Silver', 'Indium', 'Stainless Steel']] = Field(default=None, title='Material Name', description='choices: Copper, Hastelloy, Silver, Indium, Stainless Steel')
    relativeThickness: Optional[float] = Field(default=None, le=1, title='Relative Thickness (only for winding)', description='Winding tapes generally consist of more than one material. Therefore, when materials are given as a list in winding, their relative thickness, (thickness of the material) / (thickness of the winding), should be specified.')
...
class Pancake3DSolveTerminalMaterialAndBoundaryCondition(Pancake3DSolveMaterial):
    ...
    transitionNotch: Optional[Pancake3DSolveMaterial] = Field(title='Transition Notch Properties', description='Material properties of the transition notch volume.', default=Pancake3DSolveMaterial())
    transitionLayer: Optional[Pancake3DSolveMaterial] = Field(title='Transition Layer Properties', description='Material properties of the transition layer between terminals and windings.', default=Pancake3DSolveMaterial())
...
class Pancake3DSolveWindingMaterial(BaseModel):
    ...
    plating: Optional[Pancake3DSolveCERNNormalMaterial] = Field(default=Pancake3DSolveCERNNormalMaterial(name="Copper", relativeThickness=0), title='Tape plating', description='The plating of the winding tape. Only copper is supported for now.By default, the tape is not plated.')
...
class Pancake3DSolveTime(BaseModel):
    ...
    start: Optional[float] = Field(default=None, title='Start Time', description='Start time of the simulation.')
    end: Optional[float] = Field(default=None, title='End Time', description='End time of the simulation.')
    timeSteppingType: Optional[Literal['fixed', 'adaptive']] = Field(default=None, title='Time Stepping Type', description='Time stepping type.')
...
class Pancake3DSolveInitialConditions(BaseModel):
    T: Optional[PositiveFloat] = Field(default=None, alias='temperature', title='Initial Temperature', description='Initial temperature of the pancake coils.')
...
class Pancake3DGeometry(BaseModel):
    ...
    ii: Optional[Pancake3DGeometryContactLayer] = Field(alias='contactLayer', title='Contact Layer Geometry', description='This dictionary contains the contact layer geometry information.', default=Pancake3DGeometryContactLayer())
    ...
    N: Optional[PositiveInt] = Field(default=None, alias='numberOfPancakes', title='Number of Pancakes', description='Number of pancake coils stacked on top of each other.')
    gap: Optional[PositiveFloat] = Field(default=None ,alias='gapBetweenPancakes', title='Gap Between Pancakes', description='Gap distance between the pancake coils.')
...
class Pancake3DMesh(BaseModel):
    ...
    ii: Optional[Pancake3DMeshContactLayer] = Field(alias='contactLayer', title='Contact Layer Mesh', description='This dictionary contains the contact layer mesh information.', default=Pancake3DMeshContactLayer())
...
class Pancake3DSolve(BaseModel):
    ...
    nls: Optional[Optional[Pancake3DSolveNonlinearSolverSettings]] = Field(default=None, alias='nonlinearSolver', title='Nonlinear Solver Settings', description='All the nonlinear solver related settings.')
    ...
    ii: Optional[Pancake3DSolveContactLayerMaterial] = Field(alias='contactLayer', title='Contact Layer Properties', description='This dictionary contains the contact layer material properties.', default=Pancake3DSolveContactLayerMaterial())
