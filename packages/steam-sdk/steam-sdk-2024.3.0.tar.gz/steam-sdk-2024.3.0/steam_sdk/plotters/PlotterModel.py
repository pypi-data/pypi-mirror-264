...
class PlotterModel:
    ...
    def plotterModel(self, data, titles, labels, types, texts, size, legends, style, window, scale,
        ...
        # plt.axis('equal')
        plt.tight_layout()
        displayWaitAndClose(waitTimeBeforeMessage=.1, waitTimeAfterMessage=100, flag_show_text=False)  # Show plots in Pycharm, wait a certain time, alert time is up, and close the window
