...
class BuilderModel:
    ...
    def buildLEDET(self, sim_name: str, sim_number: Union[
        ...
        if self.case_model == 'magnet':
            magnet_name = sim_name  # OLD: self.model_data.GeneralParameters.magnet_name
            nameFileSMIC = os.path.join(output_path, f'{magnet_name}_selfMutualInductanceMatrix.csv')  # full path of the .csv file with self-mutual inductances to write
    ...
    def buildProteCCT(self, sim_name: str, sim_number: Union[int, str], output_path: str, verbose: bool = None):
        ...
        path_file_name = os.path.join(output_path, f'{magnet_name}{sim_suffix}.xlsx')  # full path of the ProteCCT input file to write
