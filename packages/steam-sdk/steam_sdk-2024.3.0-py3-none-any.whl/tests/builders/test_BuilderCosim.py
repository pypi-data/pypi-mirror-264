...
class TestBuilderModel(unittest.TestCase):
    ...
    def test_BuilderCosim_initialization(self):
        ...
        with self.assertRaises(Exception) as context:
            BuilderCosim(file_model_data=None, data_settings=self.data_settings, verbose=True)
    ...
    def test_BuilderCosim_readYaml_REFERENCE(self):
        ...
        # act
        BC = BuilderCosim(file_model_data=reference_file, data_settings=self.data_settings, verbose=True)
    ...
    def _compare_to_reference_COSIM(self, cosim_name: str, sim_number: int, verbose=False):
        ...
        output_path = os.path.join('output', 'COSIM')
        ...
        # act
        BC = BuilderCosim(file_model_data=file_model_data, data_settings=self.data_settings, verbose=verbose)
    ...
    def _compare_to_reference_PyCoSim(self, cosim_name: str, sim_number: int, verbose=False):
        ...
        output_path = os.path.join('output', 'PyCoSim', cosim_name)
