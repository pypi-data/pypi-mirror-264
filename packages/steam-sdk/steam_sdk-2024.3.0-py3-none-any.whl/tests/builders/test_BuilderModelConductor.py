...
class TestBuilderModel(unittest.TestCase):
    ...
    def test_BuilderModel_readYaml_REFERENCE(self):
        ...
        # act
        BM = BuilderModel(file_model_data=reference_file, case_model='conductor',
    ...
    def test_BuilderModel_readYaml(self, conductor_name='MQY_OUT'):
        ...
        # act
        BM = BuilderModel(file_model_data=file_model_data, case_model='conductor',
                          data_settings=self.data_settings, verbose=True)
    ...
    def compare_to_reference_PyBBQ(self, conductor_name, verbose=False, flag_plot_all=False):
        ...
        # act
        BM = BuilderModel(file_model_data=file_model_data, case_model='conductor',
                          data_settings=self.data_settings, verbose=verbose)
    ...
    def compare_to_reference_LEDET(self, conductor_name, verbose=False, flag_plot_all=False):
        ...
        # act
        BM = BuilderModel(file_model_data=file_model_data, case_model='conductor', data_settings=self.data_settings, verbose=verbose)
