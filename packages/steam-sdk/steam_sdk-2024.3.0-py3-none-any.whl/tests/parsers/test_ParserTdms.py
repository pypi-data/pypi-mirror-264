...
class TestParserTdms(unittest.TestCase):
    ...
    def test_writeTDMSToCsv_semimanual(self, maximum_allowed_rel_error=1e-6):
        ...
        dictionary_test = {'MF': ['I(PS_1)_YT111', 'U(PS_6)_YT124'], 'Vgnd_Time': ['Vtap_1_212']}
        output_file = os.path.join('output', 'test_writeTDMS.csv')
    ...
    def test_convertTDMSToCsv(self, maximum_allowed_rel_error=1e-6):
        # Assign
        input_file = os.path.join('input', 'test_file_getSignal_ParserTDMS.tdms')
        output_file = os.path.join('output', 'convertTdmsToCsv', 'test_writeTDMS.csv')
        ...
        # Expected files
        list_expected_files = [
            os.path.join('output', 'convertTdmsToCsv', 'test_writeTDMS_MF.csv'),
            os.path.join('output', 'convertTdmsToCsv', 'test_writeTDMS_Vgnd_Pos.csv'),
            os.path.join('output', 'convertTdmsToCsv', 'test_writeTDMS_Vgnd_Time.csv') ]
