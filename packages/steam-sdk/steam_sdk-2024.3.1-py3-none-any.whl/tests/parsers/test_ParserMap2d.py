...
class TestParserMap2d(unittest.TestCase):
    ...
    def test_parserRoxieMap2d(self):
        ...
        # Act
        output = ParserMap2d.parseRoxieMap2d(TestFile_parserRoxieMap2d)
    ...
    def test_getParametersFromMap2d(self):
        ...
        # Act
        nT_gen, nStrands_inGroup_gen, polarities_inGroup_gen, strandToHalfTurn_gen, strandToGroup_gen, x_strands_gen, y_strands_gen, I_strands_gen= \
            ParserMap2d.getParametersFromMap2d(map2d_input)
    ...
    def test_modify_map2d_ribbon_cable_only(self):
        ...
        output_array_only = ParserMap2d.modify_map2d_ribbon_cable(input_file_only, geometry_ribbon_cable_only, list_flag_ribbon)

        # Create array (parser-method) of the reference file
        reference_array_only = ParserMap2d.parseRoxieMap2d(reference_file_only)
    ...
    def test_modify_map2d_ribbon_cable_comb(self):
        ...
        # Create modified array of the input files
        output_array_comb = ParserMap2d.modify_map2d_ribbon_cable(input_file_comb, geometry_ribbon_cable_comb, list_flag_ribbon)

        # Create array (parser-method) of the reference file
        reference_array_comb = ParserMap2d.parseRoxieMap2d(reference_file_comb)
    ...
    def test_modify_map2d_ribbon_cable_different(self):
        ...
        # Create modified array of the input files
        output_array_different = ParserMap2d.modify_map2d_ribbon_cable(input_file_different, geometry_ribbon_cable_different, list_flag_ribbon)

        # Create array (parser-method) of the reference file
        reference_array_different = ParserMap2d.parseRoxieMap2d(reference_file_different)
