...
class TestParserLEDET(unittest.TestCase):
    ...
    def test_write2Excel_default(self):
        # arrange
        file_name_GENERATED = os.path.join('output',     'TestFile_write2Excel_default.xlsx')
    ...
    def test_write2Excel_longList(self):
        # arrange
        file_name_GENERATED = os.path.join('output',     'TestFile_write2Excel_longList.xlsx')
    ...
    def test_write2Excel_differentVariableTypes(self):
        # arrange
        file_name_GENERATED = os.path.join('output',     'TestFile_write2Excel_differentVariableTypes.xlsx')
    ...
    def test_write2Excel_templateProteCCT(self):
        # arrange
        file_name_GENERATED = os.path.join('output',     'TestFile_write2Excel_templateProteCCT.xlsx')
