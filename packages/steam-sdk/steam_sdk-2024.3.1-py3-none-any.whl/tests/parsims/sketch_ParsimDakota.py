...
if software == 'FiQuS':
    dakota_yaml_path = Path(r"input/parsim_dakota/TestFile_ParsimDakota_FiQuS_MQXA_multidim_parameter_study.yaml").resolve()
    pd = ParsimDakota(input_DAKOTA_yaml=dakota_yaml_path)
elif software == 'LEDET':
    dakota_yaml_path = Path(r"input/parsim_dakota/TestFile_ParsimDakota_LEDET_SMC_multidim_parameter_study.yaml").resolve()

    pd = ParsimDakota(input_DAKOTA_yaml=dakota_yaml_path)
else:
    analysis_yaml_path_this_iteration = r"input/parsim_dakota/TestFile_AnalysisSTEAM_FiQuS_MQXA.yaml"
