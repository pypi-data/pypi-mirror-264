...
LastEditTime : 2024-03-28 15:24:40
LastEditors  : <BDFD>
Description  : 
...
def windwave(o1, ad, X, U10k, atm, atr, wdu, o2, beta, slc, o4, o5, xs, d0, Ksb, xlook, o6):
    ...
    if o2 == 'Yes' and o1 == 1:
        ...
        if o5 == 'Yes' and o6 == 1:
            if o4 == 1:
                ws0e=d0[0]*((2*Ksb*U10a**2*math.cos(math.pi*beta/180)*xs[0]/9.81/d0[0]**2+1)**0.5-1) # the initial estimate of the final wind setup
            #ws0=Ksb*U10a**2*xs[0]*math.log(d0[0]/ws0e)/9.81/(d0[0]-ws0e) # initial estimate of the final wind setup
                if abs(math.cos(math.pi*beta/180))>=tol**2:
                    ws0=Ksb*U10a**2*math.cos(math.pi*beta/180)*xs[0]*math.log(d0[0]/ws0e)/9.81/(d0[0]-ws0e) # initial estimate of the final wind setup
                else:
                    ws0=0
                while abs(ws0-ws0e)>tol:
                    ...
                    if abs(math.cos(math.pi*beta/180))>=tol**2:
                        ws0=Ksb*U10a**2*math.cos(math.pi*beta/180)*xs[0]*math.log(d0[0]/ws0e)/9.81/(d0[0]-ws0e)
                    else:
                        ws0=0
