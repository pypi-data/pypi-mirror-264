...
class PegType:
    ...
    """
    Nil, Primary, Market, Midpoint, AlternateMidpoint, PriceImprovedPrimary, PriceImprovedMarket, PriceImprovedMidpoint, MidpointDiscretionary, MidpointPennySpread, MidpointExtended, MidpointDiscretionaryQDP, IexDLimit = range(
        0, 13)
