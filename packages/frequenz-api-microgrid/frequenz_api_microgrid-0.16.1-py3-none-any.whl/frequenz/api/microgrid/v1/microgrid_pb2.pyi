...
class _ComponentBoundsTargetMetric:
    ValueType = typing.NewType("ValueType", builtins.int)
    V: typing_extensions.TypeAlias = ValueType

class _ComponentBoundsTargetMetricEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ComponentBoundsTargetMetric.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    COMPONENT_BOUNDS_TARGET_METRIC_UNSPECIFIED: _ComponentBoundsTargetMetric.ValueType  # 0
    COMPONENT_BOUNDS_TARGET_METRIC_POWER_ACTIVE: _ComponentBoundsTargetMetric.ValueType  # 1
    COMPONENT_BOUNDS_TARGET_METRIC_CURRENT: _ComponentBoundsTargetMetric.ValueType  # 2
    COMPONENT_BOUNDS_TARGET_METRIC_CURRENT_PHASE_1: _ComponentBoundsTargetMetric.ValueType  # 3
    COMPONENT_BOUNDS_TARGET_METRIC_CURRENT_PHASE_2: _ComponentBoundsTargetMetric.ValueType  # 4
    COMPONENT_BOUNDS_TARGET_METRIC_CURRENT_PHASE_3: _ComponentBoundsTargetMetric.ValueType  # 5
    COMPONENT_BOUNDS_TARGET_METRIC_POWER_REACTIVE: _ComponentBoundsTargetMetric.ValueType  # 6

class ComponentBoundsTargetMetric(_ComponentBoundsTargetMetric, metaclass=_ComponentBoundsTargetMetricEnumTypeWrapper):
...
COMPONENT_BOUNDS_TARGET_METRIC_UNSPECIFIED: ComponentBoundsTargetMetric.ValueType  # 0
COMPONENT_BOUNDS_TARGET_METRIC_POWER_ACTIVE: ComponentBoundsTargetMetric.ValueType  # 1
COMPONENT_BOUNDS_TARGET_METRIC_CURRENT: ComponentBoundsTargetMetric.ValueType  # 2
COMPONENT_BOUNDS_TARGET_METRIC_CURRENT_PHASE_1: ComponentBoundsTargetMetric.ValueType  # 3
COMPONENT_BOUNDS_TARGET_METRIC_CURRENT_PHASE_2: ComponentBoundsTargetMetric.ValueType  # 4
COMPONENT_BOUNDS_TARGET_METRIC_CURRENT_PHASE_3: ComponentBoundsTargetMetric.ValueType  # 5
COMPONENT_BOUNDS_TARGET_METRIC_POWER_REACTIVE: ComponentBoundsTargetMetric.ValueType  # 6
global___ComponentBoundsTargetMetric = ComponentBoundsTargetMetric
...
class GetMicrogridMetadataResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["microgrid", b"microgrid"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["microgrid", b"microgrid"]) -> None: ...
...
class ListComponentsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["categories", b"categories", "component_ids", b"component_ids"]) -> None: ...
...
class ListSensorRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["categories", b"categories", "sensor_ids", b"sensor_ids"]) -> None: ...
...
class ListSensorsResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["sensors", b"sensors"]) -> None: ...
...
class ReceiveComponentDataStreamRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["component_id", b"component_id", "filter", b"filter"]) -> None: ...
...
class ReceiveSensorDataStreamRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["filter", b"filter"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["filter", b"filter", "sensor_id", b"sensor_id"]) -> None: ...
...
@typing_extensions.final
class AddComponentExclusionBoundsRequest(google.protobuf.message.Message):
    ...
    target_metric: global___ComponentBoundsTargetMetric.ValueType
    """The target metric whose bounds have to be set."""
    @property
    def bounds(self) -> frequenz.api.common.v1.metrics.bounds_pb2.Bounds:
    ...
    def __init__(
        ...
        *,
        component_id: builtins.int = ...,
        target_metric: global___ComponentBoundsTargetMetric.ValueType = ...,
        bounds: frequenz.api.common.v1.metrics.bounds_pb2.Bounds | None = ...,
    ) -> None: ...
...
global___AddComponentExclusionBoundsRequest = AddComponentExclusionBoundsRequest

@typing_extensions.final
class AddComponentExclusionBoundsResponse(google.protobuf.message.Message):
...
global___AddComponentExclusionBoundsResponse = AddComponentExclusionBoundsResponse

@typing_extensions.final
class AddComponentInclusionBoundsRequest(google.protobuf.message.Message):
...
global___AddComponentInclusionBoundsRequest = AddComponentInclusionBoundsRequest

@typing_extensions.final
class AddComponentInclusionBoundsResponse(google.protobuf.message.Message):
...
global___AddComponentInclusionBoundsResponse = AddComponentInclusionBoundsResponse
...
class SetComponentPowerActiveResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["valid_until", b"valid_until"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["valid_until", b"valid_until"]) -> None: ...
...
class StartComponentRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["component_id", b"component_id"]) -> None: ...
