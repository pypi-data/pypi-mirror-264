...
class RegionalTieredCache(
    ...
    def __init__(
        ...
        *,
        ...
        :param value: Value of the Regional Tiered Cache zone setting. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.27.0/docs/resources/regional_tiered_cache#value RegionalTieredCache#value}
        :param zone_id: The zone identifier to target for the resource. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.27.0/docs/resources/regional_tiered_cache#zone_id RegionalTieredCache#zone_id}
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing RegionalTieredCache that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.27.0/docs/resources/regional_tiered_cache#import import section} in the documentation of this resource for the id to use
