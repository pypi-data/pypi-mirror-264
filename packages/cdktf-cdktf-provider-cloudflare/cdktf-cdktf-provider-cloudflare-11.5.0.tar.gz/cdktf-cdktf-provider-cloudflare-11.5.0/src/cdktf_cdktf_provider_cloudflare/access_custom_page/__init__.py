...
class AccessCustomPage(
    ...
    def __init__(
        ...
        *,
        ...
        :param name: Friendly name of the Access Custom Page configuration. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.27.0/docs/resources/access_custom_page#name AccessCustomPage#name}
        :param type: Type of Access custom page to create. Available values: ``identity_denied``, ``forbidden``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.27.0/docs/resources/access_custom_page#type AccessCustomPage#type}
        ...
        :param app_count: Number of apps to display on the custom page. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.27.0/docs/resources/access_custom_page#app_count AccessCustomPage#app_count}
        :param custom_html: Custom HTML to display on the custom page. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.27.0/docs/resources/access_custom_page#custom_html AccessCustomPage#custom_html}
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing AccessCustomPage that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.27.0/docs/resources/access_custom_page#import import section} in the documentation of this resource for the id to use
