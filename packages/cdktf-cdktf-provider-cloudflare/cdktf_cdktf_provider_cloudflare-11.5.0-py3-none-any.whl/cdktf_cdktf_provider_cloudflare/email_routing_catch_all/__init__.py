...
class EmailRoutingCatchAll(
    ...
    def __init__(
        ...
        *,
        ...
        :param action: action block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.27.0/docs/resources/email_routing_catch_all#action EmailRoutingCatchAll#action}
        :param matcher: matcher block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.27.0/docs/resources/email_routing_catch_all#matcher EmailRoutingCatchAll#matcher}
        :param name: Routing rule name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.27.0/docs/resources/email_routing_catch_all#name EmailRoutingCatchAll#name}
        :param zone_id: The zone identifier to target for the resource. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.27.0/docs/resources/email_routing_catch_all#zone_id EmailRoutingCatchAll#zone_id}
        :param enabled: Routing rule status. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.27.0/docs/resources/email_routing_catch_all#enabled EmailRoutingCatchAll#enabled}
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing EmailRoutingCatchAll that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.27.0/docs/resources/email_routing_catch_all#import import section} in the documentation of this resource for the id to use
...
class EmailRoutingCatchAllAction:
    def __init__(
        ...
        *,
        ...
        '''
        :param type: Type of supported action. Available values: ``drop``, ``forward``, ``worker``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.27.0/docs/resources/email_routing_catch_all#type EmailRoutingCatchAll#type}
        :param value: A list with items in the following form. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.27.0/docs/resources/email_routing_catch_all#value EmailRoutingCatchAll#value}
        '''
        if __debug__:
...
class EmailRoutingCatchAllMatcher:
    def __init__(self, *, type: builtins.str) -> None:
        '''
        :param type: Type of matcher. Available values: ``all``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.27.0/docs/resources/email_routing_catch_all#type EmailRoutingCatchAll#type}
        '''
        if __debug__:
