...
def test_upload_files():
    ...
    meta = [
        {"meta1": "value1", "source_test": "pytest_client_api", "group_id": timestamp, "portfolio": ["value1", "value2"]},
        {"meta2": "value2", "source_test": "pytest_client_api", "group_id": timestamp, "portfolio": ["value1", "value2"]},
    ]
...
def test_client_upload_files_from_bytes():
    ...
    meta = [
        {"meta3": "value3", "source_test": "pytest_client_api", "group_id": timestamp, "portfolio": ["value1", "value2"]},
    ]
    indexing_mode = "unstructured"
    response = client.upload_files(
