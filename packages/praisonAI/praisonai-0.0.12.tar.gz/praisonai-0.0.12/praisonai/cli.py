...
class PraisonAI:
    ...
    def parse_args(self):
        ...
        parser.add_argument("-b", "--bind", nargs="?", default=None, help=argparse.SUPPRESS)  # This will catch and ignore -b
        parser.add_argument("--deploy", action="store_true", help="Deploy the application")  # New argument

        args = parser.parse_args()

        # If -b was provided with 'api:app', ignore it and set agent_file to 'api.py'
        if args.bind == 'api:app':
            args.bind = None
