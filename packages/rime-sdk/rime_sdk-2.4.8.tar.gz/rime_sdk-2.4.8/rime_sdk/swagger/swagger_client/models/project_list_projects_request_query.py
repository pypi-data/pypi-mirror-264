...
class ProjectListProjectsRequestQuery(object):
    ...
    def __init__(self, is_published=None, creation_time_range=None, last_test_run_time_range=None, stress_test_categories=None, continuous_test_categories=None, sort=None, search=None):  # noqa: E501
