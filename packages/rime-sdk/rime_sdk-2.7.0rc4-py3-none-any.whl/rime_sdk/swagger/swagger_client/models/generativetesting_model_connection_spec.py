...
class GenerativetestingModelConnectionSpec(object):
    ...
    def response_json_path(self):
        ...
        A json path specifying where in the response json payload we can find the LLM's response response string. Note that the path must point to a string value in the json payload.  Example: - response payload: '{\"myfield\": {\"myotherfield\": \"Hey there!\"}}' - json path: \"myfield.myotherfield\"  Example: - response payload: '{\"myfield\": {\"myarr\": [\"Hey there!\"]}}' - json path: \"myfield.myarr.0\"  The supported syntax is dot notation only as in the examples above.  # noqa: E501
