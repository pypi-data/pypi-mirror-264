"""The linkedin-post-date-extractor.py module is a Python library designed to streamline the process of extracting the exact date from LinkedIn post URLs.
...
GitHub Repositry link: https://github.com/Volcano-Dragon/linkedin-post-date-extractor
