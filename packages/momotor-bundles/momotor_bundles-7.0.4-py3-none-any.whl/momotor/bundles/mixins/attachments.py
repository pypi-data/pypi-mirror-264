...
class SrcAttachmentMixin:
    ...
    @typing.overload
    def iterdir(self: typing.Union[ElementMixinProtocol, "SrcAttachmentMixin"], *, include_empty_root: bool = False) \
            -> typing.Generator[PurePosixPath, None, None]:
        ...

    @typing.overload
    def iterdir(self: typing.Union[ElementMixinProtocol, "SrcAttachmentMixin"], *, include_empty_root: bool = True) \
            -> typing.Generator[typing.Optional[PurePosixPath], None, None]:
        ...
