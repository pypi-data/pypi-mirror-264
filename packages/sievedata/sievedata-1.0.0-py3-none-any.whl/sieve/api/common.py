...
def upload(a: Any, version: str = None, API_KEY: str = None, single_build: bool = True):
    ...
    try:
        ...
        try:
            response = ApiClient.upload_model(
                UploadModel(
            ...
            print(f"\n{error_str} There was an issue processing your model: {e.data}")
    ...
    try:
        user_info = ApiClient.get_organization()
    except ApiException as e:
        print(
...
def whoami(api_key: Optional[str] = None) -> Tuple[UserModel, OrganizationModel]:
    ...
    client = make_api_client(api_key)
