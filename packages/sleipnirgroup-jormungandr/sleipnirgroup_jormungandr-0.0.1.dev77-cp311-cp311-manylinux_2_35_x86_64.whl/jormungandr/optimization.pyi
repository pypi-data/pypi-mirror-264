...
class SolverExitCondition:
    ...
    MAX_WALL_CLOCK_TIME_EXCEEDED: typing.ClassVar[SolverExitCondition]  # value = <SolverExitCondition.MAX_WALL_CLOCK_TIME_EXCEEDED: -7>
