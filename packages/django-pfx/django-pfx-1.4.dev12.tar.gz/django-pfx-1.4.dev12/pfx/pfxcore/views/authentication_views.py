...
class AuthenticationView(
    ...
    def otp_activate(self, *args, **kwargs):
        ...
        Activate the TOTP authentication and return the setup URI.
    ...
    def otp_confirm(self, *args, **kwargs):
        ...
        Confirm the TOTP authentification activation.
        ...
        put:
            ...
            description: A service to confirm the TOTP activation with a
                valid TOTP code.
            requestBody:
                content:
                    application/json:
    ...
    def otp_disable(self, *args, **kwargs):
        ...
        Disable the TOTP authentification.
        ...
        put:
            ...
            description: A service to disable the TOTP authentication.
            requestBody:
                content:
                    application/json:
                        schema:
    ...
    def otp_login(self, *args, **kwargs):
        ...
        Login a user with a valid TOTP code.
        ...
        post:
            summary: TOTP login
            description: A login service which validate the TOTP code.
            requestBody:
                content:
                    application/json:
                        schema:
        ...
        data = self.deserialize_body()
        try:
            user = self.decode_jwt(data.get('token'))
        except Exception:
