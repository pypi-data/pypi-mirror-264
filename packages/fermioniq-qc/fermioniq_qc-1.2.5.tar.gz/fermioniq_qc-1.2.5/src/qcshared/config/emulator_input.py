...
class EmulatorInput(BaseConfigWithWarning):
    ...
    def validate_config_circuit(cls, v, values, **kwargs):
        ...
        if v.optimizer.enabled and v.optimizer.initial_param_values:
            ...
            def _get_param_name(_param: str | dict) -> str:
                if isinstance(_param, str):
                    ...
                    raise ValueError(f"Variable param '{_param}' could not be parsed")
            ...
            params_config = set(v.optimizer.initial_param_values)
