...
This package was generated from typeshed commit `ed10e7eba6488714fccf6cc44dd2df1fbfc5cac3` and was tested
with mypy 1.9.0, pyright 1.1.355, and
pytype 2024.3.19.
'''.lstrip()

setup(name=name,
      version="12.1.4.20240327",
      ...
      install_requires=[],
      packages=['gdb-stubs'],
      package_data={'gdb-stubs': ['__init__.pyi', 'events.pyi', 'printing.pyi', 'prompt.pyi', 'types.pyi', 'unwinder.pyi', 'xmethod.pyi', 'METADATA.toml', 'py.typed']},
