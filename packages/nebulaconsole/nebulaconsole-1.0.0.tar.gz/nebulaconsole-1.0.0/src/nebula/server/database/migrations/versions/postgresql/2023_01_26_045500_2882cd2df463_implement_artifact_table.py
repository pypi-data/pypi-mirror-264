...
def upgrade():
    op.create_table(
        ...
        sa.Column(
            "task_run_state_id", nebula.server.utilities.database.UUID(), nullable=True
        ),
        sa.Column(
            "flow_run_id", nebula.server.utilities.database.UUID(), nullable=True
        ),
        sa.Column(
            "flow_run_state_id", nebula.server.utilities.database.UUID(), nullable=True
        ),
