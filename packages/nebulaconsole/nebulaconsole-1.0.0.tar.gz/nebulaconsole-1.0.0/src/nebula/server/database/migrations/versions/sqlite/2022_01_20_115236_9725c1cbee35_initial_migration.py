...
class DataDocument(NebulaBaseModel):
    """
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "id",
            nebula.server.utilities.database.UUID(),
        ...
        sa.Column(
            "tags",
            nebula.server.utilities.database.JSON(astext_type=Text()),
            server_default="[]",
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "flow_run_id", nebula.server.utilities.database.UUID(), nullable=False
        ),
        sa.Column(
            "task_run_id", nebula.server.utilities.database.UUID(), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "active_slots",
            nebula.server.utilities.database.JSON(astext_type=sa.Text()),
            server_default="[]",
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            nebula.server.utilities.database.Pydantic(
                nebula.server.schemas.schedules.SCHEDULE_TYPES
            ),
            nullable=True,
        ),
        sa.Column(
        ...
        sa.Column(
            "flow_data",
            nebula.server.utilities.database.Pydantic(DataDocument),
            nullable=True,
        ),
        ...
        sa.Column("flow_id", nebula.server.utilities.database.UUID(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("flow_id", nebula.server.utilities.database.UUID(), nullable=False),
        sa.Column(
            "deployment_id", nebula.server.utilities.database.UUID(), nullable=True
        ),
        sa.Column(
            "parent_task_run_id",
            nebula.server.utilities.database.UUID(),
        ...
        sa.Column("state_id", nebula.server.utilities.database.UUID(), nullable=True),
        sa.ForeignKeyConstraint(
            ["deployment_id"],
            ["deployment.id"],
    ...
    op.create_table(
        ...
        sa.Column(
            "state_details",
            nebula.server.utilities.database.Pydantic(
                nebula.server.schemas.states.StateDetails
            ),
            server_default="{}",
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "empirical_policy",
            nebula.server.utilities.database.Pydantic(
                nebula.server.schemas.core.TaskRunPolicy
            ),
            server_default="{}",
            nullable=False,
        ),
        sa.Column(
            ...
            nebula.server.utilities.database.Pydantic(
                Dict[
                    ...
                    List[
                        Union[
                            nebula.server.schemas.core.TaskRunResult,
                            nebula.server.schemas.core.Parameter,
                            nebula.server.schemas.core.Constant,
                        ]
                    ],
                ]
            ),
    ...
    op.create_table(
        ...
        sa.Column(
            "task_run_id", nebula.server.utilities.database.UUID(), nullable=False
        ),
        sa.ForeignKeyConstraint(
            ["task_run_id"],
            ["task_run.id"],
