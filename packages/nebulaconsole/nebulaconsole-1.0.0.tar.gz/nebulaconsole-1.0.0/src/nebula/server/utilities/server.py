"""
Utilities for the Nebula REST API server.
"""
...
from nebula._vendor.fastapi import APIRouter, Request, Response, status
from nebula._vendor.fastapi.routing import APIRoute, BaseRoute
from nebula._vendor.starlette.routing import Route as StarletteRoute
...
class NebulaRouter(APIRouter):
    """
    A base class for Nebula REST API routers.
    """

    def __init__(self, **kwargs: Any) -> None:
        kwargs.setdefault("route_class", NebulaAPIRoute)
