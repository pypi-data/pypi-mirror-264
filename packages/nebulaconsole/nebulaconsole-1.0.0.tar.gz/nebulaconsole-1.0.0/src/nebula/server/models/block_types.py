...
from nebula.server.database.orm_models import ORMBlockType
...
async def read_block_type_by_slug(
    session: sa.orm.Session, block_type_slug: str, db: NebulaDBInterface
):
    """
...
async def delete_block_type(
    session: sa.orm.Session, block_type_id: str, db: NebulaDBInterface
):
    """
