...
from nebula.server import schemas
from nebula.server.database.dependencies import inject_db
from nebula.server.database.interface import NebulaDBInterface
from nebula.server.database.orm_models import ORMBlockDocument
from nebula.server.schemas.actions import BlockDocumentReferenceCreate
from nebula.server.schemas.core import BlockDocument, BlockDocumentReference
from nebula.server.schemas.filters import BlockSchemaFilter
from nebula.server.utilities.database import UUID as UUIDTypeDecorator
from nebula.server.utilities.names import obfuscate_string
from nebula.utilities.collections import dict_to_flatdict, flatdict_to_dict
...
async def block_document_with_unique_values_exists(
    session: AsyncSession, block_type_id: UUID, name: str, db: NebulaDBInterface
) -> bool:
