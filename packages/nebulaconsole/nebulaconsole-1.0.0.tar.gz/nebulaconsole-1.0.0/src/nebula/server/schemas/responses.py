"""
Schemas for special responses from the Nebula REST API.
"""
...
from nebula.server.schemas.core import CreatedBy, FlowRunPolicy, UpdatedBy
from nebula.server.utilities.schemas.bases import ORMBaseModel, NebulaBaseModel
...
if TYPE_CHECKING:
    import nebula.server.database.orm_models
...
class StateAcceptDetails(NebulaBaseModel):
...
class StateRejectDetails(NebulaBaseModel):
...
class StateAbortDetails(NebulaBaseModel):
...
class StateWaitDetails(NebulaBaseModel):
...
class HistoryResponseState(NebulaBaseModel):
...
class HistoryResponse(NebulaBaseModel):
...
class OrchestrationResult(NebulaBaseModel):
    """
...
class WorkerFlowRunResponse(NebulaBaseModel):
    class Config:
...
class FlowRunResponse(ORMBaseModel):
    ...
    @classmethod
    def from_orm(cls, orm_flow_run: "nebula.server.database.orm_models.ORMFlowRun"):
...
class DeploymentResponse(ORMBaseModel):
    ...
    @classmethod
    def from_orm(
        cls, orm_deployment: "nebula.server.database.orm_models.ORMDeployment"
    ):
...
class WorkerResponse(schemas.core.Worker):
    ...
    @classmethod
    def from_orm(
        cls, orm_worker: "nebula.server.database.orm_models.ORMWorker"
    ) -> "WorkerResponse":
