...
from nebula.exceptions import InvalidRepositoryURLError
from nebula.utilities.asyncutils import run_sync_in_worker_thread, sync_compatible
from nebula.utilities.compat import copytree
...
class LocalFileSystem(WritableFileSystem, WritableDeploymentStorage):
    ...
    _documentation_url = "https://docs.nebula.io/concepts/filesystems/#local-filesystem"
    ...
    async def get_directory(
        ...
        # .nebulaignore exists in the original location, not the current location which
        # is most likely temporary
        if (from_path / Path(".nebulaignore")).exists():
            ignore_func = await self._get_ignore_func(
                local_path=from_path, ignore_file=from_path / Path(".nebulaignore")
            )
        else:
            ignore_func = None
...
class RemoteFileSystem(WritableFileSystem, WritableDeploymentStorage):
    ...
    Example:
        ...
        ```python
        from nebula.filesystems import RemoteFileSystem
    ...
    _documentation_url = (
        "https://docs.nebula.io/concepts/filesystems/#remote-file-system"
    )
...
@deprecated_class(
    start_date="Mar 2024", help="Use the `S3Bucket` block from nebula-aws instead."
)
class S3(WritableFileSystem, WritableDeploymentStorage):
    ...
    It has been replaced by `S3Bucket` from the `nebula-aws` package, which offers enhanced functionality
    ...
    Example:
        ...
        ```python
        from nebula.filesystems import S3
    ...
    _documentation_url = "https://docs.nebula.io/concepts/filesystems/#s3"
...
@deprecated_class(
    start_date="Mar 2024", help="Use the `GcsBucket` block from nebula-gcp instead."
)
class GCS(WritableFileSystem, WritableDeploymentStorage):
    ...
    This class is deprecated as of March 2024 and will not be available after September 2024.
    It has been replaced by `GcsBucket` from the `nebula-gcp` package, which offers enhanced functionality
    and better a better user experience.
    ...
    Example:
        ...
        ```python
        from nebula.filesystems import GCS
    ...
    _documentation_url = "https://docs.nebula.io/concepts/filesystems/#gcs"
...
@deprecated_class(
    start_date="Mar 2024",
    help="Use the `AzureBlobStorageContainer` block from nebula-azure instead.",
)
class Azure(WritableFileSystem, WritableDeploymentStorage):
    ...
    This class is deprecated as of March 2024 and will not be available after September 2024.
    It has been replaced by `AzureBlobStorageContainer` from the `nebula-azure` package, which
    ...
    Example:
        ...
        ```python
        from nebula.filesystems import Azure
    ...
    _documentation_url = "https://docs.nebula.io/concepts/filesystems/#azure"
...
class SMB(WritableFileSystem, WritableDeploymentStorage):
    ...
    Example:
        ...
        ```python
        from nebula.filesystems import SMB
    ...
    _documentation_url = "https://docs.nebula.io/concepts/filesystems/#smb"
...
@deprecated_class(
    start_date="Mar 2024",
    help="Use the `GitHubRepository` block from nebula-github instead.",
)
class GitHub(ReadableDeploymentStorage):
    """
        ...
        This class is deprecated as of March 2024 and will not be available after September 2024.
        It has been replaced by `GitHubRepository` from the `nebula-github` package, which offers
    ...
    _documentation_url = "https://docs.nebula.io/concepts/filesystems/#github"
    ...
    async def get_directory(
        ...
        with TemporaryDirectory(suffix="nebula") as tmp_dir:
            cmd.append(tmp_dir)
