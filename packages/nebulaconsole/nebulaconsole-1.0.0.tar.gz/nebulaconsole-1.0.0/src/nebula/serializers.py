...
def nebula_json_object_encoder(obj: Any) -> Any:
    """
...
class JSONSerializer(Serializer):
    ...
    object_encoder: Optional[str] = pydantic.Field(
        default="nebula.serializers.nebula_json_object_encoder",
        description=(
    ...
    object_decoder: Optional[str] = pydantic.Field(
        default="nebula.serializers.nebula_json_object_decoder",
        description=(
