...
from nebula.cli import app
from nebula.utilities.asyncutils import in_async_main_thread
...
def invoke_and_assert(
    ...
    """
    Test utility for the Nebula CLI application, asserts exact match with CLI output.
