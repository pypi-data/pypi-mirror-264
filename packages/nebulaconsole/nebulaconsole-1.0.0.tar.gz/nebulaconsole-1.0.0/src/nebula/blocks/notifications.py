...
from nebula.blocks.abstract import NotificationBlock
from nebula.blocks.fields import SecretDict
from nebula.events.instrument import instrument_instance_method_call
from nebula.utilities.asyncutils import sync_compatible
from nebula.utilities.templating import apply_values, find_placeholders

NEBULA_NOTIFY_TYPE_DEFAULT = "nebula_default"
...
class AbstractAppriseNotificationBlock(NotificationBlock, ABC):
    ...
    notify_type: Literal[
        "nebula_default", "info", "success", "warning", "failure"
    ] = Field(
        default=NEBULA_NOTIFY_TYPE_DEFAULT,
        description=(
            "The type of notification being performed; the nebula_default "
    ...
    def __init__(self, *args, **kwargs):
        ...
        if NEBULA_NOTIFY_TYPE_DEFAULT not in apprise.NOTIFY_TYPES:
            apprise.NOTIFY_TYPES += (NEBULA_NOTIFY_TYPE_DEFAULT,)
    ...
    def _start_apprise_client(self, url: SecretStr):
        ...
        # A custom `AppriseAsset` that ensures Nebula Notifications
        # appear correctly across multiple messaging platforms
        nebula_app_data = AppriseAsset(
            app_id="Nebula Notifications",
            app_desc="Nebula Notifications",
            app_url="https://nebula.io",
        )

        self._apprise_client = Apprise(asset=nebula_app_data)
...
class AppriseNotificationBlock(AbstractAppriseNotificationBlock, ABC):
    ...
    _documentation_url = "https://docs.nebula.io/ui/notifications/"
    url: SecretStr = Field(
        default=...,
        title="Webhook URL",
...
# TODO: Move to nebula-slack once collection block auto-registration is
# available
class SlackWebhook(AppriseNotificationBlock):
    ...
    Examples:
        ...
        ```python
        from nebula.blocks.notifications import SlackWebhook

        slack_webhook_block = SlackWebhook.load("BLOCK_NAME")
        slack_webhook_block.notify("Hello from Nebula!")
        ```
    """
    ...
    _documentation_url = "https://docs.nebula.io/api-ref/nebula/blocks/notifications/#nebula.blocks.notifications.SlackWebhook"
...
class MicrosoftTeamsWebhook(AppriseNotificationBlock):
    ...
    Examples:
        ...
        ```python
        from nebula.blocks.notifications import MicrosoftTeamsWebhook
        teams_webhook_block = MicrosoftTeamsWebhook.load("BLOCK_NAME")
        teams_webhook_block.notify("Hello from Nebula!")
        ```
    """
    ...
    _documentation_url = "https://docs.nebula.io/api-ref/nebula/blocks/notifications/#nebula.blocks.notifications.MicrosoftTeamsWebhook"
...
class PagerDutyWebHook(AbstractAppriseNotificationBlock):
    ...
    Examples:
        ...
        ```python
        from nebula.blocks.notifications import PagerDutyWebHook
        pagerduty_webhook_block = PagerDutyWebHook.load("BLOCK_NAME")
        pagerduty_webhook_block.notify("Hello from Nebula!")
        ```
    """
    ...
    _documentation_url = "https://docs.nebula.io/api-ref/nebula/blocks/notifications/#nebula.blocks.notifications.PagerDutyWebHook"

    # The default cannot be nebula_default because NotifyPagerDuty's
    ...
    source: Optional[str] = Field(
        default="Nebula", description="The source string as part of the payload."
    )
...
class TwilioSMS(AbstractAppriseNotificationBlock):
    ...
    Examples:
        ...
        ```python
        from nebula.blocks.notifications import TwilioSMS
        twilio_webhook_block = TwilioSMS.load("BLOCK_NAME")
        twilio_webhook_block.notify("Hello from Nebula!")
        ```
    """
    ...
    _documentation_url = "https://docs.nebula.io/api-ref/nebula/blocks/notifications/#nebula.blocks.notifications.TwilioSMS"
...
class OpsgenieWebhook(AbstractAppriseNotificationBlock):
    ...
    Examples:
        ...
        ```python
        from nebula.blocks.notifications import OpsgenieWebhook
        opsgenie_webhook_block = OpsgenieWebhook.load("BLOCK_NAME")
        opsgenie_webhook_block.notify("Hello from Nebula!")
        ```
    """
    ...
    _documentation_url = "https://docs.nebula.io/api-ref/nebula/blocks/notifications/#nebula.blocks.notifications.OpsgenieWebhook"
...
class MattermostWebhook(AbstractAppriseNotificationBlock):
    ...
    Examples:
        ...
        ```python
        from nebula.blocks.notifications import MattermostWebhook

        mattermost_webhook_block = MattermostWebhook.load("BLOCK_NAME")

        mattermost_webhook_block.notify("Hello from Nebula!")
        ```
    """
    ...
    _documentation_url = "https://docs.nebula.io/api-ref/nebula/blocks/notifications/#nebula.blocks.notifications.MattermostWebhook"
...
class DiscordWebhook(AbstractAppriseNotificationBlock):
    ...
    Examples:
        ...
        ```python
        from nebula.blocks.notifications import DiscordWebhook

        discord_webhook_block = DiscordWebhook.load("BLOCK_NAME")

        discord_webhook_block.notify("Hello from Nebula!")
        ```
    """
    ...
    _documentation_url = "https://docs.nebula.io/api-ref/nebula/blocks/notifications/#nebula.blocks.notifications.DiscordWebhook"
...
class CustomWebhookNotificationBlock(NotificationBlock):
    ...
    Examples:
        ...
        ```python
        from nebula.blocks.notifications import CustomWebhookNotificationBlock

        custom_webhook_block = CustomWebhookNotificationBlock.load("BLOCK_NAME")

        custom_webhook_block.notify("Hello from Nebula!")
        ```
    """
    ...
    _documentation_url = "https://docs.nebula.io/api-ref/nebula/blocks/notifications/#nebula.blocks.notifications.CustomWebhookNotificationBlock"
    ...
    async def notify(self, body: str, subject: Optional[str] = None):
        ...
        client = httpx.AsyncClient(
            headers={"user-agent": "Nebula Notifications"}, cookies=cookies
        )
        async with client:
...
class SendgridEmail(AbstractAppriseNotificationBlock):
    ...
    Examples:
        ...
        ```python
        from nebula.blocks.notifications import SendgridEmail

        sendgrid_block = SendgridEmail.load("BLOCK_NAME")

        sendgrid_block.notify("Hello from Nebula!")
    """
    ...
    _documentation_url = "https://docs.nebula.io/api-ref/nebula/blocks/notifications/#nebula.blocks.notifications.SendgridEmail"
