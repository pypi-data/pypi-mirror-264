...
from nebula.logging.highlighters import (
    LevelHighlighter,
    NameHighlighter,
    NebulaConsoleHighlighter,
    StateHighlighter,
    UrlHighlighter,
)
...
def test_highlight_url(url_kind):
    url = "https://www.nebula.io/" if url_kind == "web" else "file://tests.py"
...
def test_highlight_console():
    ...
    highlighter = NebulaConsoleHighlighter()
    highlighter.highlight(text)
    assert text.spans == [
