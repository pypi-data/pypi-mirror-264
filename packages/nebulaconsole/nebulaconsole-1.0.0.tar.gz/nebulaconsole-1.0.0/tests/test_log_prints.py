...
from nebula.context import get_run_context
from nebula.logging.loggers import print_as_log
from nebula.settings import NEBULA_LOGGING_LOG_PRINTS, temporary_settings
...
def test_root_flow_log_prints_defaults_to_setting_value(caplog, setting_value):
    ...
    with temporary_settings({NEBULA_LOGGING_LOG_PRINTS: setting_value}):
        test_flow()
