...
from nebula.exceptions import FailedRun
from nebula.flows import flow
from nebula.futures import NebulaFuture, resolve_futures_to_data
from nebula.states import Completed, Failed
...
def test_raise_warning_futures_in_condition():
    ...
    match = "A 'NebulaFuture' from a task call was cast to a boolean"
