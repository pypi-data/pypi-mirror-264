...
from nebula.client.schemas.filters import ArtifactFilter, ArtifactFilterKey
from nebula.client.schemas.sorting import ArtifactCollectionSort, ArtifactSort
from nebula.exceptions import ObjectNotFound

artifact_app = NebulaTyper(
...
async def list_artifacts(
    ...
    table = Table(
        title="Artifacts",
        caption="List Artifacts using `nebula artifact ls`",
        show_header=True,
    )
...
async def inspect(
    ...
    """
        ...
        Examples:
            $ nebula artifact inspect "my-artifact"
           [
            {
...
async def delete(
    ...
    Examples:
        $ nebula artifact delete "my-artifact"
    """
