...
class IntervalSchedule(NebulaBaseModel):
    """
    ...
    def default_timezone(cls, v, *, values, **kwargs):
        ...
        # https://github.com/kozmoai/nebula/issues/11619
...
class CronSchedule(NebulaBaseModel):
    """
    Cron schedule
...
class RRuleSchedule(NebulaBaseModel):
    """
