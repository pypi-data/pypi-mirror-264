...
It has been replaced by the Docker worker from the nebula-docker package, which offers enhanced functionality and better performance.
...
import nebula
from nebula.blocks.core import Block, SecretStr
...
# Labels to apply to all containers started by Nebula
CONTAINER_LABELS = {
...
@deprecated_class(
    start_date="Mar 2024",
    help="Use the `DockerRegistryCredentials` class from nebula-docker instead.",
)
...
class DockerRegistry(BaseDockerLogin):
    ...
    _documentation_url = "https://docs.nebula.io/api-ref/nebula/infrastructure/#nebula.infrastructure.docker.DockerRegistry"
...
@deprecated_class(
    start_date="Mar 2024",
    help="Use the Docker worker from nebula-docker instead."
...
class DockerContainer(Infrastructure):
    ...
    Click [here](https://docs.nebula.io/guides/deployment/docker) to see a tutorial.
    ...
    ## Connecting to a locally hosted Nebula API
    ...
    image: str = Field(
        ...
        description="Tag of a Docker image to use. Defaults to the Nebula image.",
    )
    ...
    _logo_url = "https://cdn.sanity.io/images/3ugk85nk/production/14a315b79990200db7341e42553e23650b34bb96-250x250.png"
    _documentation_url = "https://docs.nebula.io/api-ref/nebula/infrastructure/#nebula.infrastructure.DockerContainer"
