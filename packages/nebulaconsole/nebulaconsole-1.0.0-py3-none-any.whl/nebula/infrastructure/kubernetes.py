...
It has been replaced by the Kubernetes worker from the nebula-kubernetes package, which offers enhanced functionality and better performance.
...
@deprecated_class(
    start_date="Mar 2024",
    help="Use the Kubernetes worker from nebula-kubernetes instead."
...
class KubernetesJob(Infrastructure):
    ...
    For a guided tutorial, see [How to use Kubernetes with Nebula](https://medium.com/the-nebula-blog/how-to-use-kubernetes-with-nebula-419b2e8b8cb2/).
    For more information, including examples for customizing the resulting manifest, see [`KubernetesJob` infrastructure concepts](https://docs.nebula.io/concepts/infrastructure/#kubernetesjob).
    ...
    Attributes:
        ...
        image: An optional string specifying the image reference of a container image
            to use for the job, for example, docker.io/kozmoai/nebula:2-latest. The
            behavior is as described in https://kubernetes.io/docs/concepts/containers/images/#image-names.
            Defaults to the Nebula image.
    ...
    _documentation_url = "https://docs.nebula.io/api-ref/nebula/infrastructure/#nebula.infrastructure.KubernetesJob"
    ...
    image: Optional[str] = Field(
        ...
        description=(
            ...
            " `docker.io/kozmoai/nebula:2-latest`.The behavior is as described in"
            " the Kubernetes documentation and uses the latest version of Nebula by"
    ...
    def _get_environment_variables(self):
        ...
        if (
            "NEBULA_API_URL" in env
            and "NEBULA_API_URL" not in self.env
