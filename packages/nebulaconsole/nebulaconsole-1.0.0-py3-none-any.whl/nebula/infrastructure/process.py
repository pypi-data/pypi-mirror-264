...
It has been replaced by the process worker from the `nebula.workers` module, which offers enhanced functionality and better performance.
...
class Process(Infrastructure):
    ...
    Current environment variables and Nebula settings will be included in the created
    ...
    _documentation_url = "https://docs.nebula.io/concepts/infrastructure/#process"
    ...
    def _get_environment_variables(self, include_os_environ: bool = True):
        ...
        # the Nebula settings context may not be respected
    ...
    def _base_flow_run_command(self):
        return [get_sys_executable(), "-m", "nebula.engine"]
