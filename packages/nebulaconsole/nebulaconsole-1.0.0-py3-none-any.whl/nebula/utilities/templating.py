...
BLOCK_DOCUMENT_PLACEHOLDER_PREFIX = "nebula.blocks."
VARIABLE_PLACEHOLDER_PREFIX = "nebula.variables."
...
async def resolve_block_document_references(
    template: T, client: "NebulaClient" = None
    ...
    1. Accessing a nested dictionary:
       Format: nebula.blocks.<block_type_slug>.<block_document_name>.value.key
       Example: Returns {"nested-key": "nested-value"}

    2. Accessing a specific nested value:
       Format: nebula.blocks.<block_type_slug>.<block_document_name>.value.key.nested-key
       Example: Returns "nested-value"

    3. Accessing a list element's key-value:
       Format: nebula.blocks.<block_type_slug>.<block_document_name>.value.list[0].list-key
...
@inject_client
async def resolve_variables(template: T, client: "NebulaClient" = None):
    """
