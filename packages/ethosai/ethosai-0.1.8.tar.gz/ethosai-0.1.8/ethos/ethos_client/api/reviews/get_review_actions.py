...
) -> Optional[Union[HTTPValidationError, ListReviewAction]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = ListReviewAction.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[HTTPValidationError, ListReviewAction]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[HTTPValidationError, ListReviewAction]
    """
