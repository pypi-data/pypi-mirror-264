...
) -> Optional[Union[HTTPValidationError, Namespace]]:
    if response.status_code == HTTPStatus.CREATED:
        response_201 = Namespace.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[HTTPValidationError, Namespace]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[HTTPValidationError, Namespace]
    """
