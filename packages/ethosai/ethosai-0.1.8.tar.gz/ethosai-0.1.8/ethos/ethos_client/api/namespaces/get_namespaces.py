...
) -> Optional[Union[HTTPValidationError, ListNamespace]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = ListNamespace.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[HTTPValidationError, ListNamespace]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[HTTPValidationError, ListNamespace]
    """
