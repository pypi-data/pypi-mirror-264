...
from ...models.governed_type_create import GovernedTypeCreate
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.CREATED:
        response_201 = GovernedType.from_dict(response.json())
