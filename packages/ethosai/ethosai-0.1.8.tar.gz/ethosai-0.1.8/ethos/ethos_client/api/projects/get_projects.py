...
) -> Optional[Union[HTTPValidationError, ListProject]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = ListProject.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[HTTPValidationError, ListProject]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[HTTPValidationError, ListProject]
    """
