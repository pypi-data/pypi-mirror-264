...
) -> Optional[Union[HTTPValidationError, ListTask]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = ListTask.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[HTTPValidationError, ListTask]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[HTTPValidationError, ListTask]
    """
