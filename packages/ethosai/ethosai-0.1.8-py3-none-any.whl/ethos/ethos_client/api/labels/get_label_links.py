...
) -> Optional[Union[HTTPValidationError, ListLabelLink]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = ListLabelLink.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[HTTPValidationError, ListLabelLink]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[HTTPValidationError, ListLabelLink]
    """
