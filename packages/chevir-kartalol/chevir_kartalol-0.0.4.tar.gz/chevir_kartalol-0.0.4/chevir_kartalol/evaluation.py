...
class Dilmanc:
    def __init__(self):
        ...
        # Load vocabularies
        model_file_path = Path(__file__).parent /'azb_model202402.pt'
        self.download_model_files(model_file_path)
    ...
    def download_model_files(model_file_path):
        if not os.path.exists():
            print(f"Downloading model file to {model_file_path}...")
            urlretrieve('https://drive.usercontent.google.com/download?id=1o38vwHskSU7SN-IdXJwTqsDFFrwZnxR_&export=download&authuser=0&confirm=t&uuid=a4675024-a0ac-46bf-bade-a04985525d73&at=APZUnTXTxdh1VRUixTTLJUIcWQUZ:1711293439520', model_file_path)
