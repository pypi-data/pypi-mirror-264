...
#   timestamp: 2024-03-20T11:53:50+00:00
...
class NvidiaTimeslicingGPU(BaseModel):
    ...
    count: conint(ge=1, le=50) = Field(
        ...,
        description="+label=Timeslice\n+usage=Number of timesliced GPU units to allocate to the workload.",
    )
