...
class Prompt:
	...
	def __init2__(self,func,ptext='do what',helpText='',data={}):
		while True:
			color1=Fore.rgb(random.randint(100,255),random.randint(100,255),random.randint(100,255))
			color2=Fore.rgb(random.randint(100,255),random.randint(100,255),random.randint(100,255))
			color3=Fore.rgb(random.randint(100,255),random.randint(100,255),random.randint(100,255))
			color4=Fore.rgb(random.randint(100,255),random.randint(100,255),random.randint(100,255))
