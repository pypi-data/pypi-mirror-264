...
from llmadapter.schema import AgentAction, AgentFinish, LLMResult
...
class ArgillaCallbackHandler(BaseCallbackHandler):
    ...
    Examples:
        ...
        >>> from llmadapter.callbacks import ArgillaCallbackHandler
    ...
    def __init__(
        ...
        try:
            ...
            raise FileNotFoundError(
                ...
                " on how to create a `llmadapter`-compatible `FeedbackDataset` in"
                " Argilla, please visit"
        ...
        if supported_fields != [field.name for field in self.dataset.fields]:
            raise ValueError(
                ...
                "had fields that are not supported yet for the `llmadapter` integration."
                " Supported fields are: "
                f"{supported_fields}, and the current `FeedbackDataset` fields are"
                f" {[field.name for field in self.dataset.fields]}. "
                "For more information on how to create a `llmadapter`-compatible"
        ...
        warnings.warn(
            (
                ...
                "change based on updates to `llmadapter`. Please report any issues to "
                "https://github.com/argilla-io/argilla/issues with the tag `llmadapter`."
            ),
        )
