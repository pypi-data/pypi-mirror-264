...
from llmadapter.callbacks.tracers.schemas import Run, RunTypeEnum
...
class WandbTracer(BaseTracer):
    ...
    def __init__(self, run_args: Optional[WandbRunArgs] = None, **kwargs: Any) -> None:
        ...
        LangChain callback:
        ```
        from wandb.integration.llmadapter import WandbTracer
    ...
    def _ensure_run(self, should_print_url: bool = False) -> None:
        ...
        if self._wandb.run is None:
            ...
            if self._wandb.run is not None:
                ...
                self._wandb.run._label(repo="llmadapter")
