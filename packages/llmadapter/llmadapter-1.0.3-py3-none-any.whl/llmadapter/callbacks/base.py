"""Base callback handler that can be used to handle callbacks in llmadapter."""
...
class BaseCallbackHandler(
    ...
    """Base callback handler that can be used to handle callbacks from llmadapter."""
...
class AsyncCallbackHandler(BaseCallbackHandler):
    """Async callback handler that can be used to handle callbacks from llmadapter."""
