...
class RsSmab:
	...
	_driver_options = "SupportedInstrModels = SMA/SMAB/SMCV, SupportedIdnPatterns = SMA/SMCV, SimulationIdnString = 'Rohde&Schwarz,SMA100B,100001,5.10.121.0023'"
	...
	def __init__(self, resource_name: str, id_query: bool = True, reset: bool = False, options: str = None, direct_session: object = None):
		...
		self._core.driver_version = '5.10.121.0023'
	...
	def assert_minimum_version(min_version: str) -> None:
		...
		curr_version_list = '5.10.121.0023'.split('.')
		...
		for i in range(count):
			...
			if curr > minimum:
				break
			if curr < minimum:
				raise RsInstrException(f"Assertion for minimum RsSmab version failed. Current version: '5.10.121.0023', minimum required version: '{min_version}'")
