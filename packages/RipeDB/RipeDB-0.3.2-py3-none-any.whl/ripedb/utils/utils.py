        ...
        try:
            if '-' in parte:
                ...
                if 0 <= inizio <= max_indice and 0 <= fine <= max_indice and inizio <= fine:
                    ...
                    print(f"Index out of range: {parte}. Valid until {max_indice}.")
                    return None
            else:
                indice = int(parte)
