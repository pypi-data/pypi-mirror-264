...
NETGEN_VERSION: str = '6.2.2402-26-g81e1d72d'
NETGEN_VERSION_GIT: str = 'v6.2.2402-26-g81e1d72d'
NETGEN_VERSION_HASH: str = 'g81e1d72d'
NETGEN_VERSION_MAJOR: str = '6'
NETGEN_VERSION_MINOR: str = '2'
NETGEN_VERSION_PATCH: str = '2402'
NETGEN_VERSION_PYTHON: str = '6.2.2402.post26.dev'
NETGEN_VERSION_TWEAK: str = '26'
...
ngcore_compile_options: str = '/arch:AVX2;/bigobj;/MP;/W1;/wd4068'
version: str = 'v6.2.2402-26-g81e1d72d'
