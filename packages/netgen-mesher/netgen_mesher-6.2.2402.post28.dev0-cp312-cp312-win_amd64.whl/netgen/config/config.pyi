...
NETGEN_VERSION: str = '6.2.2402-28-gd8beec75'
NETGEN_VERSION_GIT: str = 'v6.2.2402-28-gd8beec75'
NETGEN_VERSION_HASH: str = 'gd8beec75'
NETGEN_VERSION_MAJOR: str = '6'
NETGEN_VERSION_MINOR: str = '2'
NETGEN_VERSION_PATCH: str = '2402'
NETGEN_VERSION_PYTHON: str = '6.2.2402.post28.dev'
NETGEN_VERSION_TWEAK: str = '28'
...
ngcore_compile_options: str = '/arch:AVX2;$<BUILD_INTERFACE:/bigobj;/MP;/W1;/wd4068>'
version: str = 'v6.2.2402-28-gd8beec75'
