...
from model import AccountData, LoginError, SeasonData, SeriesData, EpisodeData, ListableItem, CrunchyrollError, CategoriesData
...
if __name__ == "__main__":
    ...
    _list = utils.check_arg(account, api, argv)

    if _list is None:
        utils.crunchy_dump(account, argv.__dict__)
        exit(3)
    
    utils.debug(account, _list, argv)