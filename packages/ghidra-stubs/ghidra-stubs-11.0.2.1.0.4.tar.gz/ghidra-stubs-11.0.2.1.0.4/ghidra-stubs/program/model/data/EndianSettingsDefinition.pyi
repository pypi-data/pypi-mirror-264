...
class EndianSettingsDefinition(object, ghidra.docking.settings.EnumSettingsDefinition):
    ...
    BIG: int = 2
    DEF: ghidra.program.model.data.EndianSettingsDefinition = ghidra.program.model.data.EndianSettingsDefinition@67bd0385
    DEFAULT: int = 0
    ENDIAN: ghidra.program.model.data.EndianSettingsDefinition = ghidra.program.model.data.EndianSettingsDefinition@67bd0385
    LITTLE: int = 1
