...
class Util(com.sun.jna.Library, object):
    ...
    BARE: ghidra.pty.linux.Util = Proxy interface to Native Library <libutil.so@139716573116176>
    INSTANCE: ghidra.pty.linux.Util = ghidra.pty.linux.Util$1@32644fac
