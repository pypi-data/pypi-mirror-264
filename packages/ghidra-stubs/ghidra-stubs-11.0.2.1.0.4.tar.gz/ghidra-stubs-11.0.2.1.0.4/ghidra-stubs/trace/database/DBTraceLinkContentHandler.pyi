...
class DBTraceLinkContentHandler(ghidra.framework.data.LinkHandler):
    ...
    def getDomainObject(self, __a0: ghidra.framework.store.FolderItem, __a1: ghidra.framework.store.FileSystem, __a2: long, __a3: bool, __a4: bool, __a5: object, __a6: ghidra.util.task.TaskMonitor) -> ghidra.framework.data.DomainObjectAdapterDB: ...
