...
class AsyncUtils(object):
    CLEANER: java.lang.ref.Cleaner = java.lang.ref.Cleaner@434aebc1
    FRAMEWORK_EXECUTOR: java.util.concurrent.ExecutorService = java.util.concurrent.ForkJoinPool@458a84a5[Running, parallelism = 4, size = 0, active = 0, running = 0, steals = 0, tasks = 0, submissions = 0]
    SWING_EXECUTOR: java.util.concurrent.ExecutorService = ghidra.async.SwingExecutorService$1@6e17046
