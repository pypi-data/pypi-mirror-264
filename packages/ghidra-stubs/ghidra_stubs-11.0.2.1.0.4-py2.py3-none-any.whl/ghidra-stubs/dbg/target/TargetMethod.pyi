...
class TargetMethod(ghidra.dbg.target.TargetObject, object):
    ALL_INTERFACES: java.util.Set = [interface ghidra.dbg.target.TargetSection, interface ghidra.dbg.target.TargetExecutionStateful, interface ghidra.dbg.target.TargetInterruptible, interface ghidra.dbg.target.TargetFocusScope, interface ghidra.dbg.target.TargetDetachable, interface ghidra.dbg.target.TargetThread, interface ghidra.dbg.target.TargetActiveScope, interface ghidra.dbg.target.TargetConfigurable, interface ghidra.dbg.target.TargetBreakpointSpecContainer, interface ghidra.dbg.target.TargetModuleContainer, interface ghidra.dbg.target.TargetStackFrame, interface ghidra.dbg.target.TargetSectionContainer, interface ghidra.dbg.target.TargetRegisterBank, interface ghidra.dbg.target.TargetBreakpointSpec, interface ghidra.dbg.target.TargetDeletable, interface ghidra.dbg.target.TargetMemoryRegion, interface ghidra.dbg.target.TargetSymbol, interface ghidra.dbg.target.TargetLauncher, interface ghidra.dbg.target.TargetStack, interface ghidra.dbg.target.TargetResumable, interface ghidra.dbg.target.TargetMethod, interface ghidra.dbg.target.TargetDataTypeMember, interface ghidra.dbg.target.TargetBreakpointLocationContainer, interface ghidra.dbg.target.TargetAccessConditioned, interface ghidra.dbg.target.TargetDataTypeNamespace, interface ghidra.dbg.target.TargetAggregate, interface ghidra.dbg.target.TargetRegisterContainer, interface ghidra.dbg.target.TargetAttachable, interface ghidra.dbg.target.TargetNamedDataType, interface ghidra.dbg.target.TargetSymbolNamespace, interface ghidra.dbg.target.TargetProcess, interface ghidra.dbg.target.TargetEnvironment, interface ghidra.dbg.target.TargetBreakpointLocation, interface ghidra.dbg.target.TargetModule, interface ghidra.dbg.target.TargetMemory, interface ghidra.dbg.target.TargetConsole, interface ghidra.dbg.target.TargetEventScope, interface ghidra.dbg.target.TargetKillable, interface ghidra.dbg.target.TargetInterpreter, interface ghidra.dbg.target.TargetTogglable, interface ghidra.dbg.target.TargetSteppable, interface ghidra.dbg.target.TargetAttacher, interface ghidra.dbg.target.TargetRegister]
    DISPLAY_ATTRIBUTE_NAME: unicode = u'_display'
    INTERFACES_BY_NAME: java.util.Map = {u'BreakpointLocationContainer': <type 'ghidra.dbg.target.TargetBreakpointLocationContainer'>, u'Configurable': <type 'ghidra.dbg.target.TargetConfigurable'>, u'DataTypeNamespace': <type 'ghidra.dbg.target.TargetDataTypeNamespace'>, u'SymbolNamespace': <type 'ghidra.dbg.target.TargetSymbolNamespace'>, u'BreakpointSpecContainer': <type 'ghidra.dbg.target.TargetBreakpointSpecContainer'>, u'Deletable': <type 'ghidra.dbg.target.TargetDeletable'>, u'Register': <type 'ghidra.dbg.target.TargetRegister'>, u'Thread': <type 'ghidra.dbg.target.TargetThread'>, u'SectionContainer': <type 'ghidra.dbg.target.TargetSectionContainer'>, u'Symbol': <type 'ghidra.dbg.target.TargetSymbol'>, u'Launcher': <type 'ghidra.dbg.target.TargetLauncher'>, u'Resumable': <type 'ghidra.dbg.target.TargetResumable'>, u'Method': <type 'ghidra.dbg.target.TargetMethod'>, u'ExecutionStateful': <type 'ghidra.dbg.target.TargetExecutionStateful'>, u'MemoryRegion': <type 'ghidra.dbg.target.TargetMemoryRegion'>, u'TypeMember': <type 'ghidra.dbg.target.TargetDataTypeMember'>, u'BreakpointSpec': <type 'ghidra.dbg.target.TargetBreakpointSpec'>, u'Aggregate': <type 'ghidra.dbg.target.TargetAggregate'>, u'Module': <type 'ghidra.dbg.target.TargetModule'>, u'Detachable': <type 'ghidra.dbg.target.TargetDetachable'>, u'Access': <type 'ghidra.dbg.target.TargetAccessConditioned'>, u'Attachable': <type 'ghidra.dbg.target.TargetAttachable'>, u'Environment': <type 'ghidra.dbg.target.TargetEnvironment'>, u'ModuleContainer': <type 'ghidra.dbg.target.TargetModuleContainer'>, u'Interpreter': <type 'ghidra.dbg.target.TargetInterpreter'>, u'Steppable': <type 'ghidra.dbg.target.TargetSteppable'>, u'Process': <type 'ghidra.dbg.target.TargetProcess'>, u'Attacher': <type 'ghidra.dbg.target.TargetAttacher'>, u'RegisterBank': <type 'ghidra.dbg.target.TargetRegisterBank'>, u'Section': <type 'ghidra.dbg.target.TargetSection'>, u'DataType': <type 'ghidra.dbg.target.TargetNamedDataType'>, u'Memory': <type 'ghidra.dbg.target.TargetMemory'>, u'Killable': <type 'ghidra.dbg.target.TargetKillable'>, u'Interruptible': <type 'ghidra.dbg.target.TargetInterruptible'>, u'StackFrame': <type 'ghidra.dbg.target.TargetStackFrame'>, u'Togglable': <type 'ghidra.dbg.target.TargetTogglable'>, u'ActiveScope': <type 'ghidra.dbg.target.TargetActiveScope'>, u'Console': <type 'ghidra.dbg.target.TargetConsole'>, u'EventScope': <type 'ghidra.dbg.target.TargetEventScope'>, u'Stack': <type 'ghidra.dbg.target.TargetStack'>, u'BreakpointLocation': <type 'ghidra.dbg.target.TargetBreakpointLocation'>, u'FocusScope': <type 'ghidra.dbg.target.TargetFocusScope'>, u'RegisterContainer': <type 'ghidra.dbg.target.TargetRegisterContainer'>}
    ...
    class Param(java.lang.annotation.Annotation, object):
        DEFAULTS: List[object] = [ghidra.dbg.target.TargetMethod$Param$$Lambda/0x00000001017798b8@185e3d59, ghidra.dbg.target.TargetMethod$Param$$Lambda/0x0000000101779af0@4eb680e2, ghidra.dbg.target.TargetMethod$Param$$Lambda/0x0000000101779d28@7f58c388, ghidra.dbg.target.TargetMethod$Param$$Lambda/0x0000000101779f60@2adecf48, ghidra.dbg.target.TargetMethod$Param$$Lambda/0x000000010177a198@43839bbf, ghidra.dbg.target.TargetMethod$Param$$Lambda/0x000000010177a3d0@39c8b2bd, ghidra.dbg.target.TargetMethod$Param$$Lambda/0x000000010177a608@35628f]
