...
class CompositeInternal(ghidra.program.model.data.Composite, object):
    ...
    class ComponentComparator(object, java.util.Comparator):
        INSTANCE: ghidra.program.model.data.CompositeInternal.ComponentComparator = ghidra.program.model.data.CompositeInternal$ComponentComparator@73d74775
    ...
    class OffsetComparator(object, java.util.Comparator):
        INSTANCE: ghidra.program.model.data.CompositeInternal.OffsetComparator = ghidra.program.model.data.CompositeInternal$OffsetComparator@5d61181f
    ...
    class OrdinalComparator(object, java.util.Comparator):
        INSTANCE: ghidra.program.model.data.CompositeInternal.OrdinalComparator = ghidra.program.model.data.CompositeInternal$OrdinalComparator@66d542bb
