...
class Structure(ghidra.program.model.data.Composite, object):
    ...
    class BitOffsetComparator(object, java.util.Comparator):
        INSTANCE_BE: java.util.Comparator = ghidra.program.model.data.Structure$BitOffsetComparator@6ba49d90
        INSTANCE_LE: java.util.Comparator = ghidra.program.model.data.Structure$BitOffsetComparator@1d8339fb
