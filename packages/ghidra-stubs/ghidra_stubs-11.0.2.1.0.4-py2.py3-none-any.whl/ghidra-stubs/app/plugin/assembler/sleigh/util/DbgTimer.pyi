...
class DbgTimer(java.io.PrintStream):
    ...
    ACTIVE: ghidra.app.plugin.assembler.sleigh.util.DbgTimer = ghidra.app.plugin.assembler.sleigh.util.DbgTimer@c9def3
    INACTIVE: ghidra.app.plugin.assembler.sleigh.util.DbgTimer = ghidra.app.plugin.assembler.sleigh.util.DbgTimer$2@326c45a7
