...
class BasicLocationTrackingSpecFactory(object, ghidra.debug.api.action.LocationTrackingSpecFactory):
    ...
    BY_CONFIG_NAME: java.util.Map = {u'TRACK_PC_BY_STACK': INSTANCE, u'TRACK_NONE': INSTANCE, u'TRACK_PC': INSTANCE, u'TRACK_PC_BY_REGISTER': INSTANCE, u'TRACK_SP': INSTANCE}
