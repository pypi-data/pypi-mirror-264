...
def absolute_distance(
    ...
    [absolute_distance in Rust documentation.](https://docs.rs/opendp/0.9.2-dev.20240325.123/opendp/metrics/fn.absolute_distance.html)
...
def l1_distance(
    ...
    [l1_distance in Rust documentation.](https://docs.rs/opendp/0.9.2-dev.20240325.123/opendp/metrics/fn.l1_distance.html)
...
def l2_distance(
    ...
    [l2_distance in Rust documentation.](https://docs.rs/opendp/0.9.2-dev.20240325.123/opendp/metrics/fn.l2_distance.html)
...
def linf_distance(
    ...
    [linf_distance in Rust documentation.](https://docs.rs/opendp/0.9.2-dev.20240325.123/opendp/metrics/fn.linf_distance.html)
