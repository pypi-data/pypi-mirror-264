...
def atom_domain(
    ...
    [atom_domain in Rust documentation.](https://docs.rs/opendp/0.9.2-dev.20240325.123/opendp/domains/fn.atom_domain.html)
...
def option_domain(
    ...
    [option_domain in Rust documentation.](https://docs.rs/opendp/0.9.2-dev.20240325.123/opendp/domains/fn.option_domain.html)
