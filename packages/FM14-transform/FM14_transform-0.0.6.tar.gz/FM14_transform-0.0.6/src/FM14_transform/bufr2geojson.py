...
class BUFRParser:
    ...
    def get_identification(self) -> dict:
        ...
        if _type in self.qualifiers["01"]:
            ...
            if "'station_elevation_quality_mark'" in self.qualifiers["01"]:
            # wsi_series = 0
            # wsi_issuer = 20004
            # wsi_number = 0
        ...
        while codes_bufr_keys_iterator_next(key_iterator):
            ...
            if xx < 9:
                ...
                if value is not None or description is not None:
                    ...
                    elif identification["type"] == "SYNOP_MOBIL":
                    ...
                    elif identification["type"] == "SHIP":
                        station_id = identification['callsign']
                        feature_id = f"SHIP_{identification['callsign']}_{characteristic_date}T{characteristic_time}"  # noqa
                    else:
