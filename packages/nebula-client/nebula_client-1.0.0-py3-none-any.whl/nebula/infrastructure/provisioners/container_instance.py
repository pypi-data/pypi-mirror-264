...
infrastructure using Azure Container Instances for Nebula work pools.
...
from nebula.cli._prompts import prompt, prompt_select_from_table
...
class ContainerInstancePushProvisioner:
    ...
    def __init__(self):
        ...
        self._identity_name = "nebula-acr-identity"
        self.azure_cli = AzureCLI(self.console)
        self._credentials_block_name = None
        self._resource_group_name = "nebula-aci-push-pool-rg"
        self._app_registration_name = "nebula-aci-push-pool-app"
        self._registry_name_prefix = "nebula"
    ...
    async def _get_or_create_registry(
        ...
        """
        # check to see if there are any registries starting with 'nebula'
    ...
    async def _create_aci_credentials_block(
        ...
        Args:
            ...
            client (NebulaClient): An instance of NebulaClient.
    ...
    async def _aci_credentials_block_exists(
        self, block_name: str, client: NebulaClient
    ) -> bool:
        """
    ...
    async def _create_provision_table(self, work_pool_name: str, client: NebulaClient):
        return Panel(
            dedent(
                f"""\
    ...
    async def _customize_resource_names(
        self, work_pool_name: str, client: NebulaClient
    ) -> bool:
    ...
    async def provision(
        ...
        Args:
            ...
            client (Optional[NebulaClient]): An instance of NebulaClient. If None, it will be injected.
        ...
        with Progress(console=self._console) as progress:
            ...
            update_current_profile(
                {NEBULA_DEFAULT_DOCKER_BUILD_NAMESPACE: registry["loginServer"]}
            )
            progress.advance(task)
