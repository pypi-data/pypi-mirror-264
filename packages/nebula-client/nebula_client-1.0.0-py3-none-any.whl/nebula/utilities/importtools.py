...
from nebula.exceptions import ScriptError
from nebula.utilities.filesystem import filename, is_local_path, tmpchdir
...
def load_script_as_module(path: str) -> ModuleType:
    ...
    Sets the module name to `__nebula_loader__`.

    If an exception occurs during execution of the script, a
    `nebula.exceptions.ScriptError` is created to wrap the exception and raised.
    ...
    sys.modules["__nebula_loader__"] = module
    ...
    try:
        ...
        sys.modules.pop("__nebula_loader__")
