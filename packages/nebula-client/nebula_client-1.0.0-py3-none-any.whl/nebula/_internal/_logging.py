...
class SafeLogger(logging.Logger):
    ...
    def isEnabledFor(self, level: int):
        ...
        from nebula.settings import NEBULA_LOGGING_INTERNAL_LEVEL

        return level >= logging._nameToLevel[NEBULA_LOGGING_INTERNAL_LEVEL.value()]
...
logger = logging.getLogger("nebula._internal")
