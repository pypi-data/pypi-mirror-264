...
from .clients import AssertingEventsClient, NebulaCloudEventsClient
...
def emit_event(
    ...
    operational_clients = [AssertingEventsClient, NebulaCloudEventsClient]
