...
class JSON(Block):
    ...
    _documentation_url = "https://docs.nebula.io/api-ref/nebula/blocks/system/#nebula.blocks.system.JSON"
...
class String(Block):
    ...
    Example:
        ...
        ```python
        from nebula.blocks.system import String
    ...
    _documentation_url = "https://docs.nebula.io/api-ref/nebula/blocks/system/#nebula.blocks.system.String"
...
class DateTime(Block):
    ...
    Example:
        Load a stored JSON value:
        ```python
        from nebula.blocks.system import DateTime
    ...
    _documentation_url = "https://docs.nebula.io/api-ref/nebula/blocks/system/#nebula.blocks.system.DateTime"
...
class Secret(Block):
    ...
    _documentation_url = "https://docs.nebula.io/api-ref/nebula/blocks/system/#nebula.blocks.system.Secret"
