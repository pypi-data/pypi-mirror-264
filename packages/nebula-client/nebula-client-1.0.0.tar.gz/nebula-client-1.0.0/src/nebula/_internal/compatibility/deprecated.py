...
disabled with Nebula settings. Instead, the standard Python warnings filters can be
used.
...
from nebula.utilities.importtools import (
...
class NebulaDeprecationWarning(DeprecationWarning):
    """
    ...
    *,
    ...
    def decorator(fn: T):
        ...
        def wrapper(*args, **kwargs):
            warnings.warn(message, NebulaDeprecationWarning, stacklevel=stacklevel)
