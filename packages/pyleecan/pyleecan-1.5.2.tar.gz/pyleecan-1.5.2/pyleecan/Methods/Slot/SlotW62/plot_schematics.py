...
def plot_schematics(
    ...
    if is_default:
        ...
        if is_add_schematics:
            ...
            # H0
            Zlim1 = point_dict["Z2d"] - (self.W1 - self.W0) / 8
            Zlim2 = (
                point_dict["Z4d"] - (self.W1 - self.W0) / 2 - (self.W1 - self.W0) / 8
            )
            plot_quote(
                point_dict["Z3d"],
                Zlim1,
            ...
            line.plot(
                ...
                color=ARROW_COLOR,
                linewidth=ARROW_WIDTH,
                offset_label=1j * self.W0 * 0.15 - self.W1 * 0.05,
                is_arrow=True,
                fontsize=SC_FONT_SIZE,
            )
            # H1
            ...
            if type_add_active != 0:
                # H2
                line = Segment(
                    (point_dict["Zw1s"] + point_dict["Zw4s"]) / 2,
                ...
                line.plot(
                    ...
                    color=ARROW_COLOR,
                    linewidth=ARROW_WIDTH,
                    offset_label=self.W2 * 0.9,
                    is_arrow=True,
                    fontsize=SC_FONT_SIZE,
                )
                # W2
                Zlim1 = point_dict["Zw2s"]
                Zlim2 = point_dict["Zw3s"]
                plot_quote(
                    point_dict["Zw2s"],
                    Zlim1 - 1j * self.W2,
                    Zlim2 - 1j * self.W2,
                    point_dict["Zw3s"],
                    offset_label=self.H1 * 0.4,
                    fig=fig,
                    ax=ax,
                    label="W2",
                )
                ...
                line = Segment(
                    ...
                    ((point_dict["Zw4d"] + point_dict["Zw1d"]) / 2) + 1j * self.H3,
                )
                line.plot(
                    fig=fig,
                    ax=ax,
                    ...
                    color=ARROW_COLOR,
                    linewidth=ARROW_WIDTH,
                    offset_label=self.H3 * 0.7,
                    is_arrow=True,
                    fontsize=SC_FONT_SIZE,
                )
                # W3
                Zlim1 = point_dict["Zw2d"]
                Zlim2 = point_dict["Zw2d"] + self.W3
                plot_quote(
                    point_dict["Zw2d"],
                    Zlim1 - 1j * self.H2 * 0.2,
                    Zlim2 - 1j * self.H2 * 0.2,
                    point_dict["Zw2d"] + self.W3,
                    offset_label=self.H1 * 0.35,
                    fig=fig,
                    ax=ax,
                    label="W3",
                )
