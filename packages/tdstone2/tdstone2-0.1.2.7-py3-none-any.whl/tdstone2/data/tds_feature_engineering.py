...
if sto_code_type == 'python class':
    ...
    try:
        ...
        STO_OUPTUT_DEFAULT_STATUS = f'{{"error": "failed", "info": "problem managing the model outputs. Are you sure you use the script? chekc you feature engineering mapper attached to your process id. {e}"}}'
        print_when_exception()
