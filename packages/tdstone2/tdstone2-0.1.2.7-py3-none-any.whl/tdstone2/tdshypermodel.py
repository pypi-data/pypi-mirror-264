...
class HyperModel():
    ...
    def __init__(self, tdstone, id = None, metadata ={},
        ...
        if skl_pipeline_steps is not None and model_parameters is not None and dataset is not None and id_row is not None and id_partition is not None and fold_training is not None:
