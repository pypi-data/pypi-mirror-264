...
class QdrantCRUDBase(Generic[ModelType, VectorModelType]):
    ...
    def scroll_records(self, client: QdrantClient, *, query: QueryBase, **kwargs) -> Tuple[
        ...
        return [Record(**record.model_dump(exclude={"payload"}), payload=record.payload) for record in
                records], next_point_id
    ...
    def update_vector(self, client: QdrantClient, *, _id: qdrant_types.PointId, vector: VectorModelType, **kwargs) -> bool:
