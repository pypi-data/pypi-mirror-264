...
def pie_chart(data):
  ...
  plt.axis('equal')
  plt.title('Univariate Pie Chart')
  plt.show()

# Numerical Variables
def stat_measure(data):
  minimum = min(data)
  maximum = max(data)
  ...
  print('-'*30)
  print(f'Min: {minimum:^15}')
  print(f'Max: {maximum:^15}')
  print(f'Mean: {means:^15}')
  print(f'Median: {medians:^10}')
  print(f'Mode: {modes:^14}')
  print('-'*30)
