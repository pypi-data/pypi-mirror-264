...
- **Searching for a target domain**:
    - *Command line*
        ```
        chiasmodon_*Command line*.py --domain example.com
        ```
    - *Python*
        ```python
...
- **Searching for a target domain and its subdomains**:
    - *Command line*
        ```
        chiasmodon_*Command line*.py --domain example.com --all
        ```
    - *Python*
        ```python
...
- **Searching for a target application ID on the Google Play Store**:
    - *Command line*
        ``` 
        chiasmodon_*Command line*.py --app com.discord
        ```
    - *Python*
        ```python
...
- **Searching for a target ASN**:
    - *Command line*
        ``` 
        chiasmodon_*Command line*.py --asn AS123 --view-type cred
        ```
    - *Python*
        ```python
...
- **earching for a target username**:
    - *Command line*
        ``` 
        chiasmodon_*Command line*.py --username someone
        ```
    - *Python*
        ```python
...
- **Searching for a target password**:
    ...
    - *Command line*
        ``` 
        chiasmodon_*Command line*.py --password example@123
        ```
    - *Python*
        ```python
...
- **Searching for a target CIDR**:
    ...
    - *Command line*
        ``` 
        chiasmodon_*Command line*.py --cidr x.x.x.x/24
        ```
    - *Python*
        ```python
...
- **Searching for target credentials by domain emails**:
    ...
    - *Command line*
        ``` 
        chiasmodon_*Command line*.py --domain example.com --domain-emails
        ```
    - *Python*
        ```python
