...
class Auth:
    ...
    def __init__(self, username: Optional[str] = None, password: Optional[str] = None):
        ...
        if not username:
            raise ValueError(error_message.format(credential='Username', env_var='ALLPHINS_USER'))

        if not password:
            raise ValueError(error_message.format(credential='Password', env_var='ALLPHINS_PASSWORD'))
