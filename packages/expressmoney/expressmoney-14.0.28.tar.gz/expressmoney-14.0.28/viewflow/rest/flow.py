...
class Start(nodes.Start):
    ...
    activation_class = activation.ManagedStartViewActivation
...
class View(nodes.View):
    ...
    activation_class = activation.ManagedViewActivation
...
class StartSubprocess(nodes.StartSubprocess):
    activate_next_view_class = views.ActivateNextTaskView
    cancel_view_class = views.CancelTaskView
    detail_view_class = views.DetailSubprocessView
    perform_view_class = views.PerformTaskView
    undo_view_class = views.UndoTaskView


class Subprocess(nodes.Subprocess):
    detail_view_class = views.DetailSubprocessView


class NSubprocess(nodes.NSubprocess):
    detail_view_class = views.DetailSubprocessView
