            ...
            if 'guardian' in settings.INSTALLED_APPS:
                ...
                queryset = queryset.annotate(
                    owner_permission_obj_check=Concat(
                        F('owner_permission'), Value('_'), F('owner_permission_obj_pk'),
                ...
                if hasattr(user, '_viewflow_per_object_perm_cache'):
                    ...
                    per_object_perms = per_object_perms | {
                        ...
                        for groupperm in GroupObjectPermission.objects.filter(group__in=user.groups.all())
                    }
                ...
                has_permission = Q(owner_permission__in=user.get_all_permissions()) | has_permission
