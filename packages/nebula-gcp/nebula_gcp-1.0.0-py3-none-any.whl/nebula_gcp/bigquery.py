...
from nebula.blocks.abstract import DatabaseBlock
...
async def bigquery_query(
    ...
    Example:
        ...
        from nebula_gcp.bigquery import bigquery_query
...
async def bigquery_create_table(
    ...
    Example:
        ...
        from nebula import flow
        from nebula_gcp import GcpCredentials
        from nebula_gcp.bigquery import bigquery_create_table
...
async def bigquery_insert_stream(
    ...
    Example:
        ...
        from nebula import flow
        from nebula_gcp import GcpCredentials
        from nebula_gcp.bigquery import bigquery_insert_stream
        from google.cloud.bigquery import SchemaField
...
async def bigquery_load_cloud_storage(
    ...
    Example:
        ...
        from nebula import flow
        from nebula_gcp import GcpCredentials
        from nebula_gcp.bigquery import bigquery_load_cloud_storage
...
async def bigquery_load_file(
    ...
    Example:
        ...
        from nebula import flow
        from nebula_gcp import GcpCredentials
        from nebula_gcp.bigquery import bigquery_load_file
        from google.cloud.bigquery import SchemaField
...
class BigQueryWarehouse(DatabaseBlock):
    ...
    _documentation_url = "https://kozmoai.github.io/nebula-gcp/bigquery/#nebula_gcp.bigquery.BigQueryWarehouse"  # noqa: E501
    ...
    async def fetch_one(
        ...
        **execution_options: Dict[str, Any],
        ...
        Examples:
            ...
            ```python
            from nebula_gcp.bigquery import BigQueryWarehouse
