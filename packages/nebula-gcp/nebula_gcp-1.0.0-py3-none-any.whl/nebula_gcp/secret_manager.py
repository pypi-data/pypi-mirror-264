...
async def create_secret(
    ...
    Example:
        ...
        from nebula_gcp.secret_manager import create_secret
...
async def update_secret(
    ...
    Example:
        ...
        from nebula import flow
        from nebula_gcp import GcpCredentials
        from nebula_gcp.secret_manager import update_secret
...
async def read_secret(
    ...
    Example:
        ...
        from nebula import flow
        from nebula_gcp import GcpCredentials
        from nebula_gcp.secret_manager import read_secret
...
async def delete_secret(
    ...
    Example:
        ...
        from nebula import flow
        from nebula_gcp import GcpCredentials
        from nebula_gcp.secret_manager import delete_secret
...
async def delete_secret_version(
    ...
    Example:
        ...
        from nebula import flow
        from nebula_gcp import GcpCredentials
        from nebula_gcp.secret_manager import delete_secret_version
...
class GcpSecret(SecretBlock):
    ...
    _documentation_url = "https://kozmoai.github.io/nebula-gcp/secret_manager/#nebula_gcp.secret_manager.GcpSecret"  # noqa: E501
