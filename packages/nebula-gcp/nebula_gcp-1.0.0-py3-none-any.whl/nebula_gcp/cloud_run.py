...
class CloudRunJob(Infrastructure):
    ...
    _documentation_url = "https://kozmoai.github.io/nebula-gcp/cloud_run/#nebula_gcp.cloud_run.CloudRunJob"  # noqa: E501
    ...
    def _add_env(self) -> dict:
        ...
        Method `self._base_environment()` gets necessary Nebula environment variables
        from the config.
