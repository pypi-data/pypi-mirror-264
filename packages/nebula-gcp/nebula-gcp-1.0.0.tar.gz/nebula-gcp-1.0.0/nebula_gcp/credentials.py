    ...
    def outer(func):
        ...
        def inner(*args, **kwargs):
            ...
            try:
                ...
                raise ImportError(
                    f"To use nebula_gcp.{key}, install nebula-gcp with the "
                    f"'{key}' extra: `pip install 'nebula_gcp[{key}]'`"
                ) from exc
...
class GcpCredentials(CredentialsBlock):
    ...
    _documentation_url = "https://kozmoai.github.io/nebula-gcp/credentials/#nebula_gcp.credentials.GcpCredentials"  # noqa: E501
    ...
    def get_cloud_storage_client(
        ...
        Examples:
            ...
            def example_get_client_flow():
                service_account_file = "~/.secrets/nebula-service-account.json"
