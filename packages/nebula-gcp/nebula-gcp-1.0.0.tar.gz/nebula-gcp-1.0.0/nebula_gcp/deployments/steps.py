"""
Nebula deployment steps for code storage in and retrieval from Google Cloud Storage.
"""
    ...
    Examples:
        ...
        build:
            - nebula_gcp.deployments.steps.push_to_gcs:
                ...
                bucket: my-bucket
                folder: my-folder
                credentials: "{{ nebula.blocks.gcp-credentials.dev-credentials }}"
        ```
