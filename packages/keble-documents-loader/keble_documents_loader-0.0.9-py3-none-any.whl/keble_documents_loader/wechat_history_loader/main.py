...
class WxMessage(BaseModel):
    ...
    compress_content: Optional[Any] = Field(..., alias="CompressContent")
    con_blob: Optional[str] = Field(..., alias="ConBlob")
    int_res1: Optional[int] = Field(..., alias="IntRes1")
    int_res2: Optional[int] = Field(..., alias="IntRes2")
