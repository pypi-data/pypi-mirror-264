...
This package requires [Python 3.11](https://www.python.org/downloads/release/python-370/). More recent versions should work, but are not tested.
...
pew new openfisca --python=python3.11  # create a new virtualenv called “openfisca”
```
