...
def basecall_with_pybasecall_client(client, input_path, save_file=None, batch_size=1):
    ...
    if save_file is not None:
        ...
        out.write("read_id\tsequence_length\tstrand_id\tstrand_1\tstrand_2\n")
    else:
        out = None
    ...
    try:
        ...
        if out is not None:
            for read in called_reads:
                ...
                out.write(
                    "{}\t{}\t{}\t{}\t{}\n".format(
                        read_id, sequence_length, strand_id, strand_1, strand_2
                    )
                )
    finally:
        if out is not None:
...
def get_return_code_message(return_code):
    ...
    elif return_code == BasecallClient.message:
        return None, "Message"
    else:
        return None, None
