...
class MessageManager(interfaces.TokenInterface, interfaces.MessageManager):
    ...
    def _next_message_id(self):
        ...
        self.message_id = (self.message_id + 1) % 65536  # Incrementar y mantener dentro del rango de 16 bits
        self.message_id = int(bin(self.message_id)[2:][::-1], 2)  # Invertir los bits
