...
from langtorch import TextTensor, OpenAI
import langtorch
import torch
import numpy as np
...
# print("\n".join([str(m) for m in task(paper).flat]))
# Outputs:
# We’ll show some situations in which reversibil...
# In the second part of this paper, we propose a...
# In their paper, Floridi and Chiriatti provide ...
# modal drift hypothesis...
# — that because humans are not psychologically...
#
# mean_paragraph = langtorch.max(paper, dim=0)
input_emails = TextTensor(["""Hello,
