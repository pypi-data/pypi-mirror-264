...
class PatternCls:
	...
	def set(self, pattern: List[str], satelliteSvid=repcap.SatelliteSvid.Default) -> None:
		...
		Snippet: driver.source.bb.gnss.svid.beidou.signal.l1Band.b1I.data.nmessage.pattern.set(pattern = ['rawAbc1', 'rawAbc2', 'rawAbc3'], satelliteSvid = repcap.SatelliteSvid.Default) \n
