...
class PatternCls:
	...
	def set(self, nbiot_an_pat: List[str], bitcount: int, userEquipment=repcap.UserEquipment.Default, transmission=repcap.Transmission.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.uplink.ue.niot.trans.harq.pattern.set(nbiot_an_pat = ['rawAbc1', 'rawAbc2', 'rawAbc3'], bitcount = 1, userEquipment = repcap.UserEquipment.Default, transmission = repcap.Transmission.Default) \n
