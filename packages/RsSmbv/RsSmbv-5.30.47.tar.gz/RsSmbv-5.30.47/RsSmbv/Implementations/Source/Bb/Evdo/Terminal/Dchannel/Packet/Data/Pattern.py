...
class PatternCls:
	...
	def set(self, pattern: List[str], bitcount: int, terminal=repcap.Terminal.Default, packet=repcap.Packet.Default) -> None:
		...
		Snippet: driver.source.bb.evdo.terminal.dchannel.packet.data.pattern.set(pattern = ['rawAbc1', 'rawAbc2', 'rawAbc3'], bitcount = 1, terminal = repcap.Terminal.Default, packet = repcap.Packet.Default) \n
