...
class MspareCls:
	...
	def set(self, mib_spare_bits: List[str], allocationNull=repcap.AllocationNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.downlink.emtc.alloc.ccoding.mspare.set(mib_spare_bits = ['rawAbc1', 'rawAbc2', 'rawAbc3'], allocationNull = repcap.AllocationNull.Default) \n
