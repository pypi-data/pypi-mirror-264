...
class PatternCls:
	...
	def set(self, emtc_ack_nack_pat: List[str], bitcount: int, userEquipment=repcap.UserEquipment.Default, transmission=repcap.Transmission.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.uplink.ue.emtc.trans.pucch.harq.pattern.set(emtc_ack_nack_pat = ['rawAbc1', 'rawAbc2', 'rawAbc3'], bitcount = 1, userEquipment = repcap.UserEquipment.Default, transmission = repcap.Transmission.Default) \n
