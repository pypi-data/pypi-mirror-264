...
class QsControlCls:
	...
	def set(self, qs_control: List[str], frameBlock=repcap.FrameBlock.Default, userIx=repcap.UserIx.Default) -> None:
		...
		Snippet: driver.source.bb.wlnn.fblock.user.mac.qsControl.set(qs_control = ['rawAbc1', 'rawAbc2', 'rawAbc3'], frameBlock = repcap.FrameBlock.Default, userIx = repcap.UserIx.Default) \n
