...
class TrssiCls:
	...
	def set(self, target_rssi: List[str], frameBlock=repcap.FrameBlock.Default, userIx=repcap.UserIx.Default, triggerFrameUser=repcap.TriggerFrameUser.Default) -> None:
		...
		Snippet: driver.source.bb.wlnn.fblock.user.tfConfig.uinfo.trssi.set(target_rssi = ['rawAbc1', 'rawAbc2', 'rawAbc3'], frameBlock = repcap.FrameBlock.Default, userIx = repcap.UserIx.Default, triggerFrameUser = repcap.TriggerFrameUser.Default) \n
