...
class PatternCls:
	...
	def set(self, pattern: List[str], bitcount: int, vdbTransmitter=repcap.VdbTransmitter.Default) -> None:
		...
		Snippet: driver.source.bb.gbas.vdb.mconfig.dg.gpolynomial.pattern.set(pattern = ['rawAbc1', 'rawAbc2', 'rawAbc3'], bitcount = 1, vdbTransmitter = repcap.VdbTransmitter.Default) \n
