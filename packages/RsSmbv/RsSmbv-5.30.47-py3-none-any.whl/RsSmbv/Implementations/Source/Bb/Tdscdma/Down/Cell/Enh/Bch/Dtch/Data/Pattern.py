...
class PatternCls:
	...
	def set(self, pattern: List[str], bitcount: int, cell=repcap.Cell.Default, channel=repcap.Channel.Default) -> None:
		...
		Snippet: driver.source.bb.tdscdma.down.cell.enh.bch.dtch.data.pattern.set(pattern = ['rawAbc1', 'rawAbc2', 'rawAbc3'], bitcount = 1, cell = repcap.Cell.Default, channel = repcap.Channel.Default) \n
