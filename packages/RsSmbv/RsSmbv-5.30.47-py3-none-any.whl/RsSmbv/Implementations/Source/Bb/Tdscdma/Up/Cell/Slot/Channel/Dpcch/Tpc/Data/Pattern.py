...
class PatternCls:
	...
	def set(self, pattern: List[str], bitcount: int, cell=repcap.Cell.Default, slotNull=repcap.SlotNull.Default, channelNull=repcap.ChannelNull.Default) -> None:
		...
		Snippet: driver.source.bb.tdscdma.up.cell.slot.channel.dpcch.tpc.data.pattern.set(pattern = ['rawAbc1', 'rawAbc2', 'rawAbc3'], bitcount = 1, cell = repcap.Cell.Default, slotNull = repcap.SlotNull.Default, channelNull = repcap.ChannelNull.Default) \n
