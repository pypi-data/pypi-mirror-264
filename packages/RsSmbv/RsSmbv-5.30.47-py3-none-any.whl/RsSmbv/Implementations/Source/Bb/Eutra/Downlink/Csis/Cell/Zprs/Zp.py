...
class ZpCls:
	...
	def set(self, zero_power: List[str], cellNull=repcap.CellNull.Default, indexNull=repcap.IndexNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.downlink.csis.cell.zprs.zp.set(zero_power = ['rawAbc1', 'rawAbc2', 'rawAbc3'], cellNull = repcap.CellNull.Default, indexNull = repcap.IndexNull.Default) \n
