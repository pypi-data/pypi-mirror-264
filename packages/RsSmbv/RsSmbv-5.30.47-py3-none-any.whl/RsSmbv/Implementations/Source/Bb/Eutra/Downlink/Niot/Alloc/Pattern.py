...
class PatternCls:
	...
	def set(self, pattern: List[str], bitcount: int, allocationNull=repcap.AllocationNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.downlink.niot.alloc.pattern.set(pattern = ['rawAbc1', 'rawAbc2', 'rawAbc3'], bitcount = 1, allocationNull = repcap.AllocationNull.Default) \n
