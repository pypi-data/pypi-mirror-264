...
class PatternCls:
	...
	def set(self, pattern: List[str], satelliteSvid=repcap.SatelliteSvid.Default, index=repcap.Index.Default) -> None:
		...
		Snippet: driver.source.bb.gnss.svid.sbas.signal.l5Band.el5S.data.nmessage.pattern.set(pattern = ['rawAbc1', 'rawAbc2', 'rawAbc3'], satelliteSvid = repcap.SatelliteSvid.Default, index = repcap.Index.Default) \n
