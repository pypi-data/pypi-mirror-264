...
class PatternCls:
	...
	def set(self, pattern: List[str], bitcount: int, baseStation=repcap.BaseStation.Default, channelNull=repcap.ChannelNull.Default) -> None:
		...
		Snippet: driver.source.bb.w3Gpp.bstation.channel.hsdpa.hset.data.pattern.set(pattern = ['rawAbc1', 'rawAbc2', 'rawAbc3'], bitcount = 1, baseStation = repcap.BaseStation.Default, channelNull = repcap.ChannelNull.Default) \n
