...
class PatternCls:
	...
	def set(self, pattern: List[str], bitcount: int, transportChannelNull=repcap.TransportChannelNull.Default) -> None:
		...
		Snippet: driver.source.bb.w3Gpp.mstation.enhanced.dpdch.tchannel.data.pattern.set(pattern = ['rawAbc1', 'rawAbc2', 'rawAbc3'], bitcount = 1, transportChannelNull = repcap.TransportChannelNull.Default) \n
