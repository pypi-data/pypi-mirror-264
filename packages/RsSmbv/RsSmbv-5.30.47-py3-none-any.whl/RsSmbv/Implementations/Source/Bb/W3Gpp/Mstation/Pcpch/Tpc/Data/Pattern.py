...
class PatternCls:
	...
	def set(self, pattern: List[str], bitcount: int, mobileStation=repcap.MobileStation.Default) -> None:
		...
		Snippet: driver.source.bb.w3Gpp.mstation.pcpch.tpc.data.pattern.set(pattern = ['rawAbc1', 'rawAbc2', 'rawAbc3'], bitcount = 1, mobileStation = repcap.MobileStation.Default) \n
