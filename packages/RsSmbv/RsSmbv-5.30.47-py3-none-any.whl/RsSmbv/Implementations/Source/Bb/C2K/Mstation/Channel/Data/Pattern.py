...
class PatternCls:
	...
	def set(self, pattern: List[str], bitcount: int, mobileStation=repcap.MobileStation.Default, channel=repcap.Channel.Default) -> None:
		...
		Snippet: driver.source.bb.c2K.mstation.channel.data.pattern.set(pattern = ['rawAbc1', 'rawAbc2', 'rawAbc3'], bitcount = 1, mobileStation = repcap.MobileStation.Default, channel = repcap.Channel.Default) \n
