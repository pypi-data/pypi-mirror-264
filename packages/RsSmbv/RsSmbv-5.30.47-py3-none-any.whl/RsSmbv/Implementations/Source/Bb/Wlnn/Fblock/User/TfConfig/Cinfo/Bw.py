...
class BwCls:
	...
	def set(self, bw: List[str], frameBlock=repcap.FrameBlock.Default, userIx=repcap.UserIx.Default) -> None:
		...
		Snippet: driver.source.bb.wlnn.fblock.user.tfConfig.cinfo.bw.set(bw = ['rawAbc1', 'rawAbc2', 'rawAbc3'], frameBlock = repcap.FrameBlock.Default, userIx = repcap.UserIx.Default) \n
