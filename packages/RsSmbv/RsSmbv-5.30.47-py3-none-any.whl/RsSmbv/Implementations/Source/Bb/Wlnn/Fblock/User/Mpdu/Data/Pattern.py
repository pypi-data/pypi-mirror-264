...
class PatternCls:
	...
	def set(self, pattern: List[str], frameBlock=repcap.FrameBlock.Default, userIx=repcap.UserIx.Default, macPdu=repcap.MacPdu.Default) -> None:
		...
		Snippet: driver.source.bb.wlnn.fblock.user.mpdu.data.pattern.set(pattern = ['rawAbc1', 'rawAbc2', 'rawAbc3'], frameBlock = repcap.FrameBlock.Default, userIx = repcap.UserIx.Default, macPdu = repcap.MacPdu.Default) \n
