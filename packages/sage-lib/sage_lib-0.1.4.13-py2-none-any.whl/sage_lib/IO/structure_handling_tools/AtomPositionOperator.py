...
class AtomPositionOperator:
    ...
    def get_connection_list(self, sigma:float=1.2, metric:str='covalent_radii' ) -> list:
        return [(n1, n2) for n1 in range(self.atomCount) for n2 in range(n1 + 1, self.atomCount) if self.is_bond(n1, n2)]
