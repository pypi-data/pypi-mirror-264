...
class Rfko:
    '''TODO : 1. changing the parameters of the simulation after the .matching causes problems related to the _check_parameters method,
        ...
        2. The double logger proble everytime I runinitialize another instance, this is shit!!'''

    def __init__(self,line_type='bare_machine',ions=True,E_kin=0.650,logging_level=None,build_line=True,line_dir='mad_file',**sim_params):
    ...
    def build_line(self,dir='mad_file',madout=False,print_info=False,**kwargs):
        ...
        if self.line_type=='bare_machine':
    ...
    def build_particles_custom(self,A=None,X=None,PX=None,xaxis=False,pxaxis=False,s=None,**args):
        '''
