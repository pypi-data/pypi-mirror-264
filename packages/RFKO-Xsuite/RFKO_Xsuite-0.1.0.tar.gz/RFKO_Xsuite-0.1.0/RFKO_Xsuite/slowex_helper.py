...
def tri_geom(outdict, interpolate=True,sqrt=True,negate_s=True):
    ...
    S_str, S_mu = Virtual_sextupole_complete(outdict)  # compute sextupole strength and mu
    if negate_s:
        S_str = - S_str
...
def transform_to_vs(rfko,monitor=None):
    ''' Transform the particles to the virtual sextupole
