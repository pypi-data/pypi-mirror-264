...
class WlanapiDll:
    ...
    def __init__(self):
        ...
        WlanQueryInterface.argtypes = [HANDLE, POINTER(GUID), WLAN_INTF_OPCODE, c_void_p, POINTER(DWORD), POINTER(POINTER(self.return_type)), POINTER(WLAN_OPCODE_VALUE_TYPE)]
