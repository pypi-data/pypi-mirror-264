...
from .backflow_species_mass_fractions import backflow_species_mass_fractions as backflow_species_mass_fractions_cls
...
class species(Group):
    ...
    child_names = \
        ['mean_mixture_fraction', 'secondary_mean_mixture_fraction',
         ...
         'backflow_species_mass_fractions', 'backflow_mixture_fraction',
         'backflow_mode_2_probability', 'backflow_mode_3_probability',
         'backflow_progress_variable', 'backflow_progress_variable_variance',
         'backflow_flame_area_density', 'backflow_inert_stream',
         'backflow_pollutant_no_mass_fraction',
    ...
    _child_classes = dict(
        ...
        backflow_species_mass_fractions=backflow_species_mass_fractions_cls,
    ...
    _child_aliases = dict(
        ...
        mf="backflow_species_mass_fractions",
