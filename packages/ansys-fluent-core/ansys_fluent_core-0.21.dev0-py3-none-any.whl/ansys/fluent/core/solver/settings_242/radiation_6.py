...
class radiation(Group):
    ...
    child_names = \
        ['internal_emissivity', 'internal_emissivity_band', 'bc_type',
         'boundary_source', 'polar_distribution_function', 'polar_func_type',
         'polar_expression', 'polar_data_pairs', 'theta', 'coll_dphi',
         'direct_irradiation', 'parallel_collimated_beam',
         'reference_direction', 'diffuse_irradiation_band',
