        ...
        for reqtype in self.request_types:
            ...
            if response != None:
                ...
                if "base" in self.originalresponse:
                    ...
                    if res[6]!="":
                         self.results_queue.put({"status_code":res[0],"reflects":res[1],"words":res[2],"bytes":res[3],"different_type":res[4],"different_status":res[5],"diffs":res[6],"request":dump.dump_response(response,request_prefix="").decode('utf-8','ignore').split("\r\n>})
            else:
