...
#%%
def sp_df_xy_to_sp_points(df_xy: pd.DataFrame, column_x = 'x', column_y = 'y', crs = None) -> gpd.GeoDataFrame:
...
#%%
def sp_df_xy_to_sp_lines(df_xy: pd.DataFrame, column_x = 'x', column_y = 'y', column_group: str = None, keep_columns = False, crs = None) -> gpd.GeoDataFrame:
...
#%%
def sp_df_xy_to_sp_polygons(df_xy: pd.DataFrame, column_x = 'x', column_y = 'y', column_group: str = None, keep_columns = False, crs = None) -> gpd.GeoDataFrame:
