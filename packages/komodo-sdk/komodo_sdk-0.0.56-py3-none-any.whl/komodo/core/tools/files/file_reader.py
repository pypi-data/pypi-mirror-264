...
class FileReader(KomodoTool):
    ...
    name = "File Reader"
    purpose = "Reads contents of files. Can return extracted text or raw bytes. You must use paging (start, bytes) to read large files."
    ...
    def action(self, args):
        try:
            ...
            if not raw:
                ...
                return self.read_raw_file(path, page, page_size)
