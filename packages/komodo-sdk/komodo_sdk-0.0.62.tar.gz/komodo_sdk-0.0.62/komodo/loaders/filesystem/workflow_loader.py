...
class WorkflowLoader():
    ...
    def load(self, workflow_name: str) -> dict:
        ...
        workflow_data = load_dictionary_from_yaml(workflow_file)
        ...
        data_folder = self.locations.workflow_data(workflow_name)
        data = {}
        ...
        for key in ['shortcode', 'name', 'purpose', 'context', 'data', 'dictionary']:
