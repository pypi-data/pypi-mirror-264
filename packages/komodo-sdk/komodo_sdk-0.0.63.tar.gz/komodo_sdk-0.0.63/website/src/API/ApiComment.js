...
export const API_Path = {
  ...
  agentConversationsGetUrl: (shortcode) => Url + "/agent/conversations/" + shortcode,
  ...
  collectionsDeleteCollectionUrl: (shortcode) => Url + "/collections/" + shortcode,
  collectionsUploadFilesUrl: (shortcode) => Url + "/collections/upload_files/" + shortcode,
  collectionsDownloadFileUrl: (shortcode, file_guid) => Url + "/collections/" + shortcode + "/" + file_guid,
};
