...
client_key="zvkPurRjZz0ptGnEIxMq0oTDeNiGekQhaLwWslWFqD+TaDQVyg6MTU64uJFDCu8wlOLUTHQL7AD+p6NGMM0Uk4XZEnE4bXOfiF3QaxqT0ij/A0vBxT+w7dBtTJx/FHdq9K7DZlMWL3vNN8MCaHXpew=="
username='Narasimha'
project_name='TestProjectnew22'
model_name='model88'
getWorkspaceFolderFiles(username+"_"+project_name+"_"+model_name,r'C:\Users\JakeerAhamedShaik\Downloads\down',username , client_key)
            #model_path='/tmp/outputs/save_data5/'
