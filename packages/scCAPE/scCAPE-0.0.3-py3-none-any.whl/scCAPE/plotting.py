...
def plot_loss(history, save_path, seed):
    """
    ...
    sns.despine()
    plt.tight_layout()
    fig.savefig(os.path.join(save_path, 'model_seed={}_training_loss.png'.format(seed)), dpi=1000)
    plt.close()


def plot_metric(history, save_path, seed, epoch_min=0):
    """
    ...
    sns.despine()
    plt.tight_layout()
    fig.savefig(os.path.join(save_path, 'model_seed={}_training_metric.png'.format(seed)), dpi=1000)
    plt.close()
