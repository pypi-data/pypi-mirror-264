...
def bernoulli(p: Union[bool, int, float, complex, object] = 0.5, shape: Optional[Sequence[int]] = None, key: Optional[mlx.core.array] = None, stream: Optional[Union[mlx.core.Stream, mlx.core.Device]] = None) -> mlx.core.array:
    """
...
def categorical(logits: mlx.core.array, axis: int = -1, shape: Optional[Sequence[int]] = None, num_samples: Optional[int] = None, key: Optional[mlx.core.array] = None, stream: Optional[Union[mlx.core.Stream, mlx.core.Device]] = None) -> mlx.core.array:
    """
...
def gumbel(shape: Sequence[int] = [], dtype: Optional[mlx.core.Dtype] = ..., stream: Optional[mlx.core.array] = None, key: Optional[Union[mlx.core.Stream, mlx.core.Device]] = None) -> mlx.core.array:
    """
...
def normal(shape: Sequence[int] = [], dtype: Optional[mlx.core.Dtype] = ..., loc: float = 0.0, scale: float = 1.0, key: Optional[mlx.core.array] = None, stream: Optional[Union[mlx.core.Stream, mlx.core.Device]] = None) -> mlx.core.array:
    """
...
def randint(low: Union[bool, int, float, complex, object], high: Union[bool, int, float, complex, object], shape: Sequence[int] = [], dtype: Optional[mlx.core.Dtype] = ..., key: Optional[mlx.core.array] = None, stream: Optional[Union[mlx.core.Stream, mlx.core.Device]] = None) -> mlx.core.array:
    """
...
def split(key: mlx.core.array, num: int = 2, stream: Optional[Union[mlx.core.Stream, mlx.core.Device]] = None) -> mlx.core.array:
    """
...
def truncated_normal(lower: Union[bool, int, float, complex, object], upper: Union[bool, int, float, complex, object], shape: Optional[Sequence[int]] = None, dtype: Optional[mlx.core.Dtype] = ..., key: Optional[mlx.core.array] = None, stream: Optional[Union[mlx.core.Stream, mlx.core.Device]] = None) -> mlx.core.array:
    """
...
def uniform(low: Union[bool, int, float, complex, object] = 0, high: Union[bool, int, float, complex, object] = 1, shape: Sequence[int] = [], dtype: Optional[mlx.core.Dtype] = ..., key: Optional[mlx.core.array] = None, stream: Optional[Union[mlx.core.Stream, mlx.core.Device]] = None) -> mlx.core.array:
    """
