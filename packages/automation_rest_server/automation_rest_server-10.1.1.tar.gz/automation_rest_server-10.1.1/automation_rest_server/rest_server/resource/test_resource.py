...
class TestResource(Resource):
    ...
    def delete(self, filter_=None):
        self.test_pool.add_stop_test(filter_)
        msg_ = "ALL tests" if filter_ is None else filter_
        msg = "Add test:{} to stop pool".format(msg_)
        result = {"state": State.PASS, "msg": msg}
        return result
