...
class CompletionNoneException(Exception):
    ...
    # TODO: Ensure concurrent access is safe.
    count = 0

    def __init__(self):
        super().__init__("openai completion object is None.")
        CompletionNoneException.count += 1

    def is_first_exception(self) -> bool:
        return CompletionNoneException.count == 1
...
async def openai_tool_use(
    ...
    **kwargs,
    ...
    if completion is None:
        raise CompletionNoneException(completion)
