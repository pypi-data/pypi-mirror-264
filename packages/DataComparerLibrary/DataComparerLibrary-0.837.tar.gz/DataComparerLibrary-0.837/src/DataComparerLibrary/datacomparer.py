...
# a.Vergelijken_Actueel_Resultaat_met_Verwacht_Resultaat(actual_file, expected_file)
actual_data_input = [['3', '1.1', '4', '7', '2023-05-27 12:00'],
                     ['1', '0', '2', '9', '2023-05-29 12:00'],
                     ['2024-01-12', '0', '2', '9', '2024-02-25 12:00'],
                     ['2024-03-28', '0', '2', '9', '2024-03-28 12:00'],
                     ['', '2', 0, '1', '5'],
                     ['', '2', '0', '1', '6'],
                     ['5.1', '8', '1', '0', '3'],
                     ['3', '', '2023-06-19', '3', '2023-06-08']]

expected_data_input = [['3', '1.1', '4', '7', '2023-05-27 12:00'],
                       ['1', '0', '{NOT(2)}', '9', '{NOT(2023-05-29 12:00)'],
                       ['{NOW():YYYY-MM-DD}', '0', '2', '9', '{NOW():YYYY-MM-DD} {SKIP}'],
                       ['{NOW():YYYY-MM-DD}', '0', '2', '9', '{NOW():YYYY-MM-DD} {SKIP}'],
                       ['', '2', '0', '1', '5'],
                       ['', '{NOT(8)}', '{NOT(verkeerd)}', '1', 6],
                       ['5.1', '8', '1', '0', '3'],
                       ['3', '', '2023-06-19', '3', '2023-06-08']]

a.compare_data_2d_arrays(actual_data_input, expected_data_input)
