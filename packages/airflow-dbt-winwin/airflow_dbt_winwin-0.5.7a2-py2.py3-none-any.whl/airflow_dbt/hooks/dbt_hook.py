    ...
    def run_cli(self, *command):
        ...
        for line in iter(sp.stdout.readline, b''):
            ...
            try:
                ...
                node_path = json_data["node_info"].get("node_path","")    
                sql = json_data.get("sql","")
                msg = json_info.get("msg", line.rstrip())
                
                output_msg = f"conn_name: { conn_name },node_path: { node_path },sql:\n{sql}\n,\n msg:{msg}"
                logfunc_map[log_level](json_info.get("msg", line.rstrip()))
