...
ANYSCALE_CLUSTER_ENV_PREFIX = "anyscale/cluster_env/"
...
class ImageURI:
    ...
    def is_legacy_cluster_env_image(self) -> bool:
        """Check if the image URI is a legacy cluster environment image."""
        return self.image_uri.startswith(ANYSCALE_CLUSTER_ENV_PREFIX)

    def to_legacy_cluster_env_identifier(self) -> str:
        assert self.is_legacy_cluster_env_image()
