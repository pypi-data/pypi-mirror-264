...
class DecoratedProductionServiceV2VersionAPIModel(object):
    ...
    def __init__(self, id=None, created_at=None, weight=None, current_weight=None, version=None, ray_serve_config=None, ray_gcs_external_storage_config=None, build_id=None, compute_config_id=None, production_job_ids=None, local_vars_configuration=None):  # noqa: E501
