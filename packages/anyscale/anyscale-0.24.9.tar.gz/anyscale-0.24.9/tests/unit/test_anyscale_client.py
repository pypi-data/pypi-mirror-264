...
class TestClusterEnv:
    ...
    def test_get_cluster_env_build_id_from_containerfile(
        ...
        if mark_build_fail:
            ...
            assert (
                "Building image... See details: https://console.anyscale.com/container-images/apt_1/versions/bld_1."
    ...
    def test_get_cluster_env_build_id_from_image_uri_legacy_cluster_env(
        ...
        anyscale_client, fake_external_client, _, _ = setup_anyscale_client
        legacy_image_uri = ImageURI.from_str(
            "anyscale/cluster_env/fake-cluster-env-name:5"
        )
        assert legacy_image_uri.is_legacy_cluster_env_image()
        if found:
            fake_external_client.set_cluster_env(
                "fake-cluster-env-id",
                ClusterEnvironment(
