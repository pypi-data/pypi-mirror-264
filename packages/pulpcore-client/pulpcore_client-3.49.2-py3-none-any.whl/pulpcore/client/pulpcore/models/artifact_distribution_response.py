...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, pulp_labels=None, pulp_href=None, name=None, base_url=None, hidden=False, content_guard=None, base_path=None, pulp_last_updated=None, local_vars_configuration=None):  # noqa: E501
