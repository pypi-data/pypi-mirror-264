...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, content_guard=None, name=None, base_url=None, pulp_created=None, hidden=False, base_path=None, pulp_href=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
