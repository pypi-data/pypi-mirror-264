...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_url=None, pulp_created=None, name=None, content_guard=None, pulp_labels=None, base_path=None, pulp_last_updated=None, pulp_href=None, hidden=False, local_vars_configuration=None):  # noqa: E501
