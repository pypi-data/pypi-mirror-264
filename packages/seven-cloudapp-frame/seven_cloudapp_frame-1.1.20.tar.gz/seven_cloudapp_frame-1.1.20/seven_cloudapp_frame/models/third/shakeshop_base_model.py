...
@LastEditTime: 2024-03-25 12:04:18
...
class ShakeShopBaseModel():
    ...
    def product_search_list(self, page=1, size=100, name="", product_id=[], status=-1, product_type=-1, custom_params={}, field="product_id,name,img,status,product_type,out_product_id,outer_product_id", is_log=False):
        """
