...
class LessThan(Binary):
    ...
    def __str__(self):
        return f"LT({self.field_a},{self.field_b}){{{self.condition_true},{self.condition_false}}}"
    ...
    def compile(self)->str:
        ...
        if not type(self.field_b) is int:
            f_b = self.field_b
        return f"st.LessThan('{self.field_a}', '{f_b}', {self.condition_true.compile()}, {self.condition_false.compile()})"
