...
class AnalysisVersionApi(object):
    ...
    def create(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/oi.papi.AnalysisVersionApi/create',
    ...
    def get(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/oi.papi.AnalysisVersionApi/get',
    ...
    def list(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/oi.papi.AnalysisVersionApi/list',
