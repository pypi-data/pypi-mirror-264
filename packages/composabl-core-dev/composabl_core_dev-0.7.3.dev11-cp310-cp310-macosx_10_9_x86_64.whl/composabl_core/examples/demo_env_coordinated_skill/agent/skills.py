...
from composabl_core.examples.demo_env_coordinated_skill.agent import scenarios
from composabl_core.examples.demo_env_coordinated_skill.agent.coach import (
    CoordinatedCoach,
)
from composabl_core.examples.demo_env_coordinated_skill.agent.teacher import (
    IncrementTeacher,
)
...
coordinated_skill = SkillCoordinated("coordinated_skill", CoordinatedCoach, [
    increment_skill1, increment_skill2
])
