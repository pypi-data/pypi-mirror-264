...
class Url(ABC):
    ...
    *Scheme is determined from the input string*
    ...
    def delete(self) -> None:
        ...
        """
    @classmethod
    def create_table_url(cls, root: str | Url | None = None, project_name: str | None = None, dataset_name: str | None = None, table_name: str | None = None) -> Url:
        ...
        """
    @classmethod
    def create_run_url(cls, root: str | Url | None = None, project_name: str | None = None, run_name: str | None = None) -> Url:
