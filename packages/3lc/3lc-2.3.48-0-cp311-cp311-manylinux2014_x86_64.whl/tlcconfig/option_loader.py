...
class OptionLoader:
    ...
    def write_to_yaml_file(self, filename: str = get_default_config_file(), overwrite: bool = False) -> None:
    ...
    def set_instance(option_loader: OptionLoader, write_config_file: bool = True) -> None:
        ...
        if write_config_file and not option_loader._yaml_file:
            option_loader.write_to_yaml_file()
