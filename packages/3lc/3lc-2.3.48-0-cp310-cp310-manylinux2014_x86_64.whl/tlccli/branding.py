...
def format_config_table(option_loader: OptionLoader) -> Table:
    ...
    table = Table(title=_TLCBranding.abbrev("3", "LC", " Configuration"))
    table.add_column("Key", style=_TLCBranding.zest)
    table.add_column("Value", style=_TLCBranding.neptune)
    table.add_column("Source", style=_TLCBranding.pearl)
...
def format_verbose_options_table(option_loader: OptionLoader) -> Table:
    table = Table(title=_TLCBranding.abbrev("3LC", " Configuration", " Options"))
    table.add_column("Key", style=_TLCBranding.zest)
    table.add_column("Description", style=_TLCBranding.neptune)
    table.add_column("Default", style=_TLCBranding.pearl)
...
def format_config_file(option_loader: OptionLoader) -> str:
    return _TLCBranding.abbrev(
        s0="Effective config file: ",
        s1=f"[link={option_loader._yaml_file}]{option_loader._yaml_file}[/link]",
        s2="",
    )
