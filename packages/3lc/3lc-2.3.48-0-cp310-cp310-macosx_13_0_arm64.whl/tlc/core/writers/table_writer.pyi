...
class TableWriter:
    ...
    url: Incomplete
    def __init__(self, table_name: str = ..., dataset_name: str = ..., project_name: str = ..., column_schemas: dict[str, Schema] = {}, if_exists: Literal['overwrite', 'rename', 'raise'] = 'rename', *, table_url: Url | str | None = None) -> None:
