...
def lightning_module(structure: _SampleTypeStructure | None = None, dataset_prefix: str = '', run_name: str | None = None, project_name: str | None = None, root_url: Url | str | None = None, if_dataset_exists: Literal['raise', 'reuse', 'rename', 'overwrite'] = 'reuse', if_run_exists: Literal['raise', 'reuse', 'rename', 'overwrite'] = 'rename', add_weight_column: bool = True, all_arrays_are_fixed_size: bool = False, exclude_zero_weights_train: bool = True, weighted: bool = True, use_latest: bool = True, map_functions: list[Callable[[object], object]] | Callable[[object], object] | None = None, metrics_collectors: list[MetricsCollector] | None = None, metrics_collection_interval: int = 1, metrics_collection_start: int = 1, metrics_collection_exclude_zero_weights: bool = True, metrics_collection_map_functions: list[Callable[[object], object]] | Callable[[object], object] | None = None) -> Callable[[type[_LightningModule]], type[_LightningModule]]:
    '''Decorator to use 3LC with PyTorch Lightning.
    ...
    :param metrics_collection_interval: The number of epochs between each metrics collection.
    :param metrics_collection_start: The epoch to start collecting metrics.
