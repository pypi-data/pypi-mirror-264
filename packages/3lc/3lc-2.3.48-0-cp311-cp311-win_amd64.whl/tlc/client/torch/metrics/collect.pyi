...
def collect_metrics(table: Table, metrics_collectors: list[MetricsCollector], constants: dict[str, Any] = {}, constants_schemas: dict[str, Schema] | None = None, run_url: Url | str | None = None, collect_aggregates: bool = True, split: str = '', exclude_zero_weights: bool = False, *, dataloader_args: dict[str, Any] | None = None) -> None:
