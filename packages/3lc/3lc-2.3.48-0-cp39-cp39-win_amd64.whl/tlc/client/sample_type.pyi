...
from tlc.client.sample_url_utils import increment_and_get_sample_url as increment_and_get_sample_url
...
class SampleType(ABC, Generic[ST, RT], metaclass=abc.ABCMeta):
    ...
    def schema(self) -> Schema:
        ...
        """
    @classmethod
    def from_schema(cls, schema: Schema, name: str | None = None) -> SampleType:
    ...
    def sample_is_valid(self, sample: object) -> bool:
        """Returns true if the sample matches this SampleType, False otherwise.

        :param sample: The sample to check.
        :return: True if the sample matches this SampleType, False otherwise.
        """
    def row_is_valid(self, row: object) -> bool:
        """Returns true if the row matches this SampleType, False otherwise.

        :param row: The row to check.
        :return: True if the row matches this SampleType, False otherwise.
        """
...
class Box(CompositeSampleType[object]):
    ...
    sample_type: str
    def __init__(self, child: _SampleTypeStructure) -> None: ...
...
class Hidden(AtomicSampleType[None, object]):
...
class Float(Number[float]):
    ...
    def __init__(self, name: str, precision: Literal[32, 64] = 32, normalized: bool = False, number_role: str = '') -> None:
...
class DimensionalSampleType(SampleType[ST, list], metaclass=abc.ABCMeta):
    ...
    def schema(self) -> Schema: ...
    @abstractmethod
    def sample_from_row(self, row: list) -> ST: ...
    @abstractmethod
    def row_from_sample(self, sample: ST) -> list: ...
    def sample_is_valid(self, sample: object) -> bool: ...
    def row_is_valid(self, row: object) -> bool: ...

class List(DimensionalSampleType[list]):
    """A list of variable length."""
    sample_type: str
    def sample_from_row(self, row: list) -> list: ...
    def row_from_sample(self, sample: list) -> list: ...

class Tuple(DimensionalSampleType[tuple]):
    """A tuple of variable length."""
    sample_type: str
    def sample_from_row(self, row: list) -> tuple: ...
    def row_from_sample(self, sample: tuple) -> list: ...

class NumpyArray(DimensionalSampleType[np.ndarray]):
