...
class SchemaHelper:
    ...
    def object_input_urls(obj: Any, schema: Schema) -> list[Url]:
        ...
        Note: the result is likely to be relative wrt the object's URL
        """
    @staticmethod
    def from_pyarrow_datatype(data_type: pa.DataType) -> type[ScalarValue] | None:
        """Converts a PyArrow Schema or DataType to a 3LC Schema or ScalarValue.

        :param data_type: The PyArrow data type to convert.
        :returns: The type of the scalar value that corresponds to the pyarrow data type.
        """
    @staticmethod
    def to_pyarrow_datatype(schema_or_value: Schema | ScalarValue) -> pa.DataType:
        """Converts a schema or scalar value to a pyarrow datatype.
