...
class NGrokHelper:
    ...
    pyngrok_unavailable_message = (
        "NGrok is not available. You can install the package by running 'pip install tlc[pyngrok]'."
    )

    ngrok_token_unavailable_message = "NGrok token could noe be found. Please the set NGROK_TOKEN environment variable."
