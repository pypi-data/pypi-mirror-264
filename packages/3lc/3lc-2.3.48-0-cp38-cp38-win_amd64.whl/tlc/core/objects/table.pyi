...
class Table(Object):
    ...
    1) Creating table rows on demand (through the access methods \'table_rows.__getitem__\' and \'__len__\').

    2) Creating a schema which describes the type of produced rows (through the .schema.rows property)
    ...
    When this is the case, it is guaranteed that the \'schema\' property of the table is fully populated, including the
    nested \'schema.rows\' property which defines the layout of all table rows.
    ...
    Whether table_rows.__getitem__() on a Table object later refers to this cached version (or produces the data itself)
    ...
    @property
    def sample_url(self) -> Url:
        """Return the sample url for this table.

        The sample url is the url to the folder containing the sample data for this table.
        The root of the sample url can be overridden by setting the `TLC_SAMPLE_URL` environment variable.
        """
    @staticmethod
