...
class NumericValue(ScalarValue):
    ...
    unit: Incomplete
    map: Incomplete
    def __init__(self, value_type: str = ..., value_min: float | None = None, value_max: float | None = None, enforce_min: bool = False, enforce_max: bool = False, value_step: float = 0, number_role: str = '', unit: str = '', value_map: dict[float, MapElement] | None = None, default_value: int | float | None = None) -> None: ...
    def to_minimal_dict(self, include_all: bool) -> dict[str, Any]:
        """
        Add a minimal representation of this object to a dictionary for subsequent serialization to JSON
        """
...
class DimensionNumericValue(Int32Value):
    ...
    def __init__(self, value_min: float = 0, value_max: float | None = None, enforce_min: bool = True, enforce_max: bool = False, display_name: str = '', description: str = '', number_role: str = '', unit: str = '', value_map: dict[float, MapElement] | None = None, sample_type: str = '', default_value: int | None = None) -> None: ...
    def to_minimal_dict(self, include_all: bool) -> dict[str, Any]:
        """
...
class Schema:
    ...
    def from_json(json_string: str) -> Schema:
        ...
        """
    def consider_override_from(self, override_schema: Any) -> Schema:
        """
