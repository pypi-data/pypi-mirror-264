...
class Logger():
    ...
    def __init__(self,settings=None,test_name=None,default_window=None,output_signal_settings=None,output_signal=None):
        ...
        if output_signal_settings is None:
            self.output_signal_settings = options.Output_Signal_Settings(output_signal_type='None',output_amp=0,output_f1=0,output_f2=0)
        else:
...
#        self.input_list_plot_type.currentIndexChanged.connect(self.select_view)
    ...
    def setup_frame_tools_generate_output(self):
        ...
        # set default
        self.input_output_options.setCurrentText(self.output_signal_settings.output_signal_type)
        self.input_output_options.currentTextChanged.connect(self.update_output)
        
        self.input_output_amp = QLineEdit(str(self.output_signal_settings.output_amp))
        v = QDoubleValidator(0.0,1.0,5)
        v.setNotation(QDoubleValidator.Notation.StandardNotation)
        self.input_output_amp.setValidator(v)
        
        self.input_output_f1 = QLineEdit(str(self.output_signal_settings.output_f1))
        self.input_output_f1.setValidator(QDoubleValidator(0.0,float(np.inf),5))
        
        self.input_output_f2 = QLineEdit(str(self.output_signal_settings.output_f2))
