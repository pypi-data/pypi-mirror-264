...
/!\ It requires the Example_Fort_Standalone_Runs.py to be run in the first place
"""
...
if __name__ == '__main__':
    ...
    if not os.path.isfile(os.path.join(Path2OldCase, OldCaseName+'.data')):
        print('/!\ This example requires the Example_for_Standalone_Runs.py to be run in the first place')
    else:
