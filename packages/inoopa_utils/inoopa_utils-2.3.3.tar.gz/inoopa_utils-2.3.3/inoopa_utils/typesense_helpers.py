...
class TypesenseManager:
    ...
    def __init__(
        ...
        self.typesense_url = f"{host}:{port}"
        ...
        self._check_server_heatlh(f"{host}:{port}")
        # 2. Create collections if they don't exist
        self._create_collections(self.client)

        # Expose collections
        self.collection_nace_codes = self.client.collections['nace_codes']
        self.collection_companies_names = self.client.collections['companies_names']
        self.collection_online_content = self.client.collections['online_content']
