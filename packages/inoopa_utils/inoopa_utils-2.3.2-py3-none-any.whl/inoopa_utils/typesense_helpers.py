...
class TypesenseManager:
    ...
    def __init__(
        ...
        # Expose collections
        self.nace_codes = self.client.collections['nace_codes']
        self.companies_names = self.client.collections['companies_names']
        self.online_content = self.client.collections['online_content']
