...
def len_safe_get_embedding(
    ...
    I simplified it a bit and added some comments. Could be refactored to make it clearer.
    ...
    for chunk in _chunked_tokens(text, encoding_name=tokenizer_name, chunk_length=max_tokens):
...
def _chunked_tokens(text: str, encoding_name: str, chunk_length: int):
