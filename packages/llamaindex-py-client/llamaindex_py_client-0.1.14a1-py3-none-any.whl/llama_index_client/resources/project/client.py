...
class ProjectClient:
    ...
    def create_local_eval_for_project(self, project_id: str, *, request: LocalEvalResults) -> LocalEvalResults:
        """
        Upload a local eval result set.

        Parameters:
            - project_id: str.

            - request: LocalEvalResults.
        ---
        from platform import LocalEval, LocalEvalResults
        from platform.client import PlatformApi
        ...
        client.project.create_local_eval_for_project(
            project_id="string",
            request=LocalEvalResults(
                project_id="string",
                app_name="string",
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(LocalEvalResults, _response.json())  # type: ignore
        if _response.status_code == 422:
            raise UnprocessableEntityError(pydantic.parse_obj_as(HttpValidationError, _response.json()))  # type: ignore
        try:
            _response_json = _response.json()
    ...
    def create_local_eval_set_for_project(
        ...
        project_id: str,
        *,
        local_eval_set_create_project_id: str,
        app_name: str,
        ...
        Parameters:
            ...
            - local_eval_set_create_project_id: str. The ID of the project.
        ...
        client.project.create_local_eval_set_for_project(
            project_id="string",
            local_eval_set_create_project_id="string",
            app_name="string",
            results={"string": []},
        )
        """
        _response = self._client_wrapper.httpx_client.request(
            ...
            json=jsonable_encoder(
                {"project_id": local_eval_set_create_project_id, "app_name": app_name, "results": results}
            ),
            headers=self._client_wrapper.get_headers(),
            timeout=60,
        )
    ...
    def delete_local_eval(self, project_id: str, local_eval_id: str) -> typing.Any:
        """
        Delete a local eval result set.
        ...
        client.project.delete_local_eval(
            project_id="string",
            local_eval_id="string",
        )
        """
        _response = self._client_wrapper.httpx_client.request(
            "DELETE",
            urllib.parse.urljoin(
                f"{self._client_wrapper.get_base_url()}/", f"api/project/{project_id}/localeval/{local_eval_id}"
            ),
            headers=self._client_wrapper.get_headers(),
            timeout=60,
        )
...
class AsyncProjectClient:
    ...
    async def create_local_eval_for_project(self, project_id: str, *, request: LocalEvalResults) -> LocalEvalResults:
        """
        Upload a local eval result set.
        ...
        await client.project.create_local_eval_for_project(
            project_id="string",
            request=LocalEvalResults(
                project_id="string",
                app_name="string",
    ...
    async def delete_local_eval(self, project_id: str, local_eval_id: str) -> typing.Any:
        """
        Delete a local eval result set.
        ...
        await client.project.delete_local_eval(
            project_id="string",
            local_eval_id="string",
        )
        """
